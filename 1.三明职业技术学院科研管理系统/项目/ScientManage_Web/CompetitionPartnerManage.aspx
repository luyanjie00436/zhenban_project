<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompetitionPartnerManage.aspx.cs" Inherits="sanmingScientManage_Web.CompetitionPartnerManage" %>
...
<body>
 ...
 <div class="min_height">
     <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >技能竞赛合作者</div></div></div><br />
                ...
                <div style="margin-bottom: 10px">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DlCompetition" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Partner_SelectedIndexChanged"
                                    CssClass="input1">
                                </asp:DropDownList>
                            </td>
                        </tr>
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("CompetitionPartnerId") %>'
                                            OnCommand="LinkButton6_Command">编辑</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("CompetitionPartnerId") %>'
