<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLoadProjectsManage.aspx.cs" Inherits="sanmingScientManage_Web.WorkLoadProjectsManage" %>
...
<body>
 ...
 <div class="min_height">
          <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >科研项目成果</div></div></div><br />
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtProjectsForm" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                      ShowHeaderWhenEmpty="true"     OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                         ...
                         <asp:BoundField DataField="立项日期" HeaderText="立项日期">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField> 
                              <asp:BoundField DataField="结题日期" HeaderText="结题日期">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField> 
