<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidanceManage.aspx.cs" Inherits="sanmingScientManage_Web.GuidanceManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >教学质量工程</div></div></div><br />
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtGuidanceName" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                        <td width="10%" align="right">
                            <strong>类别：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtGuidanceLevel" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    ...
                    ShowHeaderWhenEmpty="true"       OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>
                            ...
                            <asp:BoundField DataField="教学质量工程分值" HeaderText="教学质量工程分值">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
