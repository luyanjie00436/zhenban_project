<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LctureManage.aspx.cs" Inherits="sanmingScientManage_Web.LctureManage" %>
        ...
        <div style="margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                         ...
                         <td width="10%" align="right">
                            <strong>讲座（报告）名称：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtLctureName" runat="server"  CssClass="select1"  Height="27px" Width="137px"></asp:TextBox>
                        </td>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtLctureSize" runat="server"  CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                                <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                     ...
                     ShowHeaderWhenEmpty="true"      OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="系(部)" HeaderText="系(部)">
                              ...
                              <asp:BoundField DataField="讲座(报告)名称" HeaderText="讲座(报告)名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
                        
                             <asp:BoundField DataField="承办单位" HeaderText="承办单位">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>                             
                            ...
                            <asp:BoundField DataField="讲座时间" HeaderText="讲座时间">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
                            <asp:BoundField DataField="讲座地点" HeaderText="讲座地点">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>                
