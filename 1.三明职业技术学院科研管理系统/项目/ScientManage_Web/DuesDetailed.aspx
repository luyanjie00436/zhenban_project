<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DuesDetailed.aspx.cs" Inherits="ScientManage_Web2.DuesDetailed" %>
        ...
        <div>
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">会费申请表</div>
                </div>
            </div>
            <br />
                    ...
                    <ContentTemplate>
                        <div style="width: 1024px; height: 297mm; margin: 0 auto">
                            <div>
                                <table>
                                    <tr>
                                        <td class="td3" colspan="6">申请人基本信息</td>
                                    </tr>
                                    <tr>
                                        <td class="td1">姓名:</td>
                                        <td class="td2">
                                ...
                                <table style="margin-left: -1px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                          ...
                                          <td align="left">
                                            <asp:Label ID="LFollDate" runat="server"></asp:Label>
                                        </td>
                                        <td>
