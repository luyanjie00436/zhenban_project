...
{
    public partial class LongCapitalPlanAdd : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (!fupFileSend.HasFile)
                ...
                try
                {
                    ...
                    //创建文件夹
                    string sPath = "File" + "\\" + "LongProjects" + "\\" + LongProjectsId + "\\CapitalPlan\\";
                    Directory.CreateDirectory(Server.MapPath("./") + sPath);
                    //设置要保存的路径
                    path = Server.MapPath("./") + "File" + "\\" + "LongProjects" + "\\" + LongProjectsId + "\\CapitalPlan\\" + upName;
                    //将文件保存到指定路径下
                    fupFileSend.PostedFile.SaveAs(path);
                    path = "File" + "\\" + "LongProjects" + "\\" + LongProjectsId + "\\CapitalPlan\\" + upName;
                    LFileUrl.Text = path;
                }
            ...
            if (bus.LongCapitalPlanInsert("LongCapitalPlan_Insert", LongProjectsId,UserCardId, path))
            {
