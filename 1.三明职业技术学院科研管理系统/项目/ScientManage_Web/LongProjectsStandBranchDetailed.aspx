<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsStandBranchDetailed.aspx.cs" Inherits="ScientManage_Web2.LongProjectsStandBranchDetailed" %>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto">
                    ...
                    <div>
                        <table style="margin-left: -1px">
                            ...
                            <tr>
                                <td align="right" class="auto-style4">项目来源：</td>

                                <td class="auto-style5" style="text-align: left">
                                    <asp:Label ID="LProjectsFrom" runat="server"></asp:Label>
                                </td>
                                <td class="auto-style5" style="text-align: right">协作单位：</td>
