<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentAdd.aspx.cs" Inherits="sanmingScientManage_Web.DepartmentAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="right" class="auto-style4">
                            <strong>系(部)名称：</strong>
                        </td>
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtDepartmentName" runat="server" CssClass="input6" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
