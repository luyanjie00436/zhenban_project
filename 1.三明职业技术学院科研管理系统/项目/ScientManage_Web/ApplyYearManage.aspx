<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyYearManage.aspx.cs" Inherits="sanmingScientManage_Web.ApplyYearManage" %>
...
<body>
 ...
 <div class="min_height">
             <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >申报年份信息</div></div></div><br />
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("ApplyYearId") %>'
                                                OnCommand="LinkButton1_Command">点击设置为成果申报时间</asp:LinkButton>
                                            <asp:Label ID="applyTime" runat="server" Text="当前时间为成果申报时间" Visible="False"></asp:Label>
                                         <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("ApplyYearId") %>'
                                                OnCommand="LinkButton2_Command">点击设置为项目申报时间</asp:LinkButton>
                                            <asp:Label ID="LApplyProject" runat="server" Text="当前时间为项目申报时间" Visible="False"></asp:Label>
                                         <a href='ApplyYearUpd.aspx?ApplyYear=<%# Eval("ApplyYearId")%>&keepThis=true&TB_iframe=true&height=300&width=500'  class="fLink thickbox">
                                            修改</a>  
