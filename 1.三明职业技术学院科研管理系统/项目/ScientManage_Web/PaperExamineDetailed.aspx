<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperExamineDetailed.aspx.cs" Inherits="sanmingScientManage_Web.PaperExamineDetailed" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
            <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >论文审批表</div></div></div><br />
                         ...
                         <tr>
                          ...
                          <tr>
                               ...
                               <td class="td5"  align="left">
                                ...
                                <td class="td5"  align="left">
                                  <asp:Label ID="LPublicationName" runat="server" ></asp:Label>
                              </td>
                              <td class="td5"  align="left">
                                ...
                                <td class="td5"  align="left">
                                 ...
                                 <td class="td5">
                                  <asp:Label ID="LPaperDate" runat="server" ></asp:Label>
                              </td>    
                              <td class="td5">
