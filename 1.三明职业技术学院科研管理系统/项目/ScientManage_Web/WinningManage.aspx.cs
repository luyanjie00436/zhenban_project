...
{
    public partial class WinningManage : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsWinning("Winning_Selects", UserName, DepartmentId, Year, Month, Status, WinningName, WinningForm).Tables[0];

            string strExcelName = "获奖成果";
