<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherResultsDetailed.aspx.cs" Inherits="sanmingScientManage_Web.OtherResultsDetailed" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
               <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >其他成果申请表</div></div></div><br />
                        ...
                        <div>
                         ...
                         <tr>
                          ...
                          <tr>
                              ...
                              <td class="td5"  align="left">
                                  <asp:Label ID="LOtherResultsName" runat="server" ></asp:Label>
                              </td>
                              ...
                              <td class="td5">
                                  <asp:Label ID="LOtherResultsValue" runat="server" ></asp:Label>
                              </td>                        
                               <td class="td5">
