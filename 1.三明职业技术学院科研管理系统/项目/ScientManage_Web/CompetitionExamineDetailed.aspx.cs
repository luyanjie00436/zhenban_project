...
{
    public partial class CompetitionExamineDetailed : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.CompetitionExamineInsert("CompetitionExamine_Insert", CompetitionId, ExamineOpinion, UserCardId, "同意", RankId))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.CompetitionExamineInsert("CompetitionExamine_Insert", CompetitionId, ExamineOpinion, UserCardId, "拒绝", RankId))
            {
                AlertMsgAndNoFlush(UpdatePanel1, "审批成功");
                dataGriviewBD();
            }
