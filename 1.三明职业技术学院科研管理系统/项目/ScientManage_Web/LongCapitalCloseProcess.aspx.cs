...
{
    public partial class LongCapitalCloseProcess : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/LongCapitalCloseProcess.aspx") == 0)
                {
                      Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'</script>");
                }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsProcessInsert("LongCapitalCloseProcess_Insert", RankId, ProcessOrder, DepartmentName, UserCardId))
            {
        ...
        public void dataGriviewBD()
        {
            ...
            GridView1.DataSource = bus.Select("LongCapitalCloseProcess_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            ...
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            if (bus.LongCapitalCloseProcessDelete("LongCapitalCloseProcess_Delete", Convert.ToInt32(e.CommandArgument.ToString()), UserCardId))
            {
