<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompetitionExamineManage.aspx.cs" Inherits="sanmingScientManage_Web.CompetitionExamineManage" %>
                          ...
                          <asp:BoundField DataField="StudentName" HeaderText="参赛学生">
                            ...
                            <asp:BoundField DataField="FollDate" HeaderText="申报时间">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("CompetitionId") %>'>审批</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
