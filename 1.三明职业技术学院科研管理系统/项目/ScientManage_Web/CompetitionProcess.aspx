<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompetitionProcess.aspx.cs" Inherits="sanmingScientManage_Web.CompetitionProcess" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >技能竞赛审批流程</div></div></div><br />
                       ...
                       ShowHeaderWhenEmpty="true"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("CompetitionProcessId") %>' runat="server"
