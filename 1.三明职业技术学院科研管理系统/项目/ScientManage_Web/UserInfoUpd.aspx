<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfoUpd.aspx.cs" Inherits="sanmingScientManage_Web.UserInfoUpd" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
   ...
   width:70px; height:20px;  border:1px solid #989898; color:#fff; background:#542e6a; border-radius:13px; margin-right:20px; text-align:center;  line-height:30px;  padding:3px 7px;"
>其他号码</a>            </td>
                              <td class="left">
                                <strong>电话号码：</strong>
                            </td>
