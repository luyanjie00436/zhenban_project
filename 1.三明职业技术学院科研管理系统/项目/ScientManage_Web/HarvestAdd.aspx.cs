...
namespace sanmingScientManage_Web
{
    public partial class HarvestAdd : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(UpdatePanel1, typeof(UpdatePanel), "提示", " if (confirm('已申请成功！是否继续分配成员分值？')) { window.location = 'HarvestPartnerManage.aspx'}else {window.location = 'HarvestAdd.aspx'}", true);
            }
            else
            {
