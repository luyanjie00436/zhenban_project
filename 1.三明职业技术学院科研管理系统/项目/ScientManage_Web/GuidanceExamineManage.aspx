<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidanceExamineManage.aspx.cs" Inherits="sanmingScientManage_Web.GuidanceExamineManage" %>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="FollDate" HeaderText="申报时间">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("GuidanceId") %>'>审批</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
