<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherResultsExamineManage.aspx.cs" Inherits="sanmingScientManage_Web.OtherResultsExamineManage" %>
...
<body>
 ...
 <div class="min_height">
          <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >其他成果审批表</div></div></div><br />
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="FollDate" HeaderText="申报时间">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("OtherResultsId") %>'>审批</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
