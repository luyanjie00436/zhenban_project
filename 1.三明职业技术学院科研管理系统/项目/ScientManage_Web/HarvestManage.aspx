<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestManage.aspx.cs" Inherits="sanmingScientManage_Web.HarvestManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >科技成果</div></div></div><br />
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtHarvestName" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                        <td width="10%" align="right">
                            <strong>类别：</strong>
                        </td>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="级别" HeaderText="级别">
                             ...
                             <asp:BoundField DataField="成果名称" HeaderText="成果名称">
                                ...
                                <asp:BoundField DataField="发奖日期" HeaderText="发奖日期">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
