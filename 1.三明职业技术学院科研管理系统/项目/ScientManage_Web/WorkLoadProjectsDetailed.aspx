<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLoadProjectsDetailed.aspx.cs" Inherits="sanmingScientManage_Web.WorkLoadProjectsDetailed" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
           <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >项目成果申请表</div></div></div><br />
                           ...
                           <%--    <td class="td5"  align="left">
                             ...
                             <td class="td5">
                                  <asp:Label ID="LPartnerValue" runat="server" ></asp:Label>
                                      ...
                                      <td class="td5">
                                  <asp:Label ID="LConcludingValue" runat="server" ></asp:Label>
                              </td>
                               <td class="td5">
