<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalBasicManage.aspx.cs" Inherits="ScientManage_Web2.LongCapitalBasicManage" %>
...
<body>
 ...
 <div class="min_height">
           <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向经费基本信息设置</div></div></div><br />
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              ...
              <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                   ...
                   <Columns>
                            ...
                            <asp:BoundField DataField="SuedCompanyName" HeaderText="经费下达单位">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
