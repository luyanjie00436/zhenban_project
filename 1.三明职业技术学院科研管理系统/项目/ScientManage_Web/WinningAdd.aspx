<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinningAdd.aspx.cs" Inherits="sanmingScientManage_Web.WinningAdd" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >获奖成果添加</div></div></div><br />
                            ...
                            <td width="12%" align="left">
                             ...
                             <tr>
                                   ...
                                   <td align="left" width="12%">
                                      ...
                                      <tr>
                                       <td align="right" width="12%"><strong>获奖申请人:</strong> </td>
                                       <td align="left" width="12%">
                                   ...
                                   <tr>
                                       <td align="right" width="12%"><strong>获奖成果名称:</strong> </td>
                                       <td align="left" width="12%">
                                           <asp:TextBox ID="txtWinningName" runat="server" CssClass="input1"></asp:TextBox>
                                       </td>
                                       </td>
                                   </tr>
                                   <tr>
                                       <td align="right" width="12%"><strong>成果获奖时间:</strong> </td>
                                       <td align="left" width="12%">
                                           <asp:TextBox ID="txtWinningCategory" onfocus="WdatePicker()"  runat="server" CssClass="input1"></asp:TextBox>
                                       </td>
                                         <tr>
                                           <td align="right" width="12%"><strong>评奖部门:</strong> </td>
                                           <td align="left" width="12%">
                                       ...
                                       <tr>
                                           ...
                                           <td align="left" width="12%">
                                               <asp:TextBox ID="txtWinningValue" runat="server" CssClass="input1" ReadOnly="true" ></asp:TextBox>
                                           </td>
                                       </tr>
                                       <tr>
