...
var jQuery = window.jQuery = window.$ = function( selector, context ) {
	///	<summary>
	///		1: $(expression, context) - 使用CSS选择符等选择一组对象。
	///		2: $(html) - 创建DOM元素。
	///		3: $(elements) - 将DOM元素包装为jQuery对象。
	///		4: $(callback) - $(document).ready()的简写形式。
	///	</summary>
	///	<param name="selector" type="String">
	///		1: expression - 表达式，CSS选择符等，用以搜索文档。
	///		2: html - HTML代码。
	///		3: elements - DOM元素。
	///		4: callback - 函数。
	///	</param>
...
jQuery.fn = jQuery.prototype = {
	...
	append: function() {
	    ...
	    ///		内容[Content : String , Element , jQuery]
		///	</param>
	...
	hasClass: function( selector ) {
		///	<summary>
	    ///		判断元素时候拥有CSS类名，只要其中一个元素符合，返回真
		///	</summary>
		///	<param name="selector" type="String">CSS类名</param>
		///	<returns type="Boolean" />
	...
	replaceWith: function( value ) {
		///	<summary>
		///		用指定的HTML内容或DOM元素替换所有匹配的元素
		///	</summary>
		///	<param name="value" type="String">
	    ///		HTML内容或DOM元素
		///	</param>
		///	<returns type="jQuery">被替换的对象</returns>
	...
	slice: function() {
		...
		///		结束索引，不包括该索引，未指定则到结束位置
		///	</param>
		///	<returns type="jQuery">返回子集</returns>
	...
	data: function( key, value ){
		...
		///		为元素存储名值对的数据
		///	</summary>
		///	<param name="key" type="String">数据的名称</param>
		///	<param name="value" type="Any">数据的值</param>
		///	<returns type="Any">存储的值</returns>
	...
	removeData: function( key ){
		...
		///		删除存储在元素上的数据，内部方法
		///	</summary>
	    ///	<param name="key" type="Element">数据的名称</param>
...
function now(){
	...
	///		获取当前时间
	///	</summary>
    ///	<returns type="Date">当前时间</returns>
	return +new Date;
}
...
jQuery.extend({
	noConflict: function( deep ) {
		///	<summary>
		///		将‘$’的使用权交给先引用的类库，此时可以用‘jQuery’变量替代‘$’
		///		jQuery:Core 
		///	</summary>
	...
	isFunction: function( fn ) {
		...
		///		判断对象是否为函数
		///	</summary>
		///	<param name="fn" type="Object">将被检查的对象</param>
	...
	isXMLDoc: function( elem ) {
		...
		///		判断对象是否为XML文档
		///	</summary>
		///	<param name="elem" type="Object">将被检查的对象</param>
		///	<returns type="Boolean"></returns>
	...
	nodeName: function( elem, name ) {
		...
		///		检测元素是否包含指定的DOM节点名字
		///	</summary>
		///	<param name="elem" type="Element">将被检查的元素</param>
		///	<param name="name" type="String">节点名字</param>
		///	<returns type="Boolean"></returns>
	...
	data: function( elem, name, data ) {
		...
		///		存储名值对
		///	</summary>
		///	<param name="elem" type="Element">存储数据的元素</param>
		///	<param name="name" type="String">名</param>
		///	<param name="data" type="Object">值</param>
		///	<returns type="Object">存储的数据</returns>
	...
	removeData: function( elem, name ) {
		///	<summary>
		///		移除存储的数据Removes just this one named data store.
		///	</summary>
	    ///	<param name="elem" type="Element">存储将被删除数据的元素</param>
	...
	makeArray: function( array ) {
		...
		///		转换任何对象为数组，内部方法
		///	</summary>
	    ///	<param name="array" type="Object">任何对象</param>
		///	<returns type="Array" />
		///	<private />
	...
	inArray: function( elem, array ) {
		...
		///	<returns type="Number" integer="true">索引，从0开始</returns>
	...
	unique: function( array ) {
		...
		///		去除数组中重复的元素
		///	</summary>
		///	<param name="array" type="Array&lt;Element&gt;">数组</param>
		///	<returns type="Array&lt;Element&gt;">数组</returns>
	...
	grep: function( elems, callback, inv ) {
		///	<summary>
		///		过滤数组中的元素，筛选函数接收两个参数，一个是数组元素，一个是该元素的索引，该函数返回TRUE则保留当前索引元素，FALSE则删除
		///		});
		///		jQuery:JavaScript
		///	</summary>
		///	<returns type="Array" />
	...
	map: function( elems, callback ) {
		///	<summary>
	    ///		将一个数组转换为另一个数组，操作函数接收两个参数，一个是数组元素，一个是该元素的索引
		///		jQuery:JavaScript
		///	</summary>
		///	<returns type="Array" />
		///	<param name="elems" type="Array">
...
jQuery.each({
	...
	jQuery.fn[ name ] = function( selector ) {
		///	<summary>
		///        获取元素的所有子元素，包括文本节点，如果子元素是iframe，则返回其内容
		///   </summary>
		///	<returns type="jQuery" />
...
jQuery.each({
	...
	jQuery.fn[ name ] = function() {
		///	<summary>替换所有匹配元素</summary>
		///	<param name="selector" type="String">要替换元素的选择符</param>
		///	<returns type="jQuery" />
		var args = arguments;
...
jQuery.fn.extend({
	bind: function( type, data, fn ) {
		...
		///		绑定事件
		///	</summary>
		///	<param name="type" type="String">事件名称，多个以空格分割，既定名称为: blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
		///	<param name="data" optional="true" type="Object">可选，事件数据</param>
		///	<param name="fn" type="Function">事件，传递一个事件对象参数</param>
	...
	toggle: function( fn ) {
		...
		///		循环并依次触发事件
		///	</summary>
		///	<param name="fn" type="Function">多个事件</param>
	...
	hover: function(fnOver, fnOut) {
		...
		///		模拟悬停
		///	</summary>
		///	<param name="fnOver" type="Function">鼠标经过事件</param>
		///	<param name="fnOut" type="Function">鼠标离开事件</param>
	...
	ready: function(fn) {
		///	<summary>
		///		DOM文档加载完毕后执行函数Binds a function to be executed whenever the DOM is ready to be traversed and manipulated.
		///	</summary>
...
jQuery.fn.extend({
	...
	load: function( url, params, callback ) {
		...
		///		加载HTML页面并注入DOM
		///	</summary>
		///	<param name="url" type="String">HTML的地址，建议内部地址</param>
		///	<param name="data" optional="true" type="Map">可选，数据</param>
		///	<param name="callback" optional="true" type="Function">AJAX请求完成后执行</param>
		///	<returns type="jQuery" />
	...
	serialize: function() {
		...
		///		将表单数据序列化
		///	</summary>
		///	<returns type="String">数据，形如：tbName=john&pwd=123456</returns>
...
jQuery.extend({
	get: function( url, data, callback, type ) {
		...
		///	<param name="data" optional="true" type="Map">发送的数据，名值对</param>
		///	<param name="callback" optional="true" type="Function">当请求成功完成时执行的函数，参数为返回文本，类型有HTML,XML,JSON,TEXT 等</param>
		///	<param name="type" optional="true" type="String">返回数据的类型</param>
	...
	getJSON: function( url, data, callback ) {
	    ...
	    ///		发送GET请求JSON数据
		///	</summary>
		///	<param name="url" type="String">JSON数据的地址</param>
	    ///	<param name="data" optional="true" type="Map">发送的数据，名值对</param>
	    ///	<param name="callback" optional="true" type="Function">当请求成功完成时执行的函数，参数为返回文本，类型有HTML,XML,JSON,TEXT 等</param>
		///	<returns type="XMLHttpRequest" />
	...
	ajaxSetup: function( settings ) {
		...
		///		设置AJAX请求全局选项
		///	</summary>
	    ///	<param name="settings" type="Options">名值对，设置</param>
...
jQuery.fn.extend({
	show: function(speed,callback){
		...
		///		显示元素
		///	</summary>
	    ///	<param name="speed" type="String">预设的速度值 ('slow', 'normal', or 'fast')或毫秒数</param>
		///	<param name="callback" optional="true" type="Function">动画完成后执行的函数</param>
		///	<returns type="jQuery" />
	...
	animate: function( prop, speed, easing, callback ) {
		...
		///		动画函数
		///	</summary>
		///	<param name="prop" type="Options">名值对，设置</param>
	    ///	<param name="speed" type="String">预设的速度值 ('slow', 'normal', or 'fast')或毫秒数</param>
	    ///	<param name="easing" optional="true" type="String">缓动效果，预设：linear，swing</param>
	    ///	<param name="callback" optional="true" type="Function">动画完成后执行的函数</param>
	    ///	<returns type="jQuery" />
	...
	queue: function(type, fn){
		///	<summary>
		///		1: queue() - 获取第一个匹配元素上绑定的函数队列
		///		2: queue(callback) - 添加一个新函数，在队列执行完成以后执行
		///		3: queue(queue) - 用新的函数队列替换原来的函数队列
		///	</summary>
		///	<param name="type" type="Function">函数类型，默认为动画效果：fx</param>
		///	<returns type="jQuery" />
	...
	stop: function(clearQueue, gotoEnd){
		...
		///		停止元素的当前动画的执行
		///	</summary>
		///	<param name="clearQueue" optional="true" type="Boolean">设置为TRUE则清空函数队列</param>
		///	<param name="gotoEnd" optional="true" type="Boolean">设置为TRUE则执行完当前动画效果</param>
		///	<returns type="jQuery" />
...
jQuery.fn.dequeue = function(type){
	///	<summary>
	///		清除元素之前的函数队列，并执行后续的队列
	///	</summary>
    ///	<param name="type" type="String" optional="true">函数类型，默认为动画效果：fx</param>
	///	<returns type="jQuery" />
...
jQuery.fn.offset = function() {
	///	<summary>
	///		获取第一个匹配元素相对于浏览器窗口的位置
	///	</summary>
	///	<returns type="Object">元素的位置属性，包括： 'top'，'left'</returns>
...
jQuery.each( ['Left' ], function(i, name) {
	...
	jQuery.fn[ method ] = function(val) {
		///	<summary>
		///		获取或设置第一个匹配元素的相对水平滚动条的位置
		///	</summary>
		///	<param name="val" type="Number" integer="true" optional="true">想要设置的数值</param>
		///	<returns type="Number" integer="true">获取的数值</returns>
		if (!this[0]) return;
...
jQuery.each([ "Height" ], function(i, name){
	...
	jQuery.fn["inner" + name] = function(){
		///	<summary>
		///		获取第一个匹配元素的内部高度，不包括边框，但包含内边距
		///	</summary>
	    ///	<returns type="Number" integer="true">内部高度</returns>
	...
	jQuery.fn["outer" + name] = function(margin) {
		///	<summary>
	    ///		获取第一个匹配元素的内部高度，默认包括边框和内边距
		///	</summary>
		///	<param name="margins" type="Boolean">是否包含外边距</param>
	    ///	<returns type="Number" integer="true">外部高度</returns>
...
jQuery.each( [ "Width" ], function(i, name) {
	...
	jQuery.fn["inner" + name] = function(){
		///	<summary>
    	///		获取第一个匹配元素的内部宽度，不包括边框，但包含内边距
		///	</summary>
	    ///	<returns type="Number" integer="true">内部宽度</returns>
