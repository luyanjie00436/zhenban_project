<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EducationAdd.aspx.cs" Inherits="sanmingScientManage_Web.EducationAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtEducationName" CssClass="input6" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
