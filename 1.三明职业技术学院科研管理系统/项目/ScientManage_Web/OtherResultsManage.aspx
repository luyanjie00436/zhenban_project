<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherResultsManage.aspx.cs" Inherits="sanmingScientManage_Web.OtherResultsManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >其他成果</div></div></div><br />
        ...
        <div style="margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                         ...
                         <td width="10%" align="right">
                            <strong>其他成果名称：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtOtherResultsName" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                      <%--  <td width="10%" align="right">
                            <strong>鉴定单位：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtCompany" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>--%>
                               <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                      ...
                      ShowHeaderWhenEmpty="true"     OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="级别" HeaderText="级别">
                             ...
                             <asp:BoundField DataField="其他成果名称" HeaderText="其他成果名称">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                                <asp:BoundField DataField="获得日期" HeaderText="获得日期">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
