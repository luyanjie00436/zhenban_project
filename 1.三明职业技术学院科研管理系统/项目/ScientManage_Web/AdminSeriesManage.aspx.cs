...
{
    public partial class AdminSeriesManage : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            ...
            GridView1.DataSource = bus.Select("AdminSeries_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            if (bus.AdminSeriesDelete("AdminSeries_Delete", Convert.ToInt32(e.CommandArgument.ToString()),UserCardId))
            {
