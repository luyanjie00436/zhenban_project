<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestDetailed.aspx.cs" Inherits="sanmingScientManage_Web.HarvestDetailed" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >科技成果申请表</div></div></div><br />
        <div class="page_main01">
            
  <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
            <tr class="tr14">
                <td style="padding: 0 0 9px 0; margin: 0;float:left;  margin-left:142px;">
                    <input onclick="javascript: window.history.go(-1);" type="button" value="返回上一页" 

class="btn11" />
                <asp:Button  runat="server" ID="buttom2"  CssClass="btn" Text="导 出" OnClick="buttom2_Click"/></td>
            </tr>
        </table>
                         ...
                         <tr>
                          ...
                          <tr>
                              ...
                              <td class="td5"  align="left">
                                ...
                                <td class="td5"  align="left">
                                  <asp:Label ID="LAwardsDate" runat="server" ></asp:Label>
                              </td>
                                 <td class="td5"  align="left">
                          ...
                          <tr>
                              ...
                              <td class="td4">
                                  合作者列表</td>
                              <td class="td4" colspan="7" style=" width:730px">
