<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsOReviewScoreManage.aspx.cs" Inherits="ScientManage_Web2.LongProjectsOReviewScoreManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >其他项目评分</div></div></div><br />
                  ...
                  <Columns>
                            ...
                            <asp:BoundField DataField="Score" HeaderText="分值">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("OReviewId") %>'>评分</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
