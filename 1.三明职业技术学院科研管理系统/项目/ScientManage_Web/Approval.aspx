<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="sanmingScientManage_Web.Approval" %>
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                <ContentTemplate>
                   <div class="page_title">
                        <p style="font-size:20px;padding-left:12px;" id="tbs7" runat="server">科技成果审批表</p>
