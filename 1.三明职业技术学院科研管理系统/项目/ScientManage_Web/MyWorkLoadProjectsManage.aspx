<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyWorkLoadProjectsManage.aspx.cs" Inherits="sanmingScientManage_Web.MyWorkLoadProjectsManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >个人科研项目记录</div></div></div><br />
                        ...
                        <Columns>        
                          <asp:BoundField DataField="UserName" HeaderText="姓名">
                             ...
                             <asp:BoundField DataField="WorkLoadProjectsName" HeaderText="工作量项目名称">
                                ...
                                <asp:BoundField DataField="WorkLoadFrom" HeaderText="项目来源">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                         <asp:BoundField DataField="ProjectDate" HeaderText="立项日期">
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("WorkLoadProjectsId") %>'>查看详情</asp:LinkButton>
                                       
                                          <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("WorkLoadProjectsId") %>'>修改</asp:LinkButton>
