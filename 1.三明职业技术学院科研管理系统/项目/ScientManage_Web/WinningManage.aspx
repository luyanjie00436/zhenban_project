<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinningManage.aspx.cs" Inherits="sanmingScientManage_Web.WinningManage" %>
...
<body>
 ...
 <div class="min_height">
        <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2">成果获奖</div></div></div><br />
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <tr>
                      ...
                      <td width="10%" align="right">
                            <strong>获奖成果名称：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtWinningName" runat="server"  CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                           <td width="10%" align="right">
                            <strong>评奖部门：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtWinningForm" onfocus="WdatePicker()"  CssClass="select1" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>  
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                      ShowHeaderWhenEmpty="true"     OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>
                             <asp:BoundField DataField="申请人工号" HeaderText="申请人工号">
                            ...
                            <asp:BoundField DataField="级别" HeaderText="级别">
                             ...
                             <asp:BoundField DataField="获奖成果名称" HeaderText="获奖成果名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                             <asp:BoundField DataField="评奖部门" HeaderText="评奖部门">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                                <asp:BoundField DataField="成果获奖时间" HeaderText="成果获奖时间">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
