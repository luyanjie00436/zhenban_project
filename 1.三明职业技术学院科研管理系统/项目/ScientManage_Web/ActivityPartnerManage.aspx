<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityPartnerManage.aspx.cs" Inherits="sanmingScientManage_Web.ActivityPartnerManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >学术活动合作者</div></div></div><br />
                ...
                <div style="margin-bottom: 10px">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DlActivity" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Partner_SelectedIndexChanged"
                                    CssClass="input1">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true"  Width="98%">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("ActivityPartnerId") %>'
                                            OnCommand="LinkButton6_Command">编辑</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("ActivityPartnerId") %>'
