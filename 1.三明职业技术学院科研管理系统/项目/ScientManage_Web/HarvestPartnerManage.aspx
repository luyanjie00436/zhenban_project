<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestPartnerManage.aspx.cs" Inherits="sanmingScientManage_Web.HarvestPartnerManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >科技成果合作者</div></div></div><br />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div style="margin: 5px 0px 0px 0px; text-align: center;">
                    <asp:GridView ID="GridView1"  BackColor=" #d4d2d2"   CssClass="juzhong" ShowHeaderWhenEmpty="true"  runat="server" AutoGenerateColumns="False"   Width="98%">
