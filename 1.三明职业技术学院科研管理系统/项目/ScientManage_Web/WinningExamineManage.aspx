<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinningExamineManage.aspx.cs" Inherits="sanmingScientManage_Web.WinningExamineManage" %>
...
<body>
 ...
 <div class="min_height">
          <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >获奖项目审批表</div></div></div><br />
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                             ...
                             <asp:BoundField DataField="WinningName" HeaderText="获奖项目名称">
                                ...
                                <asp:BoundField DataField="WinningCategory" HeaderText="获奖项目时间">
                                <HeaderStyle Width="11%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="FollDate" HeaderText="申报时间">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("WinningId") %>' ToolTip="点击此处审批">审批</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
