...
namespace sanmingScientManage_Data
{
    public class GetData
    {
        ...
        /// 考核等级信息添加
        /// </summary>
        public bool AssessRankInsert(string proc, string JobId, string RankName, double MinValue, double MaxValue, string RankExplain, string UserCardId)
        {
        ...
        /// 考核等级信息修改
        /// </summary>
        public bool AssessRankUpdate(string proc,  int AssessRankId, int JobId, string RankName, double MinValue, double MaxValue, string RankExplain, string UserCardId)
        {
        ...
        public bool AssciationInsert(string proc, string AssciationName,  string Explain, string UserCardId)
        {
            return human.AssciationInsert(proc, AssciationName, Explain, UserCardId);
        }
        /// <summary>
        /// 学术团体修改
        /// </summary>

        public bool AssciationUpdate(string proc, int AssciationId, string AssciationName,string Explain)
        {
            return human.AssciationUpdate(proc, AssciationId, AssciationName, Explain);
        }
        /// <summary>
        /// 学术团体删除
        /// </summary>
        ...
        /// 学术团体记录查询
        /// </summary>
        public DataSet SelectsAssociation(string proc, string UserName, string DepartmentId, int Year, int Month, string Status, string AssociationName)
        {
            return human.SelectsAssociation(proc, UserName, DepartmentId, Year, Month, Status, AssociationName);
        ...
        public bool DuesInsert(string proc, string AssciationName, string Cost, string UserCardId)
        {
            return human.DuesInsert(proc, AssciationName, Cost, UserCardId);
        }
        /// <summary>
        /// 会费修改
        /// </summary>

        public bool DuesUpdate(string proc, int DuesId, string AssciationName, string Cost)
        {
            return human.DuesUpdate(proc, DuesId, AssciationName, Cost);
        }
        ...
        public DataSet SelectByDuesId(string proc, int DuesId)
        {
            return human.SelectByDuesId(proc, DuesId);
        }
        /// <summary>
        /// 会费审批添加
        /// </summary>
        public bool DuesExamineInsert(string proc, int DuesId, string ExamineOpinion, string ExamineUserCardId, string ExamineResult, int RankId)
        {
            return human.DuesExamineInsert(proc, DuesId, ExamineOpinion, ExamineUserCardId, ExamineResult, RankId);

        }
        /// <summary>
        /// 会费审批流程删除
        /// </summary>
        public bool DuesProcessDelete(string proc, int DuesProcessId, string UserCardId)
        {
            return human.DuesProcessDelete(proc, DuesProcessId, UserCardId);

        }
        /// <summary>
        /// 会费删除
        /// </summary>
        public bool DuesDelete(string proc, int DuesId)
        {
            return human.DuesDelete(proc, DuesId);
        }
        #endregion
        #region 讲座
        /// <summary>
        ...
        /// 工作量项目修改
        /// </summary>
        public bool WorkLoadProjectsUpdate(string proc, int WorkLoadProjectsId, string ProjectsId, string WorkLoadProjectsName, string WorkLoadForm, string ProjectDate, string ConcludingDate, string WorkLoadCapital, double WorkLoadProjectsValue, int PartnerRank, double PartnerValue, double ProjectsValue, double ConcludingValue, string DCategory, string DLevel, string Remarks)
        {
        ...
        /// 论文申请
        /// </summary>
        public bool PaperInsert(string proc, string UserCardId, string PaperName, string PaperSubject,string AuthorsOrder, string DCategory, string DLevel, double PaperValue, int PartnerRank, double PartnerValue, string PaperYears, string Remarks,string PublicationName, string PaperDate)
        {
            return human.PaperInsert(proc, UserCardId, PaperName, PaperSubject, AuthorsOrder,DCategory, DLevel, PaperValue, PartnerRank, PartnerValue, PaperYears, Remarks,PublicationName,PaperDate);
        ...
        /// 论文修改
        /// </summary>
        public bool PaperUpdate(string proc, int PaperId, string PaperName, string PaperSubject, string AuthorsOrder, string DCategory, string DLevel, double PaperValue, int PartnerRank, double PartnerValue, string PaperYears, string Remarks, string PublicationName, string PaperDate)
        {
            return human.PaperUpdate(proc, PaperId, PaperName, PaperSubject, AuthorsOrder, DCategory, DLevel, PaperValue, PartnerRank, PartnerValue, PaperYears, Remarks, PublicationName, PaperDate);
        ...
        /// 纵向项目基础信息保存
        /// </summary>
        public bool LongProjectsInsert(string proc, string LongProjectsId, string UserCardId, string ProjectsName, int ProjectsFromId, int ProjectsSubjectId, int ProjectsLevelId, string Company, string DeclareUrl)
        {
            return human.LongProjectsInsert(proc, LongProjectsId, UserCardId, ProjectsName, ProjectsFromId, ProjectsSubjectId, ProjectsLevelId, Company, DeclareUrl);
        ...
        /// 纵向项目查询
        /// </summary>
        public DataSet SelectsLongProjects(string proc, string ProjectsId, string ProjectsName, string UserName, string DepartmentName, string ApplyYear, string Subject, string Level, string From, string Declare, string Stand, string Inspect, string Ends, int Year, int Month)
        {
            return human.SelectsLongProjects(proc, ProjectsId, ProjectsName, UserName, DepartmentName, ApplyYear, Subject, Level, From, Declare, Stand, Inspect, Ends, Year,  Month);
        ...
        /// </summary>
        /// <param name="proc"></param>
        /// <param name="LongProjectsId"></param>
        /// <param name="TransferStatus"></param>
        /// <returns></returns>
        public bool LongProjectsUpdatinspectStatus(string proc, string LongProjectsId ,string TransferStatus)
        {
            return human.LongProjectsUpdatingspecStatus(proc,LongProjectsId,TransferStatus);
        }
        ...
        /// 纵向项目立项审批添加
        /// </summary>
        public bool LongProjectsStandExamineInsert(string proc, string LongProjectsId, string ExamineOpinion, string ExamineUserCardId, string ExamineResult, int RankId,string NewLongProjectsId)
        {
            return human.LongProjectsStandExamineInsert(proc, LongProjectsId, ExamineOpinion, ExamineUserCardId, ExamineResult, RankId,NewLongProjectsId);

        }
        /// <summary>
        /// 纵向项目评审添加
        /// </summary>
        public bool LongProjectsApprovalBranchInsert(string proc, string LongProjectsId, string UserCardId, double Branch,string ExamineOpinion)
        {
            return human.LongProjectsApprovalBranchInsert(proc, LongProjectsId, UserCardId, Branch, ExamineOpinion);
        ...
        /// 其他项目添加
        /// </summary>
        public bool LongProjectsOReviewInsert(string proc, string ReviewFileUrl, string Starttime, string Endtime, string Remarks)
        {
            return human.LongProjectsOReviewInsert(proc, ReviewFileUrl, Starttime, Endtime, Remarks);

        }
        /// <summary>
        /// 其他项目修改
        /// </summary>
        public bool LongProjectsOReviewUpdate(string proc, int OReviewId, string ReviewFileUrl, string Starttime, string Endtime, string Remarks)
        {
            return human.LongProjectsOReviewUpdate(proc, OReviewId, ReviewFileUrl, Starttime, Endtime, Remarks);

        }
        /// <summary>
        /// 其他项目编号查询
        /// </summary>
        public DataSet SelectByOReviewId(string proc, int OReviewId)
        {
            return human.SelectByOReviewId(proc, OReviewId);

        }
        /// <summary>
        /// 其他项目删除
        /// </summary>
        public bool LongProjectsOReviewDelete(string proc, string OReviewId)
        {
            return human.LongProjectsOReviewDelete(proc, OReviewId);
        }
        /// <summary>
        /// 其他项目评审添加
        /// </summary>
        public bool LongProjectsOReviewScoreInsert(string proc, int OReviewId, string UserCardId, double Score,string ExamineOpinion)
        {
            return human.LongProjectsOReviewScoreInsert(proc, OReviewId, UserCardId, Score, ExamineOpinion);

        }
        /// <summary>
        /// 按其他项目编号,用户工号查询
        /// </summary>
        public DataSet SelectByLongUser(string proc, int OReviewId, string UserCardId)
        {
            return human.SelectByLongUser(proc, OReviewId, UserCardId);

        }
        /// <summary>
        /// 其他评分项目查询
        /// </summary>
        public DataSet SelectsOReview(string proc, string Remarks)
        {
            return human.SelectsOReview(proc, Remarks);
