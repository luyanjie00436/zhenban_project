<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEnable.aspx.cs" Inherits="HumanManage_Web.UserEnable" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtUserCardId" data-toggle="tooltip" data-placement="top"  ToolTip="请输入用户工号" CssClass="input6" runat="server" Height="27px" Width="137px"  Enabled="false"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="auto-style1">
                       ...
                       <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:RadioButtonList ID="RBList1" data-toggle="tooltip" data-placement="top"  title="请选择是否用户启用状态" runat="server" RepeatDirection="Horizontal">
                    ...
                    <tr>
                        <td align="right" class="auto-style1">
                            <strong>用户信息锁定：</strong>
                        </td>
                        <td width="70%" align="left">
                            <asp:RadioButtonList ID="RadioUserLock" data-toggle="tooltip" data-placement="top"  title="请选择是否用户启用状态" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem>锁定</asp:ListItem>
                                <asp:ListItem>可修改</asp:ListItem>
                            </asp:RadioButtonList>
                             </td>
                    </tr>
