...
{
    public partial class RecruitmentPostManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/RecruitmentPostManage.aspx") == 0)
                {
                    Response.Redirect("Login.aspx");
                }
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("RecruitmentPostDetailed.aspx?Recruitment=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectTransfer("RecruitmentPost_Selects", UserName, Year, Month).Tables[0];
        ...
        {
            Response.Redirect("RecruitmentPostAdd.aspx?Recruitment=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {

            if (bus.RecruitmentDelete("RecruitmentPost_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
