<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NationAdd.aspx.cs" Inherits="HumanManage_Web.NationAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left"> 
                            <asp:TextBox ID="txtNationName" data-toggle="tooltip" data-placement="top"  ToolTip="请输入民族名称" runat="server"  CssClass="input6"  Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
