<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudyTrainStatusManage.aspx.cs" Inherits="HumanResources.StudyTrainStatusManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >进修培训修改管理</div></div></div>
    <div class="page_main01">
        ...
        <asp:Button ID="Button1" runat="server" CssClass="btn" data-placement="top" data-toggle="tooltip" OnClick="Button1_Click" Text="查 找" ToolTip="点击查找" />
            <asp:LinkButton ID="LinkButton9"  runat="server" CssClass="btn_right"  data-toggle="tooltip" data-placement="top"  ToolTip="刷新当前页面" OnClick="LinkButton9_Click">刷 新</asp:LinkButton><div style="margin-top: 10px">
                       ...
                       ShowHeaderWhenEmpty="True"  OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="姓名" HeaderText="姓名">
                            ...
                            <asp:BoundField DataField="培训项目名称" HeaderText="培训项目名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="培训开始时间" HeaderText="培训开始时间">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                                <asp:BoundField DataField="培训结束时间" HeaderText="培训结束时间">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="培训单位" HeaderText="培训单位">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="备注" HeaderText="备注">
                              ...
                              <asp:TemplateField HeaderText="查看照片">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='StudyTrainPhoto.aspx?StudyTrain=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox" >
                                            查看照片</a>  
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='StudyTrainUpd.aspx?StudyTrain=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox">
                                            修改信息</a>  
