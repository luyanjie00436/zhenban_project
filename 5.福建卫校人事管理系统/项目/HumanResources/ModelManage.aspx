<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModelManage.aspx.cs" Inherits="HumanManage_Web.ModelManage" %>
...
<body>
 ...
 <div class="min_height">
    <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >目录信息</div></div></div>
            ...
            <tr>
                ...
                <td width="20%">
                    <asp:DropDownList ID="DlModel"  runat="server"  Style="margin-left: 0px; width: 80px;"
                        CssClass="select1" data-toggle="tooltip" data-placement="top"  ToolTip="点击选择目录名称">
  ...
  data-toggle="tooltip" data-placement="top"  title="点击添加进入新增目录页面"  >添 加</a>
