...
{
    public partial class DelayQuitViewManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable dt = bus.UserViewSelects("DelayQuitView_Selects", "*", "").Tables[0];
        ...
        protected void Button12_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.UserViewSelects("DelayQuitView_Selects", Selects, Wheres).Tables[0];
