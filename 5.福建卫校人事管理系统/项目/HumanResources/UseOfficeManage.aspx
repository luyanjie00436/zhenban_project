<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseOfficeManage.aspx.cs" Inherits="HumanManage_Web.UseOfficeManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >职称任聘管理</div></div></div>
      ...
      <br />
           ...
           <div style="float:right;margin-right:20px;">
               ...
               <a id="OfficeAdda" runat="server" href="UseOfficeAdd.aspx"  class="fLink thickbox" style="  
 ...
 data-toggle="tooltip" data-placement="top"  title ="点击进入新增专业技术资格名称">添 加</a>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          ...
                                          <a href='UseOfficeAdd.aspx?UseOffice=<%# Eval("UseOfficeId")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox xg ">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9"   CommandArgument='<%# Eval("UseOfficeId") %>' runat="server"
