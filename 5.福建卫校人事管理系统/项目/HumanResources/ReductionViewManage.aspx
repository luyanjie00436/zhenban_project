<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReductionViewManage.aspx.cs" Inherits="HumanManage_Web.ReductionViewManage" %>
...
<body>
    <form id="form1" runat="server">
      <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >减免工作量综合查询</div></div></div>
     ...
     <p>基础信息</p>
       ...
       <asp:ListItem>第一学历</asp:ListItem>
              ...
              <asp:CheckBoxList ID="CBlist8" runat="server" CssClass="esp" RepeatColumns="7" RepeatDirection="Horizontal" OnSelectedIndexChanged="CBlist1_SelectedIndexChanged" Font-Size="16px" Font-Names="微软雅黑" BorderColor="#a9a9a9" BorderStyle="Solid" BorderWidth="1px" CellSpacing="2">
                  <asp:ListItem>职称职级</asp:ListItem>
                  <asp:ListItem>部门</asp:ListItem>
                  <asp:ListItem>年份</asp:ListItem>
                  <asp:ListItem>理由</asp:ListItem>
                  <asp:ListItem>教学额定工作量</asp:ListItem>
                  <asp:ListItem>教学减免后工作量</asp:ListItem>
                  <asp:ListItem>教学减免比例</asp:ListItem>
                  <asp:ListItem>教学建设额定工作量</asp:ListItem>
                  <asp:ListItem>教学建设减免后工作量</asp:ListItem>
                  <asp:ListItem>教学建设减免比例</asp:ListItem>
                  <asp:ListItem>社会额定工作量</asp:ListItem>
                  <asp:ListItem>社会减免后工作量</asp:ListItem>
                  <asp:ListItem>社会减免比例</asp:ListItem>
                  <asp:ListItem>是否停发相应岗位津贴</asp:ListItem>
                  <asp:ListItem>停发比例</asp:ListItem>
                  <asp:ListItem>停发时间</asp:ListItem>
              </asp:CheckBoxList>
