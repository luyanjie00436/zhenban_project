<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobCertificateStatusManage.aspx.cs" Inherits="HumanResources.JobCertificateStatusManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >职业资格证书修改管理</div></div></div>
                       ...
                       ShowHeaderWhenEmpty="True"  OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="姓名" HeaderText="姓名">
                            ...
                            <asp:BoundField DataField="职业资格名称" HeaderText="职业资格名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="发证单位" HeaderText="发证单位">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="获得时间" HeaderText="获得时间">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="备注" HeaderText="备注">
                             ...
                             <asp:TemplateField HeaderText="查看照片">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='JobCertificatePhoto.aspx?JobCertificate=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox" >
                                            查看照片</a>  
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='JobCertificateUpd.aspx?JobCertificate=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox">
                                            修改信息</a>  
