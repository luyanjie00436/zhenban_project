<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParttimejobExamineManage.aspx.cs" Inherits="HumanResources.ParttimejobExamineManage" %>
...
<body>
    ...
    <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >社会兼职情况审批</div></div></div>
                           ...
                           <Columns>
                               <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:CheckBox ID="cbMore" runat="server" CommandArgument='<%# Eval("ParttimejobId") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                                 <asp:TemplateField HeaderText="编号">
                                       <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemTemplate>
                                    <asp:Label ID="LOfficeId" runat="server" Text='<%#Eval("ParttimejobId") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="LinkButton1_Command" CommandArgument='<%# Eval("ParttimejobId") %>' >同意</asp:LinkButton>
                                                 <asp:LinkButton ID="LinkButton2" runat="server" OnCommand="LinkButton2_Command" CommandArgument='<%# Eval("ParttimejobId") %>' >拒绝</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
