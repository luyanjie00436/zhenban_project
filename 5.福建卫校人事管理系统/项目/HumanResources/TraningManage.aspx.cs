...
{
    public partial class TraningManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/TraningManage.aspx") == 0)
                {
                    Response.Redirect("Login.aspx");
                }
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("TraningDetailed.aspx?Traning=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        public void dataGriviewBD()
        {
           ...
           string seYear = DlYear.SelectedItem.ToString();
            ...
            DataTable dt = bus.SelectTransfer("Traning_Selects", UserName, Year, Month).Tables[0];
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("TraningManage.aspx");
        }
        protected void LinkButton8_Command(object sender, CommandEventArgs e)
        {
            Response.Redirect("TraningDetailedalter.aspx?Traning=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {

            if (bus.TraningDelete("Traning_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
