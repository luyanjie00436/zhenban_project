<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyTitleManagePersonal.aspx.cs" Inherits="HumanManage_Web.ApplyTitleManagePersonal" %>
...
<body>
    <form id="form1" runat="server">
        <div class="min_height">
            <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >个人职称考核申请记录</div></div></div>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                ...
                                                <asp:LinkButton ID="LinkButton9" runat="server" OnCommand="LinkButton9_Command" CommandArgument='<%# Eval("ApplyTitleId") %>'>删除<br/></asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="LinkButton1_Command" CommandArgument='<%# Eval("ApplyTitleId") %>'>附件管理</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
