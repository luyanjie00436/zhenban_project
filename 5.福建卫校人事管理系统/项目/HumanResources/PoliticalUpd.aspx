<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PoliticalUpd.aspx.cs" Inherits="HumanManage_Web.PoliticalUpd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtPoliticalName" CssClass="input6" data-toggle="tooltip" data-placement="top"  ToolTip="请输入政治面貌名称" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
