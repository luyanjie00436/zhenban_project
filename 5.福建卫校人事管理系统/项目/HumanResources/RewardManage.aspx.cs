...
{
    public partial class RewardManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/RewardManage.aspx") == 0)
                {
                    Response.Redirect("Login.aspx");
                }
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("RewardDetailed.aspx?Reward=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        public void dataGriviewBD()
        {
            ...
            string Reward = DlReward.SelectedItem.Text;
          
            if (Reward == "选择奖惩")
            {
                Reward = "";
            }
            DataTable dt = bus.SelectReward("Reward_Selects", UserName, Year, Month, Reward).Tables[0];
        ...
        {
            Response.Redirect("RewardAdd.aspx?Reward=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");

        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {

            if (bus.RewardDelete("Reward_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
