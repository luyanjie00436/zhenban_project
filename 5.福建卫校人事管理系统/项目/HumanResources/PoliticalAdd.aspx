<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PoliticalAdd.aspx.cs" Inherits="HumanManage_Web.PoliticalAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtPoliticalName" data-toggle="tooltip" data-placement="top"  ToolTip="请输入政治面貌名称"  CssClass="input6" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
