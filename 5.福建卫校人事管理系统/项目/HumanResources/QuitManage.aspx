<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuitManage.aspx.cs" Inherits="HumanManage_Web.QuitManage" %>
...
<body>
 ...
 <div class="min_height">
    <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >人员离职记录</div></div></div>
                ...
                <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtUserName" data-toggle="tooltip" data-placement="top"  ToolTip="请输入用户姓名 例如（119999）" CssClass="select1" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                         ...
                         <td width="10%" align="right">
                            ...
                            <td width="20%" align="left">
                                <asp:DropDownList ID="DlYear" data-toggle="tooltip" data-placement="top"  ToolTip="点击选择年份" runat="server" CssClass="select1" Width="80px">
                               ...
                               <asp:DropDownList ID="DlMonth" runat="server" data-toggle="tooltip" data-placement="top"  ToolTip="点击选择月份" CssClass="select1" Width="80px">
                          ...
                          <td>
                                <asp:Button ID="Button1" runat="server" CssClass="btn" data-toggle="tooltip" data-placement="top"  ToolTip="点击进行查找" OnClick="Button1_Click" Text="查 找" />
                             </td>
                    </tr>
                </table>
                    <br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                     ShowHeaderWhenEmpty="True"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                             <asp:BoundField DataField="QuitId" HeaderText="离职退休编号">
                            ...
                            <asp:BoundField DataField="Status" HeaderText="离职/退休">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                              <asp:BoundField DataField="QuitDate" HeaderText="离职日期">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("QuitId") %>'>查看详情</asp:LinkButton>
                                     <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("QuitId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("QuitId") %>' runat="server"
