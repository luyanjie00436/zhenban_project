<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuitViewManage.aspx.cs" Inherits="HumanManage_Web.QuitViewManage" %>
...
<body>
    <form id="form1" runat="server">
      <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >离职退休综合查询</div></div></div>
     ...
     <p>基础信息</p>
       ...
       <asp:ListItem>第一学历</asp:ListItem>
              ...
              <asp:CheckBoxList ID="CBlist8" runat="server" CssClass="esp" RepeatColumns="7" RepeatDirection="Horizontal" OnSelectedIndexChanged="CBlist1_SelectedIndexChanged" Font-Size="16px" Font-Names="微软雅黑" BorderColor="#a9a9a9" BorderStyle="Solid" BorderWidth="1px" CellSpacing="2">
                  <asp:ListItem>离职或退休</asp:ListItem>
                  <asp:ListItem>退休日期</asp:ListItem>
                  <asp:ListItem>退休理由</asp:ListItem>
