<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PoliticalManage.aspx.cs" Inherits="HumanManage_Web.PoliticalManage" %>
...
<body>
 ...
 <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >政治面貌管理</div></div></div>

      <br />
           <div style="float:right;margin-right:20px;">
     <a href="PoliticalAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
 ...
 data-toggle="tooltip" data-placement="top"  title="点击进入新增政治面貌页面"   >添 加</a>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='PoliticalUpd.aspx?Political=<%# Eval("PoliticalId")%>&keepThis=true&TB_iframe=true&height=300&width=500'   class="fLink thickbox">
                                            修改</a>  
