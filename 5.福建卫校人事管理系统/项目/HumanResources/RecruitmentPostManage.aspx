<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecruitmentPostManage.aspx.cs" Inherits="HumanManage_Web.RecruitmentPostManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >岗位申请记录</div></div></div>
                ...
                <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtUserName" data-toggle="tooltip" data-placement="top"  ToolTip="点击填写申请人姓名 例如（张三）" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    ...
                    ShowHeaderWhenEmpty="True"     OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                             ...
                             <asp:BoundField DataField="UserCardId" HeaderText="申请人工号">
                                <HeaderStyle Width="10%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="UserName" HeaderText="申请人姓名">
                                <HeaderStyle Width="10%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="PostName" HeaderText="岗位">
                              ...
                              <asp:BoundField DataField="Money" HeaderText="月薪">
                                <HeaderStyle Width="10%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("RecruitmentId") %>'>查看详情</asp:LinkButton>
                                          <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("RecruitmentId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("RecruitmentId") %>' runat="server"
