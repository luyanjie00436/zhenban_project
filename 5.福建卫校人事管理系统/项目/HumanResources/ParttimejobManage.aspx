<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParttimejobManage.aspx.cs" Inherits="HumanResources.ParttimejobManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >社会兼职情况管理</div></div></div>
      ...
      <br />
           ...
           <div style="float:right;margin-right:20px;">
               ...
               <a id="OfficeAdda" runat="server" href="ParttimejobAdd.aspx"  class="fLink thickbox" style="  
 ...
 data-toggle="tooltip" data-placement="top"  title ="点击进入新增社会兼职">添 加</a>
                    ...
                    <asp:GridView ID="GridView1" runat="server"  BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                       ...
                       <asp:BoundField DataField="UnitName" HeaderText="单位名称" >
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                     <div class="link02">
                              <a href='ParttimejobAdd.aspx?Parttimejob=<%# Eval("ParttimejobId")%>&keepThis=true&TB_iframe=true&height=400&width=500' class="fLink thickbox">修改</a>

                              <asp:LinkButton ID="LinkButton2"  CommandArgument='<%# Eval("ParttimejobId") %>' OnCommand="LinkButton2_Command" runat="server">删除</asp:LinkButton>
