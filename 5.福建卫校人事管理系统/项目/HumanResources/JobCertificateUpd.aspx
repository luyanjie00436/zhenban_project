<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobCertificateUpd.aspx.cs" Inherits="HumanResources.JobCertificateUpd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">     
                    ...
                    <tr class="tr10">
                        ...
                        <td width="70%" height="80" align="left" valign="middle" style=" background:none;">
                           <asp:Button ID="Button2" runat="server" Text="修 改" data-toggle="tooltip" data-placement="top"  ToolTip="点击修改" OnClientClick=" return xiugai()" OnClick="Button2_Click" CssClass="btn" />
                        </td>
                    </tr>
