<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RankAdd.aspx.cs" Inherits="HumanManage_Web.RankAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtRankName" runat="server"   CssClass="input6" Height="27px"  data-toggle="tooltip" data-placement="top"  ToolTip="请输入角色名称" Width="137px" ></asp:TextBox>
                        </td>
                    </tr>
                        <tr>
                        <td align="right" class="auto-style1">
