<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RewardAdd.aspx.cs" Inherits="HumanManage_Web.RewardAdd" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
        <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >奖惩信息申请</div></div></div>
        <br />
                ...
                <ContentTemplate>
                    <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td width="12%" align="left">
                                 <asp:DropDownList ID="DlReward" runat="server" data-toggle="tooltip" data-placement="top"  ToolTip="点击选择奖励或者惩罚" CssClass="select1" Width="90%" >
                                 <asp:ListItem>请选择奖励/惩罚</asp:ListItem>
                            ...
                            <td width="12%" align="left">
                               <asp:TextBox ID="txtRewardForm" data-toggle="tooltip" data-placement="top"  ToolTip="请填写奖惩形式"  runat="server"  CssClass="select1"></asp:TextBox>
                                 </td>
                              <td width="12%" align="right">
                                <strong>授予单位：</strong>
                            </td>
                            <td width="12%" align="left">
                               <asp:TextBox ID="txtRewardCompany" data-toggle="tooltip" data-placement="top"  ToolTip="请填写授予单位"  runat="server"  CssClass="select1"></asp:TextBox>
                                 </td>
                              <td width="12%" align="right">
                                <strong>授予时间：</strong>
                            </td>
                            <td width="12%" align="left">
                                <input id="txtRewardDates" data-toggle="tooltip" data-placement="top"  title="请选择授予时间" runat="server" cssclass="Wdate" readonly="true" onfocus="WdatePicker()" class="select1"/>
                                 </td>
                               </tr>  
                        <tr>
                            <td width="12%" align="right">
                            ...
                            <td colspan="7">
                                 <asp:TextBox Height="120" ID="txtRewardContent" style="overflow-y:auto" runat="server" data-toggle="tooltip" data-placement="top"  ToolTip="请填写项目名称" CssClass="select1" width="98%" Columns="1" MaxLength="400" Rows="5" TextMode="MultiLine"></asp:TextBox>
