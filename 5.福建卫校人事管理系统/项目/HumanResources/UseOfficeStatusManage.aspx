<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseOfficeStatusManage.aspx.cs" Inherits="HumanResources.UseOfficeStatusManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >职称任聘修改管理</div></div></div>
    <div class="page_main01">
        ...
        <asp:Button ID="Button1" runat="server" CssClass="btn" data-placement="top" data-toggle="tooltip" OnClick="Button1_Click" Text="查 找" ToolTip="点击查找" />
         <asp:Button ID="Button2" runat="server" CssClass="btn" data-placement="top" data-toggle="tooltip" OnClick="Button1_Click" Text="刷 新" ToolTip="点击刷新页面" />
                       ...
                       ShowHeaderWhenEmpty="True"  OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="姓名" HeaderText="姓名">
                            ...
                            <asp:BoundField DataField="聘任时间" HeaderText="聘任时间">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="专业技术资格" HeaderText="专业技术资格名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="备注" HeaderText="备注">
                              ...
                              <asp:TemplateField HeaderText="查看照片">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='UsePhoto.aspx?UseOffice=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox" >
                                            查看照片</a>  
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='UseOfficeUpd.aspx?UseOffice=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox">
                                            修改信息</a>  
