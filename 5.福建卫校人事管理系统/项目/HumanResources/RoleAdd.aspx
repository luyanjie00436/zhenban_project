<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleAdd.aspx.cs" Inherits="HumanManage_Web.RoleAdd" %>
                ...
                <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtRoleName" data-toggle="tooltip" data-placement="top"  ToolTip="请输入职务名称" runat="server" CssClass="input6" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
