<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostAdd.aspx.cs" Inherits="HumanManage_Web.PostAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtPostName" data-toggle="tooltip" data-placement="top"  ToolTip="请输入职级名称" CssClass="input6" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
                      <tr>
                        <td align="right" class="auto-style1">
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtPlanPeople" data-toggle="tooltip" data-placement="top"  ToolTip="请输入职级大类" runat="server" CssClass="input6" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
