<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSeriesManage.aspx.cs" Inherits="HumanManage_Web.AdminSeriesManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >人员类别管理</div></div></div>
...
data-toggle="tooltip" data-placement="top"  title="点击添加进入新增人员类别"   >添 加</a>
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="AdminSeriesId" HeaderText="人员类别编号">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="AdminSeriesName" HeaderText="人员类别名称">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
