...
{
    public partial class ProfessionQualificationManage : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            ...
            GridView1.DataSource = bus.Select("ProfessionQualification_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            ...
            if (bus.ProfessionQualificationDelete("ProfessionQualification_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
