<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentManage.aspx.cs" Inherits="HumanManage_Web.DepartmentManage" %>
...
<body>
  ...
  <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >行政隶属管理</div></div></div>
     
        <br />
           <div style="float:right;margin-right:20px;">
     <a href="DepartmentAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  data-toggle="tooltip" data-placement="top" title="点击添加进入新增行政隶属管理页面" class="fLink thickbox" style="  
                    ...
                    <asp:GridView ID="GridView1"  BackColor=" #d4d2d2"   CssClass="juzhong" runat="server"  Width="98%" AllowPaging="True"
                      ShowHeaderWhenEmpty="True"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PreparedNumber" HeaderText="编制人数">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                             <asp:BoundField DataField="PreparedPost" HeaderText="岗位管理编制数量">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                             <asp:BoundField DataField="PreparedProfession" HeaderText="专业技术岗位编制数量">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                             <asp:BoundField DataField="PreparedWorkers" HeaderText="工勤技能岗位编制数量">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
