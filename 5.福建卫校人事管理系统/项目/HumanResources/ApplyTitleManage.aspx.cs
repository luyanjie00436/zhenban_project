...
{
    public partial class ApplyTitleManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/ApplyTitleManage.aspx") == 0)//remian
                //{
                //    Response.Redirect("Login.aspx");
                //}
        ...
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectTitleApplyer("ApplyTitle_Selects", UserName, Year, Month).Tables[0];
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("ApplyTitleManage.aspx");
        }
