<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbroadManage.aspx.cs" Inherits="HumanManage_Web.AbroadManage" %>
...
<body>
 ...
 <div class="min_height">
    <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >人员出国记录</div></div></div>
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                         ...
                         <td width="10%" align="right">
                          ...
                          <td>
                                <asp:Button ID="Button1" data-toggle="tooltip" data-placement="top"  ToolTip="点击进行查找"  runat="server" CssClass="btn" OnClick="Button1_Click" Text="查 找" />
                             </td>
                    </tr>
                </table>
                    <br />
                    ...
                    <br />
                     <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                      ShowHeaderWhenEmpty="True"  OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                             <asp:BoundField DataField="AbroadId" HeaderText="出国编号">
                            ...
                            <asp:BoundField DataField="UserName" HeaderText="姓名">
                              ...
                              <asp:BoundField DataField="ProfessionalName" HeaderText="专业名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                              <asp:BoundField DataField="Direction" HeaderText="研究方向">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("AbroadId") %>'>查看详情</asp:LinkButton>
                                     <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("AbroadId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("AbroadId") %>' runat="server" OnCommand="LinkButton9_Command">删除</asp:LinkButton>
