<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfessionQualificationManage.aspx.cs" Inherits="HumanManage_Web.ProfessionQualificationManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >专业技术资格名称管理</div></div></div>
 
      <br />
           <div style="float:right;margin-right:20px;">
     <a href="ProfessionQualificationAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox"style="  
...
data-toggle="tooltip" data-placement="top"  title="点击添加进入新增专业技术资格名称"   >添 加</a>
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="ProfessionQualificationId" HeaderText="专业技术资格编号">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ProfessionQualificationName" HeaderText="专业技术资格名称名称">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='ProfessionQualificationUpd.aspx?ProfessionQualification=<%# Eval("ProfessionQualificationId")%>&keepThis=true&TB_iframe=true&height=300&width=500'   class="fLink thickbox">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("ProfessionQualificationId") %>' runat="server"
