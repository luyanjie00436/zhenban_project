<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_UserManage.aspx.cs" Inherits="HumanManage_Web.A_UserManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >接口使用人员管理</div></div></div>
    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div style="float:right;margin-right:20px;">
     <a href="A_UserAdd.aspx?keepThis=true&TB_iframe=true&height=400&width=500"  data-toggle="tooltip" data-placement="top"  title="点击添加进入新增人员页面" class="fLink thickbox" style="  
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='A_UserAdd.aspx?Abc_User=<%# Eval("Id")%>&keepThis=true&TB_iframe=true&height=300&width=500'   class="fLink thickbox">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("Id") %>' runat="server"
