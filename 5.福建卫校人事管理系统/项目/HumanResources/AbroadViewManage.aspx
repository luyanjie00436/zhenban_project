<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbroadViewManage.aspx.cs" Inherits="HumanManage_Web.AbroadViewManage" %>
...
<body>
    <form id="form1" runat="server">
      <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >出国信息综合查询</div></div></div>
     ...
     <p>基础信息</p>
       ...
       <asp:ListItem>第一学历</asp:ListItem>
              ...
              <asp:CheckBoxList ID="CBlist8" runat="server" CssClass="esp" RepeatColumns="7" RepeatDirection="Horizontal" OnSelectedIndexChanged="CBlist1_SelectedIndexChanged" Font-Size="16px" Font-Names="微软雅黑" BorderColor="#a9a9a9" BorderStyle="Solid" BorderWidth="1px" CellSpacing="2">
                  <asp:ListItem>申请时间</asp:ListItem>
                  <asp:ListItem>专业名称</asp:ListItem>
                  <asp:ListItem>研究方向</asp:ListItem>
                  <asp:ListItem>第一外语</asp:ListItem>
                  <asp:ListItem>第一外语水平</asp:ListItem>
                  <asp:ListItem>第二外语</asp:ListItem>
                  <asp:ListItem>第二外语水平</asp:ListItem>
                  <asp:ListItem>出国项目名称</asp:ListItem>
                  <asp:ListItem>国家地区</asp:ListItem>
                  <asp:ListItem>出国时间</asp:ListItem>
                  <asp:ListItem>获得成果</asp:ListItem>
                  <asp:ListItem>出国计划</asp:ListItem>
                    </asp:CheckBoxList>
