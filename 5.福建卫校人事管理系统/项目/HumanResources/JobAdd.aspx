<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobAdd.aspx.cs" Inherits="HumanManage_Web.JobAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtJobName"  data-toggle="tooltip" data-placement="top"  ToolTip="请输入职称名称" CssClass="input6" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
