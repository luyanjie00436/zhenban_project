<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelayQuitManage.aspx.cs" Inherits="HumanManage_Web.DelayQuitManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >延迟退休记录</div></div></div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                        ...
                        <td width="10%" align="left">
                         ...
                         <td width="10%" align="right">
                            ...
                            <td width="20%" align="left">
                               ...
                               <asp:DropDownList ID="DlMonth" data-toggle="tooltip" data-placement="top"  ToolTip="点击选择申请月份" runat="server" CssClass="select1" Width="80px">
                    ...
                    ShowHeaderWhenEmpty="True"    OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                             <asp:BoundField DataField="DelayQuitId" HeaderText="延迟退休编号">
  ...
  <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("DelayQuitId") %>'>查看详情</asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("DelayQuitId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("DelayQuitId") %>' runat="server"
