<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusManage.aspx.cs" Inherits="HumanManage_Web.StatusManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >状态管理</div></div></div>
    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div style="float:right;margin-right:20px;">
     <a href="StatusAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  data-toggle="tooltip" data-placement="top"  title="点击添加进入新增状态页面" class="fLink thickbox" style="  
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='StatusUpd.aspx?Status=<%# Eval("StatusId")%>&keepThis=true&TB_iframe=true&height=300&width=500'   class="fLink thickbox">
                                            修改</a>  
