...
{
    public partial class QuitManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/QuitManage.aspx") == 0)
                {
                    Response.Redirect("Login.aspx");
                }
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("QuitDetailed.aspx?Quit=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectTransfer("Quit_Selects", UserName,  Year, Month).Tables[0];
        ...
        {
            Response.Redirect("QuitAdd.aspx?Quit=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");

        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            if (bus.QuitDelete("Quit_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
