...
{
    public partial class DelayQuitManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/DelayQuitManage.aspx") == 0)
                {
                    Response.Redirect("Login.aspx");
                }
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("DelayQuitDetailed.aspx?DelayQuit=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectTransfer("DelayQuit_Selects", UserName, Year, Month).Tables[0];
        ...
        {
            Response.Redirect("DelayQuitAdd.aspx?DelayQuit=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");

        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            if (bus.DelayQuitDelete("DelayQuit_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
