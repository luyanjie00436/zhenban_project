<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RewardViewManage.aspx.cs" Inherits="HumanManage_Web.RewardViewManage" %>
...
<body>
    <form id="form1" runat="server">
      <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >奖惩信息综合查询</div></div></div>
    ...
    <p>基础信息</p>
       ...
       <asp:ListItem>第一学历</asp:ListItem>
              ...
              <asp:CheckBoxList ID="CBlist8" runat="server" CssClass="esp" RepeatColumns="7" RepeatDirection="Horizontal" OnSelectedIndexChanged="CBlist1_SelectedIndexChanged" Font-Size="16px" Font-Names="微软雅黑" BorderColor="#a9a9a9" BorderStyle="Solid" BorderWidth="1px" CellSpacing="2">
                  ...
                  <asp:ListItem>授予单位</asp:ListItem>
                  <asp:ListItem>授予时间</asp:ListItem>
                  <asp:ListItem>奖励或惩罚</asp:ListItem>
                  <asp:ListItem>奖惩形式</asp:ListItem>
