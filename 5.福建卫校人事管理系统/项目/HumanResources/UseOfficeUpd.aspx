<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseOfficeUpd.aspx.cs" Inherits="HumanManage_Web.UseOfficeUpd" %>
    ...
    <title></title><link rel="stylesheet" href="css/bootstrap.min.css" /><script src="js/jquery.min.js"></script><script src="js/bootstrap.min.js"></script><script>$(function () { $("[data-toggle='tooltip']").tooltip(); });</script>
     ...
     <script src="My97DatePicker/WdatePicker.js" type="text/javascript"></script>
            ...
            function panduan()
        {
            ...
            if (ProfessionName.selectedIndex < 1) {
                alert("请选择专业技术资格名称！");
                return false;
            }
