<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkExperienceExamineManage.aspx.cs" Inherits="HumanResources.WorkExperienceExamineManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >工作经历审批</div></div></div>
                       ...
                       ShowHeaderWhenEmpty="True"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="cbMore" runat="server" CommandArgument='<%# Eval("WorkExperienceId") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="编号">
                                  <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemTemplate>
                                    <asp:Label ID="LOfficeId" runat="server" Text='<%#Eval("WorkExperienceId") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                           ...
                           <asp:BoundField DataField="UserName" HeaderText="姓名">
                            ...
                            <asp:BoundField DataField="Remarks" HeaderText="备注">
                              ...
                              <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="LinkButton1_Command" CommandArgument='<%# Eval("WorkExperienceId") %>' OnClientClick="return confirm('确认同意审批吗？');">同意</asp:LinkButton>
                                                 <asp:LinkButton ID="LinkButton2" runat="server" OnCommand="LinkButton2_Command" CommandArgument='<%# Eval("WorkExperienceId") %>' OnClientClick="return confirm('确认拒绝审批吗？');">拒绝</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
