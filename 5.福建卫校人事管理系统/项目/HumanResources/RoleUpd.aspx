<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleUpd.aspx.cs" Inherits="HumanManage_Web.RoleUpd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtRoleName" runat="server" data-toggle="tooltip" data-placement="top"  ToolTip="请输入职务名称" CssClass="input6" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
