<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DegreeManage.aspx.cs" Inherits="HumanManage_Web.DegreeManage" %>
...
<body>
 ...
 <div class="min_height">
    <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >学位管理</div></div></div>
   <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div style="float:right;margin-right:20px;">
     <a href="DegreeAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500" data-toggle="tooltip" data-placement="top"  title="点击进入新增学位页面"  class="fLink thickbox" style="  
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='DegreeUpd.aspx?Degree=<%# Eval("DegreeId")%>&keepThis=true&TB_iframe=true&height=300&width=500'   class="fLink thickbox">
                                            修改</a>  
