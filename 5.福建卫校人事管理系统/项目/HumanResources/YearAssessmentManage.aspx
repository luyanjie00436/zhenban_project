<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YearAssessmentManage.aspx.cs" Inherits="HumanResources.YearAssessmentManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >年度考核管理</div></div></div>
      ...
      <br />
           ...
           <div style="float:right;margin-right:20px;">
               ...
               <a id="OfficeAdda" runat="server" href="YearAssessmentAdd.aspx"  class="fLink thickbox" style="  
 ...
 data-toggle="tooltip" data-placement="top"  title ="点击进入新增年度考核">添 加</a>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          ...
                                          <a href='YearAssessmentAdd.aspx?YearAssessment=<%# Eval("YearAssessmentId")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox xg ">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9"   CommandArgument='<%# Eval("YearAssessmentId") %>' runat="server"
