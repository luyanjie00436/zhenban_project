<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseOfficeExamineManage.aspx.cs" Inherits="HumanResources.UseOfficeExamineManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >职称任聘审批</div></div></div>
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                       ...
                       ShowHeaderWhenEmpty="True"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="cbMore" runat="server" CommandArgument='<%# Eval("UseOfficeId") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="编号" >
                                 <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                 <ItemTemplate>
                                    <asp:Label ID="LOfficeId" runat="server" Text='<%#Eval("UseOfficeId") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                           ...
                           <asp:BoundField DataField="UserName" HeaderText="姓名">
                            ...
                            <asp:BoundField DataField="Remarks" HeaderText="备注">
                              ...
                              <asp:TemplateField HeaderText="查看照片">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='UsePhoto.aspx?UseOffice=<%# Eval("UseOfficeId")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox" >
                                            查看照片</a>  
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                              ...
                              <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="LinkButton1_Command" CommandArgument='<%# Eval("UseOfficeId") %>' OnClientClick="return confirm('确认同意审批吗？');">同意</asp:LinkButton>
                                                 <asp:LinkButton ID="LinkButton2" runat="server" OnCommand="LinkButton2_Command" CommandArgument='<%# Eval("UseOfficeId") %>' OnClientClick="return confirm('确认拒绝审批吗？');">拒绝</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="同意" CssClass="btn" OnClick="Button1_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" Text="拒绝" CssClass="btn" OnClick="Button2_Click" />
        </div>
    </div>
    </div>
    </form>
