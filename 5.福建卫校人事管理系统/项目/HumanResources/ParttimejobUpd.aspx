<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParttimejobUpd.aspx.cs" Inherits="HumanResources.ParttimejobUpd" %>
             ...
             <tr>
                    ...
                    <tr class="tr10">
                        ...
                        <td width="70%" height="80" align="left" valign="middle" style=" background:none;">                        
                            <asp:Button ID="Button2" runat="server" Text="修 改" data-toggle="tooltip" data-placement="top"   OnClientClick=" return panduan()" ToolTip="点击修改" OnClick="Button2_Click" CssClass="btn" />
                        </td>
                    </tr>
                </table>
   </div>
