<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkExperienceManage.aspx.cs" Inherits="HumanResources.WorkExperienceManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >工作经历管理</div></div></div>
      ...
      <br />
           ...
           <div style="float:right;margin-right:20px;">
               ...
               <a id="OfficeAdda" runat="server" href="WorkExperienceAdd.aspx"  class="fLink thickbox" style="  
 ...
 data-toggle="tooltip" data-placement="top"  title ="点击进入新增工作经历">添 加</a>
         <asp:LinkButton ID="LinkButton9"  runat="server" CssClass="btn_right"  data-toggle="tooltip" data-placement="top"  ToolTip="刷新当前页面" OnClick="LinkButton9_Click">刷 新</asp:LinkButton>
                <input onclick="javascript: window.history.go(-1);" type="button" value="返回上一页"  class="btn1" data-toggle="tooltip" data-placement="top"  title="点击返回上一页" />
                </div><br />
                       ...
                       ShowHeaderWhenEmpty="True"  OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="UserName" HeaderText="姓名">
                            ...
                            <asp:BoundField DataField="EndDate" HeaderText="结束">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          ...
                                          <a href='WorkExperienceAdd.aspx?WorkExperience=<%# Eval("WorkExperienceId")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox xg ">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9"   CommandArgument='<%# Eval("WorkExperienceId") %>' runat="server"
