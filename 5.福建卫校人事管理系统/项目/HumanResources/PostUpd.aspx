<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostUpd.aspx.cs" Inherits="HumanManage_Web.PostUpd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                      ...
                      <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtPlanPeople" CssClass="input6" data-toggle="tooltip" data-placement="top"  ToolTip="请输入职级大类" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
