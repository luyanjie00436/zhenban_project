<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleApplyViewManage.aspx.cs" Inherits="HumanManage_Web.RoleApplyViewManage" %>
...
<body>
    <form id="form1" runat="server">
      <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >干部考核综合查询</div></div></div>
     <br />
<div>
    ...
    <p>基础信息</p>
       ...
       <asp:ListItem>第一学历</asp:ListItem>
              ...
              <asp:CheckBoxList ID="CBlist8" runat="server" CssClass="esp" RepeatColumns="7" RepeatDirection="Horizontal" OnSelectedIndexChanged="CBlist1_SelectedIndexChanged" Font-Size="16px" Font-Names="微软雅黑" BorderColor="#a9a9a9" BorderStyle="Solid" BorderWidth="1px" CellSpacing="2">
                  <asp:ListItem>考核名称</asp:ListItem>
                  <asp:ListItem>申报部门</asp:ListItem>
                  <asp:ListItem>申报职务</asp:ListItem>
                  <asp:ListItem>申报内容</asp:ListItem>
                  <asp:ListItem>申报详细</asp:ListItem>
                  <asp:ListItem>申请年份</asp:ListItem>
                    </asp:CheckBoxList>
