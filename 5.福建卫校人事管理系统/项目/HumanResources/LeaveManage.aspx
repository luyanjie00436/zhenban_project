<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveManage.aspx.cs" Inherits="HumanManage_Web.LeaveManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >人员请假记录</div></div></div>
                ...
                <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtUserName" runat="server" data-toggle="tooltip" data-placement="top"  ToolTip="请填写用户姓名 例如（119999）" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                         ...
                         <td width="10%" align="right">
                            ...
                            <td width="20%" align="left">
                                <asp:DropDownList data-toggle="tooltip" data-placement="top"  ToolTip="点击选择申请年份" ID="DlYear" runat="server" CssClass="select1" Width="80px">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                      ShowHeaderWhenEmpty="True"  OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                             <asp:BoundField DataField="LeaveId" HeaderText="请假编号">
                            ...
                            <asp:BoundField DataField="UserName" HeaderText="姓名">
                             ...
                             <asp:BoundField DataField="StartDate" HeaderText="请假开始时间">
                                <HeaderStyle Width="11%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                             <asp:BoundField DataField="EndDate" HeaderText="请假结束时间">
                                <HeaderStyle Width="11%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
...
OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LeaveId") %>'>查看详情</asp:LinkButton>
                                         <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("LeaveId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("LeaveId") %>' runat="server"
