<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobCertificateManage.aspx.cs" Inherits="HumanResources.JobCertificateManage" %>
        ...
        $(document).ready(
         function () {
             ...
             for (var i = 1; i < tabrows; i++) {
                 if (sbc == 0 || $("#GridView1").find("tr").eq(i).find("td").eq(sbc).text().length <3) {
                     $("#GridView1").find("tr").eq(i).find("a").remove();//.css("display", "none");
                 }
             }
         }
         );
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >职业资格证书管理</div></div></div>
      ...
      <br />
           ...
           <div style="float:right;margin-right:20px;">
               ...
               <a id="OfficeAdda" runat="server" href="JobCertificateAdd.aspx"  class="fLink thickbox" style="  
 ...
 data-toggle="tooltip" data-placement="top"  title ="点击进入新增职业资格">添 加</a>
                       ...
                       ShowHeaderWhenEmpty="True"  OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='JobCertificateAdd.aspx?JobCertificate=<%# Eval("JobCertificateId")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9"  CommandArgument='<%# Eval("JobCertificateId") %>' runat="server"
