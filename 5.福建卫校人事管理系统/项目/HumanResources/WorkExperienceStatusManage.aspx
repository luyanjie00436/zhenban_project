<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkExperienceStatusManage.aspx.cs" Inherits="HumanResources.WorkExperienceStatusManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >工作经历修改管理</div></div></div>
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="姓名" HeaderText="姓名">
                            ...
                            <asp:BoundField DataField="职务" HeaderText="职务">
                               ...
                               <asp:BoundField DataField="是否当前任职" HeaderText="是否当前任职">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='WorkExperienceUpd.aspx?WorkExperience=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox">
                                            修改信息</a>  
