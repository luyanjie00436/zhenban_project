<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostManage.aspx.cs" Inherits="HumanManage_Web.PostManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >职级管理</div></div></div>
     <br />
     <div style="float:right;margin-right:20px;">
     <a href="PostAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
 ...
 data-toggle="tooltip" data-placement="top"  title="点击添加进入新增职级页面"  >添 加</a>
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    ShowHeaderWhenEmpty="True"     OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                              <asp:BoundField DataField="PostId" HeaderText="职级编号">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="PostName" HeaderText="职级名称">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                              <asp:BoundField DataField="PlanPeople" HeaderText="职级大类">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='PostUpd.aspx?Post=<%# Eval("PostId")%>&keepThis=true&TB_iframe=true&height=300&width=500'   class="fLink thickbox">
                                            修改</a> 
                                          <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("PostId") %>' runat="server"
