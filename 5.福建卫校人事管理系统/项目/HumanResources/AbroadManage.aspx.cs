...
{
    public partial class AbroadManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/AbroadManage.aspx") == 0)
                {
                    Response.Redirect("Login.aspx");
                }
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("AbroadDetailed.aspx?Abroad=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectTransfer("Abroad_Selects", UserName,  Year, Month).Tables[0];
        ...
        {
            Response.Redirect("AbroadAdd.aspx?Abroad=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");

        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {

            if (bus.AbroadDelete("Abroad_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
