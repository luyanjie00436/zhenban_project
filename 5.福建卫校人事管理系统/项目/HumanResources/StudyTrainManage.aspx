<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudyTrainManage.aspx.cs" Inherits="HumanManage_Web.StudyTrainManage" %>
...
<div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >培训进修管理</div></div></div>
      ...
      <br />
           ...
           <div style="float:right;margin-right:20px;">
               ...
               <a id="OfficeAdda" runat="server" href="StudyTrainAdd.aspx"  class="fLink thickbox" style="  
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          ...
                                          <a href='StudyTrainAdd.aspx?StudyTrain=<%# Eval("StudyTrainId")%>&keepThis=true&TB_iframe=true&height=400&width=500'  class="fLink thickbox xg ">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9"   CommandArgument='<%# Eval("StudyTrainId") %>' runat="server"
