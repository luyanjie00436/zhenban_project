<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherResultsProcess.aspx.cs" Inherits="sanmingScientManage_Web.OtherResultsProcess" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >其他成果审批流程</div></div></div><br />
                    ...
                    ShowHeaderWhenEmpty="true"       OnSelectedIndexChanging="GridView1_SelectedIndexChanging" PageSize="10">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("OtherResultsProcessId") %>' runat="server"
