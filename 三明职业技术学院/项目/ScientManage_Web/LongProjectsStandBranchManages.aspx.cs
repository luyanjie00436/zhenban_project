...
{
    public partial class LongProjectsStandBranchManages : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/LongProjectsStandBranchManages.aspx") == 0)
                {
                      Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'</script>");
                }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsBranch("LongProjectsStandBranchView_Selects", UserName, DepartmentName, ProjectsName).Tables[0];
           
            string strExcelName = "项目立项评审";
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("LongProjectsStandBranchDetaileds?LongProjectsId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("AssociationManage.aspx");
        }
    }
}