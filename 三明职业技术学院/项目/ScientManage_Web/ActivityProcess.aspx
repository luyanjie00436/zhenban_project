<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityProcess.aspx.cs" Inherits="sanmingScientManage_Web.ActivityProcess" %>
...
<body>
 ...
 <div class="min_height">
        <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >学术活动审批流程</div></div></div><br />
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("ActivityProcessId") %>' runat="server"
