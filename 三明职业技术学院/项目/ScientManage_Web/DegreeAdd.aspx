<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DegreeAdd.aspx.cs" Inherits="sanmingScientManage_Web.DegreeAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtDegreeName" runat="server" CssClass="input6" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
