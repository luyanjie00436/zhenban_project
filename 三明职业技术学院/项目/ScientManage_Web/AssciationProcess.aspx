<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssciationProcess.aspx.cs" Inherits="sanmingScientManage_Web.AssciationProcess" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >团体学会审批流程</div></div></div><br />
                       ...
                       ShowHeaderWhenEmpty="true"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("AssociationProcessId") %>' runat="server"
