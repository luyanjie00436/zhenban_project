<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsStandExamineDetailed.aspx.cs" Inherits="ScientManage_Web2.LongProjectsStandExamineDetailed" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="3">
                        ...
                        <strong>新项目编号：</strong>&nbsp;</td>
                    <td colspan="5">
                        <asp:TextBox ID="txtNewLongProjectsId" runat="server" Columns="1" CssClass="select1" Height="30px" Width="156px"  ></asp:TextBox>
