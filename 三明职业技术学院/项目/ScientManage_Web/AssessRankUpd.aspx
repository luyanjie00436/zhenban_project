<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssessRankUpd.aspx.cs" Inherits="sanmingScientManage_Web.AssessRankUpd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:DropDownList ID="DLTeaching" runat="server" CssClass="input1" Height="27px" Width="137px" >
                            </asp:DropDownList>
                               </td>
                    </tr>
                    <tr>
                    ...
                    <tr  >
                        ...
                        <td width="70%" align="left">
                          <asp:TextBox ID="txtMinValue" CssClass="input6" runat="server" Height="27px" Width="137px"></asp:TextBox>
                               </td>
                    </tr>
                    <tr>
                        <td align="right" class="auto-style4" >
