<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCompetitionManage.aspx.cs" Inherits="sanmingScientManage_Web.MyCompetitionManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >个人技能竞赛记录</div></div></div><br />
                        ...
                        <Columns>        
                          ...
                          <asp:BoundField DataField="StudentName" HeaderText="参赛学生">
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("CompetitionId") %>'>查看详情</asp:LinkButton>
                                       
                                          <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("CompetitionId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("CompetitionId") %>' runat="server"
