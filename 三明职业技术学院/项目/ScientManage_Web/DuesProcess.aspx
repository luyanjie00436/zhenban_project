<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DuesProcess.aspx.cs" Inherits="ScientManage_Web2.DuesProcess" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >会费审批流程</div></div></div><br />
                       ...
                       ShowHeaderWhenEmpty="true"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("DuesProcessId") %>' runat="server"
