<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachingExamineDetailed.aspx.cs" Inherits="sanmingScientManage_Web.TeachingExamineDetailed" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
               <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >著作教材审批表</div></div></div><br />
                         ...
                         <tr>
                          ...
                          <tr>
                              ...
                              <td class="td4">
                                ...
                                <td class="td5">
                                  <asp:Label ID="LTeachingDate" runat="server" ></asp:Label>
                              </td>
                              <td class="td5">
