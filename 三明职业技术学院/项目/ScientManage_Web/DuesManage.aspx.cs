...
{
    public partial class DuesManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/DuesManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'</script>");
                }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsAssociation("Dues_Selects", UserName, DepartmentId, Year, Month, Status, AssociationName).Tables[0];

            string strExcelName = "团体学会会费";
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("DuesManage.aspx");
        }
    }
}