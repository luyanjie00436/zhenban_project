<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperManage.aspx.cs" Inherits="sanmingScientManage_Web.PaperManage" %>
                            ...
                            <asp:BoundField DataField="级别" HeaderText="级别">
                              ...
                              <asp:BoundField DataField="刊号" HeaderText="刊号">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                 ...
                                 <asp:BoundField DataField="刊物期数" HeaderText="刊物期数">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
