<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperPartnerManage.aspx.cs" Inherits="sanmingScientManage_Web.PaperPartnerManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >论文合作者</div></div></div><br />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div style="margin: 5px 0px 0px 0px; text-align: center;">
                    <asp:GridView ID="GridView1"   ShowHeaderWhenEmpty="true"  BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AutoGenerateColumns="False" Width="98%">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="AuthorsOrder" HeaderText="作者顺序">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
