...
{
    public partial class PatentProcess : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.PatentProcessInsert("PatentProcess_Insert", RankId, ProcessOrder, DepartmentName, UserCardId))
            {
        ...
        public void dataGriviewBD()
        {
            ...
            GridView1.DataSource = bus.Select("PatentProcess_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("PatentProcess.aspx");
        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {

            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            if (bus.PatentProcessDelete("PatentProcess_Delete", Convert.ToInt32(e.CommandArgument.ToString()), UserCardId))
            {
