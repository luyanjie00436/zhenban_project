<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostAdd.aspx.cs" Inherits="sanmingScientManage_Web.PostAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtPostName" runat="server" CssClass="input6" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
                      <tr>
                        <td align="right" class="auto-style5">
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtPlanPeople" runat="server" CssClass="input6" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="auto-style5">
