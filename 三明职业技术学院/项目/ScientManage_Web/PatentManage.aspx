<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatentManage.aspx.cs" Inherits="sanmingScientManage_Web.PatentManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >专利</div></div></div><br />
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtPatentName" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                        <td width="10%" align="right">
                            <strong>类别：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtPatentCateGory" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                         ...
                         <Columns>
                           ...
                           <asp:BoundField DataField="专利名称" HeaderText="专利名称">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                 ...
                                 <asp:BoundField DataField="专利批准日期" HeaderText="专利批准日期">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
