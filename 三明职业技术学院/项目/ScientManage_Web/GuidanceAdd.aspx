<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidanceAdd.aspx.cs" Inherits="sanmingScientManage_Web.GuidanceAdd" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
        <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >教学质量工程申报</div></div></div>
        <br />
                            ...
                            <td width="12%" align="left">
                               ...
                               <tr>
                                   ...
                                   <td align="left" width="12%">
                                    ...
                                    <tr>
                                       <td align="right" width="12%"><strong>项目申请人:</strong> </td>
                                       <td align="left" width="12%">
                                   ...
                                   <tr>
                                       ...
                                       <td align="left" width="12%">
                                           <asp:TextBox ID="txtGuidanceName" runat="server" CssClass="input1" ></asp:TextBox>
                                       </td>
                                       </td>
                                   </tr>
                           <tr>
                             ...
                             <tr>
                                   <td align="right" width="12%"><strong>项目级别:</strong> </td>
                                   <td align="left" width="12%">
                            ...
                            <td width="12%" align="left">
                                <input ID="txtGuidanceDate" runat="server"  onfocus="WdatePicker()" class="input1"></input>
                            </td>
                               </tr>
                                         <tr>
                                       ...
                                       <tr>
                                           <td align="right" width="12%"><strong>教学质量工程分值:</strong> </td>
                                           <td align="left" width="12%">
                                               <asp:TextBox ID="txtGuidanceValue" runat="server" CssClass="input1" ReadOnly="true"></asp:TextBox>
                                           </td>
                                       </tr>
                                       <tr>
                                       ...
                                       <tr>
                                           <td align="right" width="12%" class="auto-style4"><strong>本人得分:</strong> </td>
