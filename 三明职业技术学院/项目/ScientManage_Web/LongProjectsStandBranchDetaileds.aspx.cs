...
namespace ScientManage_Web2
{
    public partial class LongProjectsStandBranchDetaileds : System.Web.UI.Page
    {
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            DataSet dt1 = bus.SelectByLongUser("LongProjectsStandBranch_SelectByUserCardId", LongProjectsId,UserCardId);
            ...
            try
            {
                string tempPath = Server.MapPath("File/Template/科研项目立项论证评审表.doc");
                string tempcopy = Server.MapPath("科研项目立项论证评审表.doc");
                string FileNameOut = "科研项目立项论证评审表.doc";
                ...
                if (dt1.Tables[0].Rows[0]["ExamineOpinion"].ToString().Length>0)
                {
