<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusAdd.aspx.cs" Inherits="sanmingScientManage_Web.StatusAdd" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtStatusName" CssClass="input6" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    </tr>
