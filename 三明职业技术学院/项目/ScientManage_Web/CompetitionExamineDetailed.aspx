<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompetitionExamineDetailed.aspx.cs" Inherits="sanmingScientManage_Web.CompetitionExamineDetailed" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
               <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >技能竞赛审批表</div></div></div><br />
                        ...
                        <div>
                         ...
                         <tr>
                          ...
                          <tr>
                              ...
                              <td class="td5"  align="left">
                                  <asp:Label ID="LCompetitionName" runat="server" ></asp:Label>
                              </td> 
                               <td class="td5"  align="left">
                                  <asp:Label ID="LAppraisalCompany" runat="server" ></asp:Label>
                              </td> 
                               <td class="td5"  align="left">
                                  <asp:Label ID="LTeacherName" runat="server" ></asp:Label>
                              </td> 
                               <td class="td5"  align="left">
                                  <asp:Label ID="LStudentName" runat="server" ></asp:Label>
                              </td> 
                               <td class="td5"  align="left">
                                  <asp:Label ID="LMentor" runat="server" ></asp:Label>
                              </td> 
                                 <td class="td5"  align="left">
                                  <asp:Label ID="LCompetitionDate" runat="server" ></asp:Label>
                              </td> 

                              <td class="td5">
                                  <asp:Label ID="LCompetitionValue" runat="server" ></asp:Label>
                              </td>                        
                               <td class="td5">
                          ...
                          <tr>
                              ...
                              <td class="td4">
                                  合作者列表</td>
                              <td class="td4" colspan="9" style=" width:730px">
