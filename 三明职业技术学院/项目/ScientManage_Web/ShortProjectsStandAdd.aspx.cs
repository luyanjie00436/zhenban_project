...
namespace ScientManage_Web2
{
    public partial class ShortProjectsStandAdd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["ShortProjectsId"] != null)
                {
                    ...
                    txtContractMoney.Text = ds.Tables[0].Rows[0]["ContractMoney"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ContractMoney=txtContractMoney.Text;
            ...
            try
            {
                ...
                LFileUrl.Text = path;
                if (bus.ShortProjectsInsert("ShortProjects_Insert", ShortProjectsId, UserCardId,ContractId,ContractName,Convert.ToDouble( ContractMoney),Company, path))
                {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.ShortProjectsInsert("ShortProjects_Update", ShortProjectsId, UserCardId,ContractId,ContractName,Convert.ToDouble(ContractMoney), Company, path))
            {
