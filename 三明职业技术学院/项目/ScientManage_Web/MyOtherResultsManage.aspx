<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyOtherResultsManage.aspx.cs" Inherits="sanmingScientManage_Web.MyOtherResultsManage" %>
...
<body>
 ...
 <div class="min_height">
           <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >个人其他成果记录</div></div></div><br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>        
                            ...
                            <asp:BoundField DataField="OtherResultsValue" HeaderText="成果分值">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("OtherResultsId") %>'>查看详情</asp:LinkButton>
                                       
                                          <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("OtherResultsId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("OtherResultsId") %>' runat="server"
