<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityExamineDetailed.aspx.cs" Inherits="sanmingScientManage_Web.ActivityExamineDetailed" %>
                         ...
                         <tr>
                          ...
                          <tr>
                              ...
                              <td class="td5"  align="left">
                               ...
                               <td class="td5"  align="left">
                                  <asp:Label ID="LCompanyName" runat="server" ></asp:Label>
                              </td> 
                              <td class="td5">
                                  <asp:Label ID="LActivityValue" runat="server" ></asp:Label>
                              </td>                        
                               <td class="td5">
