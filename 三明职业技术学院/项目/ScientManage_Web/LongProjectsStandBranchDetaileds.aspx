<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsStandBranchDetaileds.aspx.cs" Inherits="ScientManage_Web2.LongProjectsStandBranchDetaileds" %>
        ...
        <div>
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">项目立项评审详细表</div>
                </div>
            </div>
            <br />
                    ...
                    <div>
                        <table class="bgcolor">
                            ...
                            <tr>
                                ...
                                <td class="td5" style="text-align: right">协作单位：</td>
                            ...
                            <tr>
                                ...
                                <td class="td5" align="right">评审附件：</td>
                                <td class="td5" style="text-align: left">
                        ...
                        <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ExamineOpinion" HeaderText="评审意见">
                                    <HeaderStyle CssClass="gridview_HeaderStyle" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="FollDate" HeaderText="评审时间">
                                    <HeaderStyle CssClass="gridview_HeaderStyle" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <div class="link02">
                                            <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("UserCardId") %>'>导出</asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="gridview_HeaderStyle" />
                                    <ItemStyle HorizontalAlign="Center" />
