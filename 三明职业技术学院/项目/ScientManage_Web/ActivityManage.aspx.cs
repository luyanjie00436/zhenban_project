    ...
    public partial class ActivityManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/ActivityManage.aspx") == 0)
                {
                      Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'</script>");
                }
                ...
                else
                {
                  ...
                  //  string DepartmentId = dt.Rows[0]["UserDepartmentId"].ToString();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsActivity("Activity_Selects", UserName, DepartmentId, Year, Month, Status, AssociationName).Tables[0];
        
            string strExcelName = "学术活动成果";
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("ActivityManage.aspx");
        }
    }
}