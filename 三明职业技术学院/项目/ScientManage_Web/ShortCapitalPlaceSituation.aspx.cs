...
{
    public partial class ShortCapitalPlaceSituation : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            RankId = Convert.ToInt32(HttpUtility.UrlDecode(Request.Cookies["RankId"].Value));
            GridView1.DataSource = bus.SelectByUserCardId("ShortCapitalPlace_SelectByUserCardId", UserCardId).Tables[0].DefaultView;
            GridView1.DataBind();
        }
