<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompetitionManage.aspx.cs" Inherits="sanmingScientManage_Web.CompetitionManage" %>
...
<body>
 ...
 <div class="min_height">
          <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >技能竞赛</div></div></div><br />
        ...
        <div style="margin-top: 10px">
                         ...
                         <td width="10%" align="right">
                            ...
                            <td width="20%" align="left">
                               ...
                               <asp:ListItem Value="0">选择月份</asp:ListItem>
                                ...
                                <td width="10%" align="right">
                            <strong>技能竞赛名称：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtCompetitionName" CssClass="select1" runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong"  runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="技能竞赛名称" HeaderText="技能竞赛名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                            ...
                            <asp:BoundField DataField="级别" HeaderText="级别">
                              ...
                              <asp:BoundField DataField="竞赛组织单位" HeaderText="竞赛组织单位">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="参赛教师姓名" HeaderText="参赛教师姓名">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>                             
                          <asp:BoundField DataField="参赛学生姓名" HeaderText="参赛学生姓名">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="指导教师姓名" HeaderText="指导教师姓名">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>     
