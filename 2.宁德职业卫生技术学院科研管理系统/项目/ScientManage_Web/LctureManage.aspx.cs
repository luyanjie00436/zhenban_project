...
{
    public partial class LctureManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/LctureManage.aspx") == 0)
                {
                      Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'</script>");
                }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            string LctureSize = txtLctureSize.Text.Trim();
            ...
            DataTable dt = bus.SelectsLcture("Lcture_Selects", UserName, DepartmentId, Year, Month, Status, LctureName, LctureSize).Tables[0];
           
            string strExcelName = "学术讲座成果";
