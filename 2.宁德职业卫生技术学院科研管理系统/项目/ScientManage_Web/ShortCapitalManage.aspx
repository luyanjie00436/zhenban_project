<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalManage.aspx.cs" Inherits="ningdeScientManage_Web.ShortCapitalManage" %>
...
<body>
 ...
 <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >横向项目经费情况</div></div></div><br />
    ...
    <div class="page_main01">
        <div style="margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtContractId" runat="server"  CssClass="select1" Height="27px" Width="110px"></asp:TextBox>
                        </td>
                          <td  align="right">
                        ...
                        <td  align="left">
                           <asp:TextBox ID="txtContractName" runat="server"  CssClass="select1" Height="27px" Width="110px"></asp:TextBox>
