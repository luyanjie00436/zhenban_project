<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsInspectManage.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsInspectManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向项目中检</div></div></div><br />
     <br />
    <div class="page_main01">
       
               
                    <p style="font-size:20px; padding-left:12px;">可中检项目</p>
                    <asp:GridView ID="GridView1" runat="server"  BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                     ShowHeaderWhenEmpty="true"     AutoGenerateColumns="False"  PageSize="10" Width="98%">
                        ...
                        <Columns>           
                             <asp:BoundField DataField="NewLongProjectsId" HeaderText="项目编号">
                            ...
                            <asp:BoundField DataField="ProjectsLevelExplain" HeaderText="项目级别">
                             ...
                             <asp:TemplateField HeaderText="中检状态">
                                    <ItemTemplate>
                                        <asp:Label ID="LInspectStatus" runat="server" Text='<%# Eval("InspectStatus") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="gridview_HeaderStyle" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton5" runat="server" OnCommand="LinkButton5_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>中检</asp:LinkButton>  
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                        ...
                        <PagerStyle CssClass="str001" />
                         ...
                         <br />
                    <p style="font-size:20px;padding-left:12px;">已申请中检项目</p>
                      ...
                      <AlternatingRowStyle BackColor="#bfbdbd" />
                          <Columns>                             
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton6" runat="server" OnCommand="LinkButton6_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>查看详情</asp:LinkButton>  
                                   <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>修改</asp:LinkButton>
                                             </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
