<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperExamineManage.aspx.cs" Inherits="ningdeScientManage_Web.PaperExamineManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >论文项目审批表</div></div></div><br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                             ...
                             <asp:BoundField DataField="PaperSubject" HeaderText="论文题目">
                                ...
                                <asp:BoundField DataField="PublicationName" HeaderText="刊物名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>                   
                              <asp:BoundField DataField="PaperName" HeaderText="刊号">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                 ...
                                 <asp:BoundField DataField="PaperYears" HeaderText="改刊物卷、期、起止页码">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                            ...
                            <asp:BoundField DataField="FollDate" HeaderText="申报时间">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("PaperId") %>'>审批</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
