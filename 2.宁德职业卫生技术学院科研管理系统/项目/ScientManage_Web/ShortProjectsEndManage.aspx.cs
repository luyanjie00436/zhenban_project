...
{
    public partial class ShortProjectsEndManage : System.Web.UI.Page
    {
        ...
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            GridView1.DataSource = bus.SelectByUserCardId("ShortProjects_SelectCanEnd", UserCardId).Tables[0].DefaultView;
            GridView1.DataBind();
            GridView2.DataSource = bus.SelectByUserCardId("ShortProjects_SelectEndUserCardId", UserCardId).Tables[0].DefaultView;
            GridView2.DataBind();
        ...
        {
            string url = "/ShortProjectsEndAdd.aspx?ShortProjectsId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf");
