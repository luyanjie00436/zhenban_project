<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndBranchManage.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsEndBranchManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向项目结题评审</div></div></div><br />
                   ...
                   <Columns>
                          ...
                          <asp:BoundField DataField="EndStatus" HeaderText="结题状态">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>评审</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
