<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CooperationManage.aspx.cs" Inherits="ningdeScientManage_Web.CooperationManage" %>
...
<body>
 ...
 <div class="min_height">
          <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >合作形式管理</div></div></div><br />
    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div class="btn_left2">
     <a href="CooperationAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="CooperationId" HeaderText="合作形式编号">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="CooperationName" HeaderText="合作形式名称">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='CooperationUpd.aspx?Cooperation=<%# Eval("CooperationId")%>&keepThis=true&TB_iframe=true&height=300&width=500''  class="fLink thickbox">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("CooperationId") %>' runat="server"
