<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectsTemplateAdd.aspx.cs" Inherits="ningdeScientManage_Web.ProjectsTemplateAdd" %>
                    ...
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <asp:DropDownList ID="DLCategory" CssClass="select1" Width="137px" runat="server">
                                  ...
                                  <asp:ListItem Value="纵向项目立项评审">纵向项目立项评审</asp:ListItem>
                                  <asp:ListItem Value="纵向项目结题评审">纵向项目结题评审</asp:ListItem>
