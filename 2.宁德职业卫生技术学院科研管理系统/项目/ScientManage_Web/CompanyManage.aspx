<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyManage.aspx.cs" Inherits="ningdeScientManage_Web.CompanyManage" %>
...
<body>
    <form id="form1" runat="server">
                      <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >单位信息</div></div></div><br />

     
        <br />
           <div class="btn_left2">
     <a href="CompanyAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
        ...
        <div style="margin-top: 10px">
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server"  Width="98%" AllowPaging="True"
                      ShowHeaderWhenEmpty="true"     OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="CompanyId" HeaderText="单位编号">
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         <a href='CompanyUpd.aspx?Company=<%# Eval("CompanyId")%>&keepThis=true&TB_iframe=true&height=300&width=500'  class="fLink thickbox">
                                            修改</a>   
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("CompanyId") %>' runat="server"
