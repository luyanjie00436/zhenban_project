<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalPlaceManage.aspx.cs" Inherits="ningdeScientManage_Web.LongCapitalPlaceManage" %>
...
<body>
 ...
 <div class="min_height">
           <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向经费到位信息</div></div></div><br />
              ...
              <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                  ...
                  <AlternatingRowStyle BackColor="#bfbdbd" />
                        <Columns>
                             ...
                             <asp:BoundField DataField="SumPlaceMoney" HeaderText="已到位经费">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>设置</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
