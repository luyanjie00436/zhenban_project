<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsInspectExamineManage.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsInspectExamineManage" %>
...
<body>
 ...
 <div class="min_height">
           <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向项目中检审批</div></div></div><br />
                  ...
                  <Columns>
                          ...
                          <asp:BoundField DataField="InspectStatus" HeaderText="中检状态">
                             ...
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>审批</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
