<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ningdeScientManage_Web.Default" %>
  ...
  <div id="top">
      <div style="width:40%;  padding-left:18px;  float:left; margin-top:18px;"><img src="Images/default_logo.png" /></div>
       ...
       <div  class="top_menu" >
        ...
        <asp:Menu ID="top_menu" Width="80%" Font-Size="11" CssClass="zihao"  ForeColor="White" runat="server"  Orientation="Horizontal"  StaticEnableDefaultPopOutImage="False" DisappearAfter="500">
