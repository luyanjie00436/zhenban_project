<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortProjectsManage.aspx.cs" Inherits="ningdeScientManage_Web.ShortProjectsManage" %>
...
<body>
 ...
 <div class="min_height">
           <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >横向项目情况</div></div></div><br />
        ...
        <div style="margin-top: 10px">
                    ...
                    <tr>
                       ...
                       <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtContractId" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                           <td align="right">
                                <strong>结题状态：</strong></td>
                        <td>

                            <asp:DropDownList ID="DLEnd" runat="server" CssClass="select1" Width="137px">
                        ...
                        <td  align="left">
                           <asp:TextBox ID="txtContractName" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                       ...
                       <strong>合作单位：</strong> 
                        ...
                        <td>
                <asp:TextBox ID="txtCompany" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                     <td align="right">
                                <strong>合同金额：</strong></td>
                        <td>

                             <asp:TextBox ID="txtMoney1" CssClass="select1" runat="server" Height="27px" Width="37px" TextMode="Number"></asp:TextBox>
                            ~<asp:TextBox ID="txtMoney2"  CssClass="select1" runat="server" Height="27px" Width="37px" TextMode="Number"></asp:TextBox>
                        </td>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DLStand" runat="server" CssClass="select1" Width="137px">
 ...
 <td align="right">
                               ...
                               <td  align="left"> <asp:Button ID="Button3" runat="server" CssClass="btn" OnClick="Button3_Click" Text="导 出" />
                            </td>
                        </tr>
