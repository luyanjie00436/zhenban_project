<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssciationManage.aspx.cs" Inherits="ningdeScientManage_Web.AssciationManage" %>
...
<body>
 ...
 <div class="min_height">
          <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >团体学会</div></div></div><br />
                    ...
                    <tr>
                       ...
                       <td width="10%" align="right">
                        ...
                        <td width="10%" align="left">
                          ...
                          <tr>
                               <td align="right" class="auto-style5">
                                   <strong>团体（学会）名称：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtAssociationName" CssClass="select1"  runat="server" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                       ...
                       ShowHeaderWhenEmpty="true"   OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="系(部)" HeaderText="系(部)">
                              ...
                              <asp:BoundField DataField="团体学会名称" HeaderText="团体学会名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
                            ...
                            <asp:BoundField DataField="所需费用" HeaderText="所需费用">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
