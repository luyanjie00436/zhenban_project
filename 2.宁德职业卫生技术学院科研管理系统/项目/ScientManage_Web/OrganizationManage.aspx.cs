...
namespace ningdeScientManage_Web
{
    public partial class OrganizationManage : System.Web.UI.Page
    {
        ...
        {
            GridView1.DataSource = bus.Select("Organization_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            if (bus.OrganizationDelete("Organization_Delete", Convert.ToInt32(e.CommandArgument.ToString()), UserCardId))
            {
        ...
        {
            Response.Cookies["selectOrganizationId"].Value = GridView1.Rows[e.NewSelectedIndex].Cells[1].Text.ToString();
