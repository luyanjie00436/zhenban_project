...
{
    public partial class MyProjectStatusManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/MyProjectStatusManage.aspx") == 0)
                {
                    Response.Redirect("Login.aspx");
                }
        ...
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            GridView1.DataSource = bus.SelectByUserCardId("ProjectStatus_SelectByPartnerUser", UserCardId).Tables[0].DefaultView;
            GridView1.DataBind();
        ...
        protected void LinkButton8_Command(object sender, CommandEventArgs e)
        {
                ...
                Response.Redirect("ProjectStatusAdd.aspx?ProjectStatusId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        ...
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            ...
            if (bus.ProjectStatusDelete("ProjectStatus_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("MyProjectStatusManage.aspx");
        }
    }
}