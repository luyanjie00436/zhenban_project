<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndExamineDetailed.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsEndExamineDetailed" %>
...
<body>
    ...
    <div>
                      <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >项目结题审批表</div></div></div><br />
                         ...
                         <tr>
                          ...
                          <tr>
                              ...
                              <td class="td5" align="right"  >
                               ...
                               <tr>
                                   <td align="right">评审总分值：</td>
                                   <td><asp:Label runat="server" ID="LSumBranch"></asp:Label> </td>
                                   <td align="right">平均分：</td>
                                   <td> <asp:Label runat="server" ID="LAvgBranch"></asp:Label></td>
                       ...
                       <tr>
                            <td class="td5" align="right"  >
                             ...
                             <td align="right">项目立项详细：</td>
                              ...
                              <tr>
                                   <td align="right">项目中检详细：</td>
                                   <td> <asp:LinkButton ForeColor="blue" Text="查看详细" runat="server" Id="LinkButton4" OnClick="LinkButton4_Click"></asp:LinkButton>
                              </td>
                              </tr>
                      </table>
