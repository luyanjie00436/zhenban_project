<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectsSubjectManage.aspx.cs" Inherits="ningdeScientManage_Web.ProjectsSubjectManage" %>
...
<body>
 ...
 <div class="min_height">
          <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >项目类别</div></div></div><br />

    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div class="btn_left2">
     <a href="ProjectsSubjectAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='ProjectsSubjectUpd.aspx?ProjectsSubject=<%# Eval("ProjectsSubjectId")%>&keepThis=true&TB_iframe=true&height=300&width=500'  class="fLink thickbox">
                                            修改</a>  
