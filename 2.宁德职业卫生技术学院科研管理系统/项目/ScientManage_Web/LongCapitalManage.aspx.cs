...
namespace ningdeScientManage_Web
{
    public partial class LongCapitalManage : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsLongCapital("LongCapital_Selects", ProjectsId, ProjectsName, Company, Money1, Money2, DepartmentName).Tables[0];
           
            string strExcelName = "纵向经费表";
