<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortProjectsStandExamineManage.aspx.cs" Inherits="ningdeScientManage_Web.ShortProjectsStandExamineManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >横向项目立项审批</div></div></div><br />
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              ...
              <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                   ...
                   <Columns>
                          ...
                          <asp:BoundField DataField="StandStatus" HeaderText="立项情况">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                             <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("ShortProjectsId") %>'>审批</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
