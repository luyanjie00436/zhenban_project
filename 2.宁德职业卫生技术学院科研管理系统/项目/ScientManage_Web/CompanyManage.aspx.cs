...
namespace ningdeScientManage_Web
{
    public partial class CompanyManage : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            ...
            GridView1.DataSource = bus.Select("Company_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
           ...
           if (bus.CompanyDelete("Company_Delete", Convert.ToInt32(e.CommandArgument.ToString()), UserCardId))
            {
        ...
        {
            Response.Cookies["selectCompanyId"].Value = GridView1.Rows[e.NewSelectedIndex].Cells[1].Text.ToString();
