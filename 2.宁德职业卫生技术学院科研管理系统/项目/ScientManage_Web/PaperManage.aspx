<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperManage.aspx.cs" Inherits="ningdeScientManage_Web.PaperManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >论文</div></div></div><br />
        ...
        <div style="margin-top: 10px">
                    ...
                    <tr>
                      ...
                      <td width="10%" align="right">
                        ...
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtPaperSubject" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                        <td width="10%" align="right">
                            <strong>刊号：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtPaperName" runat="server" CssClass="select1" Height="27px" Width="137px"></asp:TextBox>
                        </td>
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>
                            ...
                            <asp:BoundField DataField="论文题目" HeaderText="论文题目">
                             ...
                             <asp:BoundField DataField="刊物名称" HeaderText="刊物名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>            
                            ...
                            <asp:BoundField DataField="级别" HeaderText="级别">
                              ...
                              <asp:BoundField DataField="刊号" HeaderText="刊号">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
                                 <asp:BoundField DataField="刊物卷、期、起止页码" HeaderText="刊物卷、期、起止页码">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                              <asp:BoundField DataField="论文发表时间" HeaderText="论文发表时间">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>     
