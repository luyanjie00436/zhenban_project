<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyPaperManage.aspx.cs" Inherits="ningdeScientManage_Web.MyPaperManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >个人论文记录</div></div></div><br />
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>        
                             ...
                             <asp:BoundField DataField="DLevel" HeaderText="级别">
                              ...
                              <asp:BoundField DataField="PaperName" HeaderText="刊号">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                 ...
                                 <asp:BoundField DataField="PaperYears" HeaderText="刊物卷、期、起止页码">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>  
                                <asp:BoundField DataField="PaperDate" HeaderText="论文发表时间">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("PaperId") %>'>查看详情</asp:LinkButton>
                                       
                                          <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("PaperId") %>'>修改</asp:LinkButton>
