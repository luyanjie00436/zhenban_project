<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Authority.aspx.cs" Inherits="ningdeScientManage_Web.Authority" %>
         ...
         <tr>
           ...
           <td style="text-align:left;  height: 29px;" >
               <asp:CheckBoxList ID="CBShort" runat="server" RepeatDirection="Horizontal">
                                 ...
                                 <tr>
               <td style="text-align:right; height: 29px; width: 94px;" >
                    <strong>项目情况:</strong> </td>
           <td style="text-align:left;  height: 29px;" >
               <asp:CheckBoxList ID="CBProjectsStatus" runat="server" RepeatDirection="Horizontal">
               </asp:CheckBoxList>
            </td>
        </tr>     
                                 <tr>
               <td style="text-align:right; height: 29px; width: 94px;" >
                    <strong>科技项目情况:</strong> </td>
           <td style="text-align:left;  height: 29px;" >
               <asp:CheckBoxList ID="CBKJProjectsStatus" runat="server" RepeatDirection="Horizontal">
               </asp:CheckBoxList>
            </td>
        </tr>     
