<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalPlanManage.aspx.cs" Inherits="ningdeScientManage_Web.ShortCapitalPlanManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >横向经费预算</div></div></div><br />
                          ...
                          <asp:TemplateField HeaderText="预算状态">
                               ...
                               <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                   ...
                                   <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("ShortProjectsId") %>'>预算</asp:LinkButton>
                                          </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
