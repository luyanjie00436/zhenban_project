<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalCloseAdd.aspx.cs" Inherits="ningdeScientManage_Web.LongCapitalCloseAdd" %>
...
<body>
    ...
    <div>
              <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >经费决算</div></div></div><br />
        <div class="page_main01">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="30%" align="left" colspan="2">
                              <asp:DropDownList CssClass="select1" ID="DlCategory" runat="server">
