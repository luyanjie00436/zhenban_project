<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndManage.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsEndManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向结题管理</div></div></div><br />
     <br />
                        ...
                        <Columns>                         
                            ...
                            <asp:BoundField DataField="ProjectsLevelExplain" HeaderText="项目级别">
                             ...
                             <asp:TemplateField HeaderText="结题状态">
                                    <ItemTemplate>
                                        <asp:Label ID="LEndStatus1" runat="server" Text='<%# Eval("EndStatus") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="gridview_HeaderStyle" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                      <asp:LinkButton ID="LinkButton5" runat="server" OnCommand="LinkButton5_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>结题</asp:LinkButton>  
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                    ...
                    ShowHeaderWhenEmpty="true"     OnPageIndexChanging="GridView2_PageIndexChanging"   AutoGenerateColumns="False" 
                       ...
                       <AlternatingRowStyle BackColor="#bfbdbd" />
                         <Columns>                             
                            ...
                            <asp:TemplateField HeaderText="结题状态">
                                    <ItemTemplate>
                                        <asp:Label ID="LEndtStatus" runat="server" Text='<%# Eval("EndStatus") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="gridview_HeaderStyle" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
