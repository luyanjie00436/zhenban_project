<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalPlanProcess.aspx.cs" Inherits="ningdeScientManage_Web.LongCapitalPlanProcess" %>
...
<body>
 ...
 <div class="min_height">
           <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向经费预算流程</div></div></div><br />
                       ...
                       ShowHeaderWhenEmpty="true"    OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("LongCapitalPlanProcessId") %>' runat="server"
