<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndBranchDetailed.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsEndBranchDetailed" %>
...
<body>
    ...
    <div>
               <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >项目结题评审表</div></div></div><br />
...
<tr>
                        ...
                        <td width="30%" align="left" colspan="2">
                            ...
                            &nbsp;&nbsp;&nbsp;        
                            <asp:LinkButton runat="server" ForeColor="Blue" ID="LinkButton2" Text="下载模板" OnClick="LinkButton1_Click"></asp:LinkButton>
                        </td>
                          </tr>
                                <tr>
                        <td width="20%" align="right">
                        ...
                        <td width="30%" align="left" colspan="2">
                            <asp:FileUpload ID="fupFileSend" runat="server" Width="203px" />
                               ...
                               <td colspan="2">
                                     <asp:LinkButton runat="server" ID="LinkButton3" ForeColor="blue" Text="下载附件" OnClick="LinkButton2_Click"></asp:LinkButton>
