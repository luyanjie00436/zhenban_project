<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrganizationManage.aspx.cs" Inherits="ningdeScientManage_Web.OrganizationManage" %>
...
<body>
 ...
 <div class="min_height">
        <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >组织形式管理</div></div></div><br />

    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div class="btn_left2">
     <a href="OrganizationAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" ShowHeaderWhenEmpty="true" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="OrganizationId" HeaderText="组织形式编号">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="OrganizationName" HeaderText="组织形式名称">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='OrganizationUpd.aspx?Organization=<%# Eval("OrganizationId")%>&keepThis=true&TB_iframe=true&height=300&width=500''  class="fLink thickbox">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("OrganizationId") %>' runat="server"
