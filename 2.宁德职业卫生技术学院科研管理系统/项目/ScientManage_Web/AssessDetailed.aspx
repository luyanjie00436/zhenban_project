<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssessDetailed.aspx.cs" Inherits="ningdeScientManage_Web.AssessDetailed" %>
...
<body>
  ...
  <br /><br /><br />
        ...
        <div id="div2"  style="text-align: center; margin-top:10px ">
            <input id="div3" type="button" value="打 印" onclick=" printPage() " style="    width:60px; height:30px;    border:1px solid #000; border-radius:13px; text-align:center; line-height:30px;  cursor:pointer;" />
