<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsDeclareManage.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsDeclareManage" %>
<!DOCTYPE html>
...
<body>
 ...
 <div class="min_height">
         <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向申报管理</div></div></div><br />
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                  ...
                                  <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("LongProjectsId") %>' runat="server" OnCommand="LinkButton9_Command">删除</asp:LinkButton>
