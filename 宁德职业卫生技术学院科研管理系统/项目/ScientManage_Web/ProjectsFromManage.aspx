<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectsFromManage.aspx.cs" Inherits="ningdeScientManage_Web.ProjectsFromManage" %>
...
<body>
 ...
 <div class="min_height">
              <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >项目来源</div></div></div><br />

      <br />
           <div class="btn_left2">
     <a href="ProjectsFromAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong"  AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='ProjectsFromUpd.aspx?ProjectsFrom=<%# Eval("ProjectsFromId")%>&keepThis=true&TB_iframe=true&height=300&width=500'  class="fLink thickbox">
                                            修改</a>  
