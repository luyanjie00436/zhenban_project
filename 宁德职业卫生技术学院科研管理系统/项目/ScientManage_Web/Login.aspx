<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ningdeScientManage_Web.Login" %>
            ...
            <div class="login_h2">
             ...
             <div class="login_h5">
                 <span>密</span><span> 码:</span>
                     <div >
                         <input type="text" ID="txtLoginUserPwd" class="input8" runat="server" onfocus="this.type='password'"/>                                                
                     </div>
                </div>
