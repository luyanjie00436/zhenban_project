...
{
    public partial class ShortCapitalChangeAdd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable dt2 = bus.SelectByProjectsTemplateCategory("ProjectsTemplate_SelectByCategory", "经费变更").Tables[0];
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //创建文件夹
                string sPath = "File" + "\\" + "ShortProjects" + "\\" + ShortProjectsId + "\\CapitalChange\\";
                Directory.CreateDirectory(Server.MapPath("./") + sPath);
                //设置要保存的路径
                path = Server.MapPath("./") + "File" + "\\" + "ShortProjects" + "\\" + ShortProjectsId + "\\CapitalChange\\" + upName;
                //将文件保存到指定路径下
                fupFileSend.PostedFile.SaveAs(path);
                path = "File" + "\\" + "ShortProjects" + "\\" + ShortProjectsId + "\\CapitalChange\\" + upName;
                LFileUrl.Text = path;
            }
            ...
            if (bus.ShortCapitalPlanInsert("ShortCapitalChange_Insert", ShortProjectsId, UserCardId, path))
            {
