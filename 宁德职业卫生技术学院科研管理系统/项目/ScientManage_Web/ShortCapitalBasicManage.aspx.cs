...
{
    public partial class ShortCapitalBasicManage : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            RankId = Convert.ToInt32(HttpUtility.UrlDecode(Request.Cookies["RankId"].Value));
            GridView1.DataSource = bus.Select("ShortCapitalBasic_SelectCanUpdate").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            string url = "/ShortCapitalBasicAdd.aspx?ShortProjectsId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf");
