<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsManage.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsManage" %>
 ...
 <div class="min_height">
        ...
        <div style="margin-top: 10px">
                 ...
                 <asp:DropDownList ID="DLFrom" runat="server" CssClass="select1" Width="137px">
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DLDeclare" runat="server" CssClass="select1" Width="137px">
   ...
   <td align="right">
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DLInspect" runat="server" CssClass="select1" Width="137px">
