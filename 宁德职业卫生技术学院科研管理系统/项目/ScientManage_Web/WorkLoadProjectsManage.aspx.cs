...
namespace ningdeScientManage_Web
{
    public partial class WorkLoadProjectsManage : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsWorkLoadProjects("WorkLoadProjects_Selects", UserName, DepartmentId, Year, Month, Status, ProjectsName, ProjectsForm).Tables[0];
            string strExcelName = "科研项目成果";
