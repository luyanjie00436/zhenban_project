<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalChangeManage.aspx.cs" Inherits="ningdeScientManage_Web.LongCapitalChangeManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向经费预算变更</div></div></div><br />
                          ...
                          <asp:TemplateField HeaderText="变更状态">
                               ...
                               <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                   ...
                                   <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>变更</asp:LinkButton>
                                          </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
