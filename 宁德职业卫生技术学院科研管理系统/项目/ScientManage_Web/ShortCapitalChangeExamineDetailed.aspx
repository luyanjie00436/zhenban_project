<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalChangeExamineDetailed.aspx.cs" Inherits="ningdeScientManage_Web.ShortCapitalChangeExamineDetailed" %>
...
<body>
    ...
    <div>
                    <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >项目经费预算变动审批表</div></div></div><br />
