<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalPlaceDetailed.aspx.cs" Inherits="ningdeScientManage_Web.ShortCapitalPlaceDetailed" %>
         ...
         <table width="100%">
                   <tr>
                       <td  align="right" width="80%">
                            ...
                            <td>
                             <asp:TextBox ID="txtSumMoney" runat="server" Enabled="false" CssClass="input10"></asp:TextBox>
                            </td>
                   </tr>
               </table>
