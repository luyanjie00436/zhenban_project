...
{
    public partial class LongProjectsEndBranchManages : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/LongProjectsEndBranchManages.aspx") == 0)
                {
                      Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'</script>");
                }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsBranch("LongProjectsEndBranchView_Selects", UserName, DepartmentName, ProjectsName).Tables[0];
         
            string strExcelName = "项目结题评审";
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("LongProjectsEndBranchDetaileds.aspx?LongProjectsId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
