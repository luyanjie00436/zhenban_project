<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalPlanManage.aspx.cs" Inherits="ningdeScientManage_Web.LongCapitalPlanManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向经费预算</div></div></div><br />
                          ...
                          <asp:TemplateField HeaderText="预算状态">
                               ...
                               <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                   ...
                                   <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("LongProjectsId") %>'>预算</asp:LinkButton>
                                          </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
