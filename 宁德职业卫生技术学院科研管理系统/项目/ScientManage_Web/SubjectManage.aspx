<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectManage.aspx.cs" Inherits="ningdeScientManage_Web.SubjectManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >学科分类管理</div></div></div><br />
    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div class="btn_left2">
     <a href="SubjectAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" ShowHeaderWhenEmpty="true" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="SubjectId" HeaderText="学科分类编号">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="SubjectName" HeaderText="学科分类名称">
                                <HeaderStyle Width="33%" CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='SubjectUpd.aspx?Subject=<%# Eval("SubjectId")%>&keepThis=true&TB_iframe=true&height=300&width=500''  class="fLink thickbox">
                                            修改</a>  
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("SubjectId") %>' runat="server"
