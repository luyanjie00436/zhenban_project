<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsDeclareProcess.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsDeclareProcess" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >纵向项目流程</div></div></div><br />
                    ...
                    <tr>          
                           <td width="9%" align="right">
                            ...
                            <td width="11%" align="left">
                                 <asp:DropDownList ID="DLSubject" runat="server" CssClass="select1" Width="80%" AutoPostBack="True"  OnSelectedIndexChanged="DLSubject_SelectedIndexChanged">
