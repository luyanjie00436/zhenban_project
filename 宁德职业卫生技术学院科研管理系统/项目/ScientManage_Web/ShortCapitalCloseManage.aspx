<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalCloseManage.aspx.cs" Inherits="ningdeScientManage_Web.ShortCapitalCloseManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >横向经费决算管理</div></div></div><br />
                          ...
                          <asp:TemplateField HeaderText="结算状态">
                               ...
                               <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                   ...
                                   <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("ShortProjectsId") %>'>决算</asp:LinkButton>
                                          </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
