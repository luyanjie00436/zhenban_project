<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeManage.aspx.cs" Inherits="ningdeScientManage_Web.NoticeManage" %>
...
<body>
    <form id="form1" runat="server">
                 <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >通知公告</div></div></div><br />

        <br />
           <div class="btn_left2">
     <a href="NoticeAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                         ...
                                         OnCommand="LinkButton8_Command">附件下载</asp:LinkButton>
                                 
                                         <a href='NoticeUpd.aspx?Notice=<%# Eval("NoticeId")%>&keepThis=true&TB_iframe=true&height=300&width=500'  class="fLink thickbox">
                                            修改</a>   
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("NoticeId") %>' runat="server"
