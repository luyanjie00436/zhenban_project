<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortProjectsStandManage.aspx.cs" Inherits="ningdeScientManage_Web.ShortProjectsStandManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >横向立项管理</div></div></div><br />

           <div  class="btn_left2">
         <asp:LinkButton ID="LinkButton3"  runat="server" CssClass="btn_right"   OnClick="LinkButton3_Click">项目添加</asp:LinkButton>
                 <asp:LinkButton ID="LinkButton9"  runat="server" CssClass="btn_right"  OnClick="LinkButton9_Click">刷新</asp:LinkButton>
                </div><br />
                        ...
                        <Columns>                             
                            ...
                            <asp:BoundField DataField="ContractMoney" HeaderText="合作金额">
                             ...
                             <asp:TemplateField HeaderText="立项状态">
                                    <ItemTemplate>
                                        <asp:Label ID="LStandStatus" runat="server" Text='<%# Eval("StandStatus") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="gridview_HeaderStyle" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                  ...
                                  <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("ShortProjectsId") %>'>修改</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("ShortProjectsId") %>' runat="server" OnCommand="LinkButton9_Command">删除</asp:LinkButton>
