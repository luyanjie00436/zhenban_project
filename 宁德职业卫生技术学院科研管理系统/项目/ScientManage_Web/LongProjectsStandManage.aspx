<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsStandManage.aspx.cs" Inherits="ningdeScientManage_Web.LongProjectsStandManage" %>
...
<body>
 ...
 <div class="min_height">
       <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >个人纵向项目立项情况</div></div></div><br />

     <br />
        
    <div class="page_main01">
        <div style="margin-top: 10px">
          <p style="font-size:20px;padding-left:12px;">可立项项目</p>
              <asp:GridView ID="GridView2" runat="server" BackColor=" #d4d2d2"   CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                  ...
                  <AlternatingRowStyle BackColor="#bfbdbd" />
                        ...
                        <PagerStyle CssClass="str001" />
                         ...
                         <br />
            <p style="font-size:20px;padding-left:12px;">已立项项目</p>
