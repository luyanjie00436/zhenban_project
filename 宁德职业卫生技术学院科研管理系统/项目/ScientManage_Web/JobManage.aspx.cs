...
namespace ningdeScientManage_Web
{
    ...
    public partial class JobManage : System.Web.UI.Page
    {
        ...
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            ...
            if (countjob > 0)
            {
                Response.Write("<script>alert('您要删除的职称已有" + countjob + "位用户在使用，不能删除该职称！');</script>");
            }
            else if (bus.JobDelete("Job_Delete", Convert.ToInt32(e.CommandArgument.ToString()),UserCardId))
            {
