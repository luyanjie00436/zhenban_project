...
LProjectsContent.Text = dt.Tables[0].Rows[0]["ProjectsContent"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsStandExamineInsert("LongProjectsStandExamine_Insert", LongProjectsId, ExamineOpinion, UserCardId, "审批通过", RankId))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsStandExamineInsert("LongProjectsStandExamine_Insert", LongProjectsId, ExamineOpinion, UserCardId, "审批未通过", RankId))
            {
                Response.Write("<script>alert('审批成功！')</script>");
                dataGriviewBD();
            }
