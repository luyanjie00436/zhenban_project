...
namespace ningdeScientManage_Web
{
    public partial class GuidanceManage : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = bus.SelectsGuidance("Guidance_Selects", UserName, DepartmentId, Year, Month, Status, GuidanceName, GuidanceLevel).Tables[0];
           
            string strExcelName = "教学质量工程成果";
