<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectsLevelManage.aspx.cs" Inherits="ningdeScientManage_Web.ProjectsLevelManage" %>
...
<body>
 ...
 <div class="min_height">
              <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >项目级别</div></div></div><br />

    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
      <br />
           <div class="btn_left2">
     <a href="ProjectsLevelAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500"  class="fLink thickbox" style="  
                    ...
                    <asp:GridView ID="GridView1" BackColor=" #d4d2d2"   CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                          <a href='ProjectsLevelUpd.aspx?ProjectsLevel=<%# Eval("ProjectsLevelId")%>&keepThis=true&TB_iframe=true&height=300&width=500'  class="fLink thickbox">
                                            修改</a>  
