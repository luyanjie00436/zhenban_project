...
namespace ningdeScientManage_Web
{
    public partial class LongProjectsDeclareAdd : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
           ...
           DateTime NowDate = Convert.ToDateTime( DateTime.Now.ToString("yyyy/MM/dd"));
            ...
            int ProjectsSubject = Convert.ToInt32(DLSubject.SelectedItem.Value);
             ...
             {
                  Response.Write("<script>alert('请输入研究内容摘要！')</script>");
                return;
             }
            ...
            try
            {
                ...
                LFileUrl.Text = path;
                if (bus.LongProjectsInsert("LongProjects_Insert", LongProjectsId, UserCardId, LongProjectsName,ProjectsFrom,ProjectsSubject,ProjectsLevel,Company, path,ProjectsContent))
                {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsInsert("LongProjects_Update", LongProjectsId, UserCardId, LongProjectsName, ProjectsFrom, ProjectsSubject, ProjectsLevel, Company, path, ProjectsContent))
            {
