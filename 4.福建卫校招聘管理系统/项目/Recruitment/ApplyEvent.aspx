<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyEvent.aspx.cs" Inherits="Recruitment.ApplyEvent" %>
...
<body>
  ...
  <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2">岗位报名查询</div></div></div><br />
        ...
        <div >
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="juzhong" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Contents" HeaderText="审核说明">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                               ...
                               <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">                                 
                                          <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("JobId") %>' ToolTip="点击跳转到住准考证页面" ForeColor="Blue">查看准考证</asp:LinkButton>
