<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobGradeManage.aspx.cs" Inherits="Recruitment.Manage.JobGradeManage" %>
          ...
          <div class="zong">
            ...
            <div class="you" >                      
              <div class="min_height">
                <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >成绩录入</div></div></div>
                <br />
               ...
               <td >初审通过人数：<asp:Label ID="Label19" runat="server" Text='<%# Eval("UserCount") %>' ></asp:Label></td>
                ...
                <tr>
                    ...
                    <td  colspan="3" align="right" style="padding-right:10px;" > 
                         ...
                         <asp:LinkButton ID="lnkUpdate" runat="server" CommandArgument='<%#Eval("JobMangeId") %>' CssClass="btnn" CommandName="Update">查看详情</asp:LinkButton>
                          </tr>
     </table>
