<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CandidatesInfoMange.aspx.cs" Inherits="Recruitment.CandidatesInfoMange" %>
      ...
      <div class="wrap" >
        ...
        <div class="zuo" >
          <div class="zong">
              ...
              <div class="suowz" >搜索考生</div>
                <div class="sousuo" >
                  <table border="0" class="bgg" width="100%" >
                    <tr><td align="right" class="auto-style3" >报名序号：</td><td  align="left" > <asp:TextBox ID="txtNumber" runat="server"  Width="90%"></asp:TextBox></td></tr>

                    <tr>
                      <td align="right" class="auto-style3" >姓名：</td><td  align="left" > <asp:TextBox ID="txtName" runat="server" Width="90%"></asp:TextBox></td>
                    </tr>

                    <tr>
                      <td align="right" class="auto-style3" >身份证号：</td><td  align="left" > <asp:TextBox ID="txtIdCard" runat="server" Width="90%"></asp:TextBox></td>
                    </tr>
                    <tr>
                      <td align="right" class="auto-style3" >联系电话：</td><td  align="left" > <asp:TextBox ID="txtPhone" runat="server" Width="90%"></asp:TextBox></td>
                    </tr>
                    <tr>
                      <td align="right" class="auto-style3" >电子邮箱：</td><td  align="left" > <asp:TextBox ID="txtEmail" runat="server" Width="90%"></asp:TextBox></td>
                    </tr>
                    <tr>
                      <td align="right" class="auto-style3" >毕业院校：</td><td  align="left" > <asp:TextBox ID="txtInstitutions" runat="server" Width="90%"></asp:TextBox></td>
                    </tr>  
                    <tr>
                      <td align="right" class="auto-style3" >专业名称：</td><td  align="left" > <asp:TextBox ID="txtProfessionName" runat="server" Width="90%"></asp:TextBox></td>
                   </tr>                                                 
                                                               
                      <tr><td align="right" class="auto-style3" ></td><td  align="right" style="padding-right:10px;" > <asp:Button ID="Button10" runat="server" CssClass="btn" Text="搜 索" OnClick="Button10_Click"   />
                    </td></tr> 
                  </table>
                </div>       
              </div>
            ...
            <div class="you" > 
                                     <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2">考生信息管理</div></div></div>
                ...
                <tr>
                    ...
                    <td  colspan="3" align="right"> 
                       <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btnn" CommandArgument='<%#Eval("Number") %>' CommandName="Update">查看详情</asp:LinkButton>
                       <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btnn" CommandArgument='<%#Eval("Number")  %>' CommandName="Edit">导出</asp:LinkButton>
