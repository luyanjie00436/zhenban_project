...
namespace Recruitment.Manage
{
    public partial class GradeManage : System.Web.UI.Page
    {
        ...
        public void chaxun()
        {
            ...
            JobMangeId = Convert.ToInt32(pwds.DecryptDES(Request.QueryString["JobMangeId"], "asdfasdf"));
            DataSet dy = bus.Job_Selects("JobGrade_Selects", Number, Name, IdCard, Phone, Email, Institutions, Profession, Sort, JobMangeId);
        ...
        protected void DataList1_UpdateCommand(object source, DataListCommandEventArgs e)
        {
            ...
            Response.Redirect("GradeUpd.aspx?JobId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
    }
}