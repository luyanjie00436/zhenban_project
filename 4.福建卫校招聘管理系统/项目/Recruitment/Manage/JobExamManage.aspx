<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobExamManage.aspx.cs" Inherits="Recruitment.Manage.JobExamManage" %>
                   ...
                   <tr>
                    ...
                    <tr>
                        <td align="right" class="auto-style3" >
                           <asp:Button ID="Button10" runat="server" Text="搜 索" OnClick="Button10_Click"  />
                        </td>
                        <td  align="left" style="padding-right:15px;" > 
                            <asp:Button ID="Button11" runat="server" Text="导 出" OnClick="Button11_Click"  />
                        </td>
                    </tr> 
                  </table>
                </div>       
              ...
              <div class="min_height">
               ...
               <asp:DataList ID="dataOfYear" runat="server" Width="100%" 
                ...
                <tr>
                    ...
                    <td >年份：<asp:Label ID="Label20" runat="server" Text='<%# Eval("Years") %>' ></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td >考场：<asp:Label ID="Label21" runat="server" Text='<%# Eval("ExamAddress") %>' ></asp:Label></td>
                </tr>
                <tr>
               ...
               <td >初审通过人数：<asp:Label ID="Label19" runat="server" Text='<%# Eval("UserCount") %>' ></asp:Label></td>
                ...
                <tr>
                    ...
                    <td  colspan="3" align="right" style="padding-right:10px;" > 
                          <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%#Eval("JobMangeId") %>' CssClass="btnn" CommandName="Update">设置考试科目</asp:LinkButton>
                         
                        
                         <asp:LinkButton ID="lnkUpdate" runat="server" CommandArgument='<%#Eval("JobMangeId") %>' CssClass="btnn" CommandName="Delete">设置考场及注意事项</asp:LinkButton>
                          </tr>
     </table>
