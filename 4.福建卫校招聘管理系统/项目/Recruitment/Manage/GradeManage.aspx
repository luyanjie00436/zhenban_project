<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeManage.aspx.cs" Inherits="Recruitment.Manage.GradeManage" %>
        ...
        <div class="zuo" >
          <div class="zong">
            <div class="caozuo"  ><div class="caozuowz">操作</div></div>
              ...
              <div class="xiala">
                <asp:DropDownList Width="95%" ID="DSort" runat="server" >
                  <asp:ListItem Value="FollDateDesc">注册时间倒序排列</asp:ListItem>
                  <asp:ListItem Value="FollDateAsc">注册时间正序排列</asp:ListItem>  
            ...
            <div class="you" > 
                ...
                <tr>
                   <td >分数：<asp:Label ID="Label12" runat="server" Text='<%# Eval("Grade") %>' ></asp:Label></td>
                   <td >&nbsp;</td> <td >&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td  colspan="3" align="right" style="padding-right:10px;" > 
                       <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btnn" CommandArgument='<%#Eval("JobId") %>' CommandName="Update">修改分数</asp:LinkButton>
