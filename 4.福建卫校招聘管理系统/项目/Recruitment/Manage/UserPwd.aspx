<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserPwd.aspx.cs" Inherits="Recruitment.UserPwd" %>
...
<div class="bejj"><span  style="color:#fff; width:200px;  float:left; line-height:2;font-size:14px; font-weight:bold;">修改密码</span></div>
    <div>
            ...
            <ContentTemplate>
                ...
                <table  border="0" cellspacing="0" cellpadding="0" class="uua">
                    ...
                    <tr class="tr10">
                                                ...
                                                <td width="70%" height="80"  colspan="2" align="center" valign="middle" >
