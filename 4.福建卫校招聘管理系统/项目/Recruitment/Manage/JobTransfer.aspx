<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobTransfer.aspx.cs" Inherits="Recruitment.Manage.JobTransfer" %>
          ...
          <div class="zong">
            ...
            <div class="you" >                      
              <div class="min_height">
                <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >岗位管理</div></div></div>
                <br />
               ...
               <td >报名人数：<asp:Label ID="Label19" runat="server" Text='<%# Eval("UserCount") %>' ></asp:Label></td>
                      </tr>
                <tr>
