...
{
    public partial class JobTransfer : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            ...
            DataSet dy = bus.JobMange_Selects("JobMange_Selects", JobName, SubjectName, Culture, Political, Recruitment, Gender, Should, Nation, Degree, Position, Education, Age, Profession, Sort, Years);
        ...
        protected void DataList1_UpdateCommand(object source, DataListCommandEventArgs e)
        {
            ...
            Response.Redirect("Useatransfer.aspx?JobMangeId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
