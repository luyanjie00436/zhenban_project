<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamGradeManage.aspx.cs" Inherits="Recruitment.Manage.ExamGradeManage" %>
          ...
          <div class="zong">
            ...
            <div class="you" >                      
              <div class="min_height">
                <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >考试信息管理</div></div></div>
                <br />
               ...
               <asp:DataList ID="dataOfYear" runat="server" Width="100%" 
                ...
                <td >年份：<asp:Label ID="Label21" runat="server" Text='<%# Eval("Years") %>' ></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td >报考费用：<asp:Label ID="Label14" runat="server" Text='<%# Eval("ApplyCost") %>' ></asp:Label></td>
                       <td >考室号：<asp:Label ID="Label20" runat="server" Text='<%# Eval("TestAddress") %>' ></asp:Label></td>
                </tr>
                <tr>
                   ...
                   <td >招收人数：<asp:Label ID="Label18" runat="server" Text='<%# Eval("Enrollment") %>' ></asp:Label></td>
                      <td >初审通过人数：<asp:Label ID="Label19" runat="server" Text='<%# Eval("UserCount") %>' ></asp:Label></td>
                     </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td  colspan="3" align="right"> 
                         ...
                         <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btnn"  CommandArgument='<%#Eval("JobMangeId") %>' CommandName="Update">修改考试科目</asp:LinkButton>
                         <a  href='JobMangeTestAdd.aspx?JobMange=<%# Eval("JobMangeId")%>&keepThis=true&TB_iframe=true&height=300&width=500'  class="fLink thickbox" style="    background:#dedede; border:1px solid #a6a6a6; padding:3px 15px 3px 15px;    border-radius:4px;" title="修改考室">
                                              <asp:Label ID="A7" runat="server" >修改考室</asp:Label></a>
                          <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btnn"  CommandArgument='<%#Eval("JobMangeId") %>' CommandName="Delete">修改考试注意事项</asp:LinkButton>
                        </tr>
     </table>
