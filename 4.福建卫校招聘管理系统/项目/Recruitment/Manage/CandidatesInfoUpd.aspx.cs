...
{
    public partial class CandidatesInfoUpd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["NumberId"] != null)
                {
                    ...
                    txtExpertise.Text = ds.Tables[0].Rows[0]["Expertise"].ToString();
                    txtResume.Text = ds.Tables[0].Rows[0]["Resumes"].ToString();
                    txtFamilyMember.Text = ds.Tables[0].Rows[0]["FamilyMember"].ToString();
                    txtPerformance.Text = ds.Tables[0].Rows[0]["Performance"].ToString();
        ...
        //    string Resumes = txtResume.Text;
        //    string FamilyMember = txtFamilyMember.Text;
