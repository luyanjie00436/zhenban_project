...
{
    public partial class JobGradeManage : System.Web.UI.Page
    {
        ...
        protected void DataList1_UpdateCommand(object source, DataListCommandEventArgs e)
        {
            ...
            Response.Redirect("GradeManage.aspx?JobMangeId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
