<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalChangeProcess.aspx.cs" Inherits="ScientManage_Web.LongCapitalChangeProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">资金预算变更流程</div>
                </div>
            </div>
                ...
                <div style="margin-top: 10px">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <br>
                            <br>
                            <asp:GridView ID="GridView1" runat="server" Width="98%" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True"
