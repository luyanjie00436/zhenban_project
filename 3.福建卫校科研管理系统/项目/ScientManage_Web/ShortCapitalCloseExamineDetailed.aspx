<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalCloseExamineDetailed.aspx.cs" Inherits="ScientManage_Web.ShortCapitalCloseExamineDetailed" %>
                    ...
                    <div>
                        ...
                        <table class="biaoe" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td colspan="6">
                                    <asp:TextBox ID="txtExamineOpinion" runat="server" Columns="1" CssClass="input1" Height="80" data-toggle="tooltip" data-placement="top" ToolTip="请输入审批意见" MaxLength="400" Rows="5" TextMode="MultiLine" Width="98%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td height="28">
