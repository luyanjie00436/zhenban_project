<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortProjectsEndExamineDetailed.aspx.cs" Inherits="ScientManage_Web.ShortProjectsEndExamineDetailed" %>
                    ...
                    <div>
                        ...
                        <table class="biaoe" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td colspan="6">
                                    <asp:TextBox ID="txtExamineOpinion" runat="server" Columns="1" CssClass="input1" Height="80" MaxLength="400" data-toggle="tooltip" data-placement="top" ToolTip="请输入审批意见" Rows="5" TextMode="MultiLine" Width="98%"></asp:TextBox>
