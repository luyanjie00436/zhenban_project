...
{
    public partial class Teaching__TeamManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/Teaching_TeamManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
     ...
     /*   public void ExportToExcel(System.Web.UI.Page page, GridView excel, string fileName)
        ...
        public void dataGriviewBD()
        {
            ...
            int Month;
            string Teaching_TeamYear = DLApplyYear.SelectedItem.Text;
            if (Teaching_TeamYear == "选择年份")
            {
                Teaching_TeamYear = "";
            }
            try
            ...
            DataTable dt = bus.SelectsTeaching_Team("Teaching_Team_Selects", UserName, DepartmentId, Year, Month, Status, Teaching_TeamName, Leve, Teaching_TeamYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsTeaching_Team("Teaching_Team_Selects", UserName, DepartmentId, Year, Month, Status, Teaching_TeamName, Leve, Teaching_TeamYear).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("Teaching_TeamDetailed.aspx?Teaching_TeamId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("Teaching_TeamManage.aspx");
        }
        //合并单元格
