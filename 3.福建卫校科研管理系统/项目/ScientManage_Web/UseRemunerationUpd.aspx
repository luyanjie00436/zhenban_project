<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseRemunerationUpd.aspx.cs" Inherits="ScientManage_Web.UseRemunerationUpd" %>
                    ...
                    <ContentTemplate>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td width="70%" align="left">
                                    <asp:TextBox ID="txtRemuneration" data-toggle="tooltip" data-placement="top" ToolTip="请输入行政职级" CssClass="input6" runat="server" Height="27px" Width="137px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" class="auto-style2">
                            ...
                            <tr class="tr10">
                                ...
                                <td width="70%" height="80" align="left" valign="middle">
                                    <asp:Button ID="Button1" runat="server" Text="修 改" data-toggle="tooltip" data-placement="top" ToolTip="点击进行修改" OnClick="Button1_Click" CssClass="btn" />&nbsp;</td>
                            </tr>
                        </table>
                    </ContentTemplate>
                </asp:UpdatePanel>
