<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_constructionPartnerManage.aspx.cs" Inherits="ScientManage_Web.C_constructionPartnerManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">课程建设合作者</div>
                </div>
            </div>
                    ...
                    <ContentTemplate>
                        <div style="margin-bottom: 10px">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="right" class="auto-style1">请选择您申报的课程建设项目:
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DlC_Construction" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Partner_SelectedIndexChanged"
                                            CssClass="select1" data-toggle="tooltip" data-placement="top" ToolTip="选择您申报的课程建设项目">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" AutoGenerateColumns="False" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="操作">
                                            <ItemTemplate>
                                                <div class="link02">
                                                    <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("C_constructionPartnerId") %>'
                                                        OnCommand="LinkButton6_Command" ToolTip="点击进行修改">编辑</asp:LinkButton>
                                                    <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("C_constructionPartnerId") %>'
