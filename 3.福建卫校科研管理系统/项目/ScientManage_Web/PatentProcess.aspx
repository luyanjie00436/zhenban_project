<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatentProcess.aspx.cs" Inherits="ScientManage_Web.PatentProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">专利审批流程</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("PatentProcessId") %>' runat="server"
