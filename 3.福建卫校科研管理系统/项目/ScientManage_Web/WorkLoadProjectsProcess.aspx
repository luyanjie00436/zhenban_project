<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLoadProjectsProcess.aspx.cs" Inherits="ScientManage_Web.WorkLoadProjectsProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">科研项目审批流程</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" Width="100%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("WorkloadProjectsProcessId") %>' runat="server"
