...
{
    public partial class MyShortProjectsEndManage : System.Web.UI.Page
    {
        ...
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            GridView1.DataSource = bus.SelectByUserCardId("ShortProjectsEnd_SelectByMyUserCardId", UserCardId).Tables[0].DefaultView;
            GridView1.DataBind();
        }
        //项目添加
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            ...
            string url = "/ShortProjectsEndAdds.aspx?Proid=" + pwds.EncryptDES(proid, "asdfasdf");
        ...
        {
            string url = "/ShortProjectsEndAdds.aspx?Proid=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf");
            Response.Redirect(url);
        ...
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            ...
            if (bus.ShortProjectsDelete("ShortProjectsEnd_Delete", e.CommandArgument.ToString()))
            {
