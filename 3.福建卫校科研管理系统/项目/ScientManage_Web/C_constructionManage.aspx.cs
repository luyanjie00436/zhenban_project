...
{
    public partial class C_constructionManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/C_constructionManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        public void dataGriviewBD()
        {
            ...
            int Month;
            string C_constructionYear = DLApplyYear.SelectedItem.Text;
            if (C_constructionYear == "选择年份")
            {
                C_constructionYear = "";
            }
            try
            ...
            DataTable dt = bus.SelectsC_construction("C_construction_Selects", UserName, DepartmentId, Year, Month, Status, C_constructionName, Leve, C_constructionYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
           ...
           return bus.SelectsC_construction("C_construction_Selects", UserName, DepartmentId, Year, Month, Status, C_constructionName, Leve, C_constructionYear).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("C_constructionDetailed.aspx?C_constructionId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("C_constructionManage.aspx");
        }
        //合并单元格
