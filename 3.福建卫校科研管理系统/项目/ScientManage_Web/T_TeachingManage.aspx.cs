...
{
    public partial class T_TeachingManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/T_TeachingManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
      ...
      /*  public void ExportToExcel(System.Web.UI.Page page, GridView excel, string fileName)
        ...
        public void dataGriviewBD()
        {
            ...
            int Month;
            string T_TeachingYear = DLApplyYear.SelectedItem.Text;
            if (T_TeachingYear == "选择年份")
            {
                T_TeachingYear = "";
            }
            try
            ...
            DataTable dt = bus.SelectsT_Teaching("T_Teaching_Selects", UserName, DepartmentId, Year, Month, Status, T_TeachingName, Category, T_TeachingYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsT_Teaching("T_Teaching_Selects", UserName, DepartmentId, Year, Month, Status, T_TeachingName, Category, T_TeachingYear).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("T_TeachingDetailed.aspx?T_TeachingId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("T_TeachingManage.aspx");
        }
        //合并单元格
