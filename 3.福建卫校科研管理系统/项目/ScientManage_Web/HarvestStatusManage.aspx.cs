...
{
    public partial class HarvestStatusManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/HarvestManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectsHarvest("Harvest_Selects", UserName, DepartmentId, Year, Month, Status, HarvestName, Company, WinningYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
           ...
           return bus.SelectsHarvest("Harvest_Selects", UserName, DepartmentId, Year, Month, Status, HarvestName, Company, WinningYear).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            Response.Redirect("HarvestStatusModify.aspx?HarvestId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("HarvestManage.aspx");
        }
