<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndExamineDetailed.aspx.cs" Inherits="ScientManage_Web.LongProjectsEndExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">项目结题审批表</div>
                </div>
            </div>
                        ...
                        <table class="biaob">
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="text-align: left; padding-left: 20px;">
                                    <asp:LinkButton ForeColor="blue" Text="查看详细" runat="server" ID="LinkButton4" OnClick="LinkButton4_Click" ToolTip="点击跳转到项目中检审批表"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
