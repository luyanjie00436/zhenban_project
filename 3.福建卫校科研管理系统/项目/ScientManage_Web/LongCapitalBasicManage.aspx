<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalBasicManage.aspx.cs" Inherits="ScientManage_Web.LongCapitalBasicManage" %>
            ...
            <div class="min_height">
                <div class="aa">
                    <div class="parallelogram">
                        <div class="parallelogram2">经费基本信息设置</div>
                    </div>
                </div>
                                ...
                                <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="操作">
                                            <ItemTemplate>
                                                <div class="link02">
                                                    <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点击进行设置经费">设置</asp:LinkButton>
                                                </div>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="gridview_HeaderStyle" />
                                            <ItemStyle HorizontalAlign="Center" />
