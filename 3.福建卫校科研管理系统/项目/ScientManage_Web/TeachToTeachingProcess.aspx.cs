...
{
    public partial class TeachToTeachingProcess : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/T_TeachingProcess.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.TeachToTeachingProcessInsert("TeachToTeachingProcess_Insert", RankId, ProcessOrder, DepartmentName, UserCardId))
            {
        ...
        public void dataGriviewBD()
        {
            ...
            GridView1.DataSource = bus.Select("TeachToTeachingProcessProcess_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("TeachToTeachingProcess.aspx");
        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {

            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            if (bus.TeachToTeachingProcessDelete("TeachToTeachingProcess_Delete", Convert.ToInt32(e.CommandArgument.ToString()), UserCardId))
            {
