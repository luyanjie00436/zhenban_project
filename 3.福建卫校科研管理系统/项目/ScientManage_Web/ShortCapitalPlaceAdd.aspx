<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalPlaceAdd.aspx.cs" Inherits="ScientManage_Web.ShortCapitalPlaceAdd" %>
                        ...
                        <div style="margin-bottom: 10px">
                            <table class="bgcolor" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtPlaceDate" data-toggle="tooltip" data-placement="top" title="点击请选择到位时间" runat="server" cssclass="Wdate" readonly="true" onfocus="WdatePicker()"
                                            class="input1">
                                    </td>
                                    <td align="right">到位说明
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPlaceExplain" data-toggle="tooltip" data-placement="top" ToolTip="请输入到位说明" runat="server" CssClass="input1" Width="197px"></asp:TextBox>
                                    </td>
                                    <td align="center">
                                        <asp:Button ID="Button2" runat="server" Text="修 改" data-toggle="tooltip" data-placement="top" ToolTip="点击修改" OnClick="Button2_Click" CssClass="btn" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AutoGenerateColumns="False" Width="98%">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("ShortCapitalPlaceId") %>'
                                                    OnCommand="LinkButton6_Command">编辑</asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("ShortCapitalPlaceId") %>'
