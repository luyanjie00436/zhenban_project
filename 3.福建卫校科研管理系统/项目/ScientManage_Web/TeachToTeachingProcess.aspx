<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachToTeachingProcess.aspx.cs" Inherits="ScientManage_Web.TeachToTeachingProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">教学工作量转化教研分流程</div>
                </div>
            </div>
                        ...
                        <ContentTemplate>
                            <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="24%" height="80" align="left">
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("TeachToTeachingProcessId") %>' runat="server"
