<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NationAdd.aspx.cs" Inherits="ScientManage_Web.NationAdd" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="70%" align="left">
                                    <asp:TextBox ID="txtNationName" runat="server" CssClass="input6" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入民族名称"></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="tr10">
