<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachingPartnerManage.aspx.cs" Inherits="ScientManage_Web.TeachingPartnerManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">著作合作者</div>
                </div>
            </div>
                    ...
                    <ContentTemplate>
                        <div style="margin-bottom: 10px">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="right" class="auto-style1">请选择您申报的著作:
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DlTeaching" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Partner_SelectedIndexChanged"
                                            CssClass="select1" data-toggle="tooltip" data-placement="top" ToolTip="选择您申报的著作">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtPartnerRank" type="" runat="server" onblur="javascript:yzszfw1(this,0,100);" class="input1" data-toggle="tooltip" data-placement="top" title="输入本人排名 例如（1、2、3......）"></input>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtPartnerValue" runat="server" type="" onblur="javascript:yzszfw1(this,0,99999999);" class="input1" data-toggle="tooltip" data-placement="top" title="输入分配分值 例如（1、2、3......）"></input>
                                    </td>
                                </tr>
                                <tr>
