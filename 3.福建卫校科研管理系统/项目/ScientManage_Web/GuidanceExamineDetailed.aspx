<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidanceExamineDetailed.aspx.cs" Inherits="ScientManage_Web.GuidanceExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">指导学生审批表</div>
                </div>
            </div>
                    ...
                    <div>
                        <table class="biaob">
                            <tr>
                                ...
                                <td class="td5">成果或调研报告名称</td>
                                <td class="td5">成果或采用级别</td>
                                <td class="td5">备注</td>
                            ...
                            <tr>
                                ...
                                <td class="td5" align="center">
                                    <asp:Label ID="LGuidanceName" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LGuidanceLevel" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center" style="word-break: break-all; width: 100px;">
                                    <asp:Label ID="LRemarks" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LGuidanceValue" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
