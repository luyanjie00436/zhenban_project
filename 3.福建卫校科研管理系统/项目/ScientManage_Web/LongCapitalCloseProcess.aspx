<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalCloseProcess.aspx.cs" Inherits="ScientManage_Web.LongCapitalCloseProcess" %>
                        ...
                        <ContentTemplate>
                            <table border="0" cellspacing="0" cellpadding="0" class="bgcolor">
                                <tr>
                                    ...
                                    <td width="11%" align="left">
                                        <asp:DropDownList ID="DlProcessOrder" runat="server" CssClass="select1" Width="80%" data-toggle="tooltip" data-placement="top" ToolTip="选择审批角色">
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("LongCapitalCloseProcessId") %>' runat="server"
