<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRole.aspx.cs" Inherits="ScientManage_Web.UserRole" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">用户职务管理</div>
                </div>
            </div>
                        ...
                        <ContentTemplate>
                            <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="right">
                                        <asp:TextBox ID="txtUserCardId" Enabled="false" CssClass="select1" runat="server" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="用户工号"></asp:TextBox>
                                    </td>
                                    <td class="left"><strong>行政隶属：</strong></td>
                                    <td class="right">
                                        <asp:DropDownList ID="DlDepartment" Height="27px" runat="server" CssClass="select1" ToolTip="选择行政隶属">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="left"><strong>行政职务：</strong></td>
                                    <td class="right">
                                        <asp:DropDownList ID="DlRole" Height="27px" runat="server" CssClass="select1" ToolTip="选择行政职务">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="left">
                                        ...
                                        <asp:Button ID="Button2" runat="server" Text="修 改" OnClick="Button2_Click" CssClass="btn" Visible="False" data-toggle="tooltip" data-placement="top" ToolTip="点击进行修改" />
                                    </td>
                                </tr>
                            </table>
                            <br>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("UserRoleId") %>' ToolTip="点击进行修改">修改</asp:LinkButton>
