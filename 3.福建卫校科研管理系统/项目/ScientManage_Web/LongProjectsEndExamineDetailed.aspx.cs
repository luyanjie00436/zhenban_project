...
{
    public partial class LongProjectsEndExamineDetailed : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsDeclareExamineInsert("LongProjectsEndExamine_Insert", LongProjectsId, ExamineOpinion, UserCardId, "审批通过", RankId))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsDeclareExamineInsert("LongProjectsEndExamine_Insert", LongProjectsId, ExamineOpinion, UserCardId, "审批未通过", RankId))
            {
                Response.Write("<script>alert('审批成功！');window.history.go(-1);</script>");
                dataGriviewBD();
            }
