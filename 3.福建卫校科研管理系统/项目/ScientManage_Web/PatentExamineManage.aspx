<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatentExamineManage.aspx.cs" Inherits="ScientManage_Web.PatentExamineManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">专利审批</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("PatentId") %>' ToolTip="跳转到专利审批表进行审批">审批</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
