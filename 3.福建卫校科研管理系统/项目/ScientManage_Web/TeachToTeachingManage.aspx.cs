...
{
    public partial class TeachToTeachingManage : System.Web.UI.Page
    {
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("TeachToTeachingDetailed.aspx?TeachToTeachingId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
