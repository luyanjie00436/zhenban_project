<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalChangeExamineDetailed.aspx.cs" Inherits="ScientManage_Web.ShortCapitalChangeExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">项目经费预算变动审批表</div>
                </div>
            </div>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto">
                    <div>
                        ...
                        <table class="biaob">
                            ...
                            <tr>
                                <td align="right" class="td5">合同金额：</td>
                                <td class="td5">
                        ...
                        <table class="biaoe" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td colspan="6">
                                    <asp:TextBox ID="txtExamineOpinion" data-toggle="tooltip" data-placement="top" ToolTip="请填写审批意见" runat="server" Columns="1" CssClass="input1" Height="80" MaxLength="400" Rows="5" TextMode="MultiLine" Width="98%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td height="28">
                                    <div class="page_title_txt">
                                        <asp:Button ID="Button1" runat="server" data-toggle="tooltip" data-placement="top" ToolTip="点击同意" Text="同 意" OnClick="Button1_Click" CssClass=" btn" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <asp:Button ID="Button2" runat="server" Text="拒 绝" data-toggle="tooltip" data-placement="top" ToolTip="点击拒绝" OnClick="Button2_Click" CssClass="btn" />
                                    </div>
                                </td>
                            </tr>
                        </table>
