<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestStatusManage.aspx.cs" Inherits="ScientManage_Web.HarvestStatusManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">成果审批管理</div>
                </div>
            </div>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server"
                                            OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="跳转到成果项目审批表">修改审批状态</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
