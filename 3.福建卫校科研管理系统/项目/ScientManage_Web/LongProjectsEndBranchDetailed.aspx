<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndBranchDetailed.aspx.cs" Inherits="ScientManage_Web.LongProjectsEndBranchDetailed" %>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto">
                    ...
                    <div>
                        <table class="biaob">
                            ...
                            <tr>
                                <td class="td5" align="right">结题材料：</td>
                                <td class="td5">
                                    <asp:Label ID="LFileUrl" runat="server" Visible="false"></asp:Label>
                                    <asp:LinkButton ForeColor="blue" Text="附件下载" runat="server" ID="LinkButton1" OnClick="LinkButton1_Click" ToolTip="点击下载结题材料附件"></asp:LinkButton>
                                </td>
                                <td class="td5"></td>
                                <td class="td5"></td>
                            </tr>
                        ...
                        <table class="biaoc">
                            <tr>
                                <td align="right">
                                    <strong>分值：</strong>&nbsp;</td>
                                <td>
                                    <input id="txtBranch" runat="server" columns="1" class="input1" rows="5" type="" onblur="javascript:yzszfw1(this,0,99999999);" data-toggle="tooltip" data-placement="top" title="输入分值"/>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
