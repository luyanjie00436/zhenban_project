<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teaching_TeamAdd.aspx.cs" Inherits="ScientManage_Web.Teaching__TeamAdd" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">教学团队建设添加</div>
                </div>
            </div>
            <div class="page_main01">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left" width="12%">
                            <asp:TextBox ID="txtTeaching_TeamName" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入项目的名称"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="12%">
                            <input id="txtTeaching_TeamValue" runat="server" class="input1" type="" onblur="javascript:yzszfw1(this,0,99999999);" data-toggle="tooltip" data-placement="top" title="输入本年度个人工作量分值"></input>
                        </td>
                    </tr>
                    <tr>
