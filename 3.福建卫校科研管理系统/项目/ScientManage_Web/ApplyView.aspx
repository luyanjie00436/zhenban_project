<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyView.aspx.cs" Inherits="ScientManage_Web.ApplyView" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">年度工作量统计汇总表</div>
                </div>
            </div>
                ...
                <div style="margin-top: 10px">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgcolor">
                        <tr>
                            ...
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtUserName" runat="server" CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入姓名"></asp:TextBox>
                            </td>
                            ...
                            <td>
                                <asp:Button ID="Button3" runat="server" CssClass="btn" OnClick="Button3_Click" Text="导 出" data-toggle="tooltip" data-placement="top" ToolTip="记录导出到Excle" />
                            </td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="额定工作量" HeaderText="额定工作量">
                                <HeaderStyle  Width="7%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="上年度预留工作量" HeaderText="上年度预留工作量">
                                <HeaderStyle Width="7%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="实际完成教学建设工作量" HeaderText="实际完成教学建设工作量">
                                <HeaderStyle Width="7%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="实际完成科研工作量" HeaderText="实际完成科研工作量分">
                                <HeaderStyle Width="7%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="预留工作量" HeaderText="预留工作量">
                                <HeaderStyle Width="7%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="超工作量" HeaderText="超工作量">
                                <HeaderStyle Width="7%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                             ...
                             <asp:TemplateField   HeaderText="备注">
                                  <ItemTemplate >
                                    <div class="link02"  style="width:200px;word-break:break-all;">
                                       <asp:Label runat="server" Text='<%# Eval("备注")%>'></asp:Label>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle Width="17%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle Width="17%" HorizontalAlign="Center" />
                            </asp:TemplateField>

                            <%--  <asp:BoundField   DataField="备注" HeaderText="备注">
                                <HeaderStyle Width="16%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>--%>
                              <asp:TemplateField   HeaderText="操作">
                                  <ItemTemplate >
                                    <div class="link02">
                                        <a href='ApplyRemarksUpd.aspx?AssessValue1=<%# Eval("编号")%>&keepThis=true&TB_iframe=true&height=300&width=500' class="fLink thickbox">修改备注</a>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle Width="7%"  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
