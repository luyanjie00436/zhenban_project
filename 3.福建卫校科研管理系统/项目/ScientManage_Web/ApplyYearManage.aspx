<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyYearManage.aspx.cs" Inherits="ScientManage_Web.ApplyYearManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">申报时间信息</div>
                </div>
            </div>
            ...
            <div style="float: right; margin-right: 20px;">
                <a href="ApplyYearAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500" class="fLink thickbox" style="width: 150px; height: 50px; border: 1px solid #000; border-radius: 13px; margin-right: 20px; text-align: center; line-height: 30px; padding: 6px 15px 6px 15px;">添 加</a>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("ApplyYearId") %>'
                                            OnCommand="LinkButton1_Command" ToolTip="点击设置为成果申报年份">点击设置为申报时间</asp:LinkButton>
                                        <asp:Label ID="applyTime" runat="server" Text="当前时间为成果申报年份" Visible="False" ToolTip="显示当前时间为申报年份"></asp:Label>
                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("ApplyYearId") %>'
                                            OnCommand="LinkButton2_Command">点击设置为项目申报年份</asp:LinkButton>
                                        <asp:Label ID="LApplyProject" runat="server" Text="当前时间为项目申报年份" Visible="False"></asp:Label>
