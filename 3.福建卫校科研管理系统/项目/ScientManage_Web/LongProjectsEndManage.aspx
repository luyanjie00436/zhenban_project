<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndManage.aspx.cs" Inherits="ScientManage_Web.LongProjectsEndManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">结题管理</div>
                </div>
            </div>
            <br />
            <div class="page_main01">
                <div style="margin-top: 10px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="结题状态">
                                <ItemTemplate>
                                    <asp:Label ID="LEndStatus" runat="server" Text='<%# Eval("EndStatus") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton5" runat="server" OnCommand="LinkButton5_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点击跳转到项目结题表">结题</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                    ...
                    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" CssClass="juzhong"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="结题情况">
                                <ItemTemplate>
                                    <asp:Label ID="LEndStatus" runat="server" Text='<%# Eval("EndStatus") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton6" runat="server" OnCommand="LinkButton6_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点击跳转到项目立项审批表">查看详情</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点击跳转到项目结题">修改</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
