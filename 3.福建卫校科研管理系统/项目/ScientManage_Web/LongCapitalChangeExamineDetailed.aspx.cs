...
{
    public partial class LongCapitalChangeExamineDetailed : System.Web.UI.Page
    {
        ...
        {
            LongProjectsId = pwds.DecryptDES(Request.QueryString["LongProjectsId"], "asdfasdf");
            DataSet dy = bus.SelectByLongProjectsId("LongCapitalChangeExamine_Select", LongProjectsId);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsDeclareExamineInsert("LongCapitalChangeExamine_Insert", LongProjectsId, ExamineOpinion, UserCardId, "审批通过", RankId))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsDeclareExamineInsert("LongCapitalChangeExamine_Insert", LongProjectsId, ExamineOpinion, UserCardId, "审批未通过", RankId))
            {
                Response.Write("<script>alert('审批成功！');window.history.go(-1);</script>");
                dataGriviewBD();
            }
