    ...
    public partial class TeachingPartnerManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = bus.SelectTeachingByUserCardId("Teaching_SelectByMyUserCardId", UserCardId).Tables[0];
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.TeachingPartnerInsert("TeachingPartner_Insert", TeachingId, UserCardId, PartnerRank, PartnerValue))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.TeachingPartnerUpdate("TeachingPartner_Update", Convert.ToInt32(HttpUtility.UrlDecode(Request.Cookies["TeachingPartnerId"].Value)), UserCardId, PartnerRank, PartnerValue))
            {
