...
namespace ScientManage_Web
{
    public partial class LongProjectsEndAdd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["LongProjectsId"] != null)
                {
                   ...
                   LUserJob.Text = dt.Rows[0]["ZY_JobSeries"].ToString();
                   LUserPost.Text = dt.Rows[0]["ZY_TitleLevelName"].ToString();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsApprovalInsert("LongProjectsEnd_Update", LongProjectsId, path))
            {
