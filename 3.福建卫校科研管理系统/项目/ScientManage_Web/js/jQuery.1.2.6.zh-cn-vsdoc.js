...
jQuery.fn = jQuery.prototype = {
	...
	slice: function() {
		...
		///		分离出子集
		///	</summary>
		///	<param name="start"  integer="true">
		/// 	开始索引，从0开始
		/// </param>
		///	<param name="end" optional="true"  integer="true">
...
jQuery.extend({
	...
	inArray: function( elem, array ) {
		...
		///	<returns  integer="true">索引，从0开始</returns>
...
jQuery.each( ['Left' ], function(i, name) {
	...
	jQuery.fn[ method ] = function(val) {
		...
		///	</summary>
		///	<param name="val"  integer="true" optional="true">想要设置的数值</param>
		///	<returns  integer="true">获取的数值</returns>
		if (!this[0]) return;
...
jQuery.each([ "Height" ], function(i, name){
	...
	jQuery.fn["inner" + name] = function(){
		...
		///	</summary>
	    ///	<returns  integer="true">内部高度</returns>
	...
	jQuery.fn["outer" + name] = function(margin) {
	    ...
	    ///	<returns  integer="true">外部高度</returns>
...
jQuery.each( [ "Width" ], function(i, name) {
	...
	jQuery.fn["inner" + name] = function(){
		...
		///	</summary>
	    ///	<returns  integer="true">内部宽度</returns>
