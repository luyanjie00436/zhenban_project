...
{
    public partial class ShortCapitalPlanExamineDetailed : System.Web.UI.Page
    {
        ...
        {
            ShortProjectsId = pwds.DecryptDES(Request.QueryString["ShortProjectsId"], "asdfasdf");
            DataSet dy = bus.SelectByShortProjectsId("ShortCapitalPlanExamine_Select", ShortProjectsId);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.ShortProjectsDeclareExamineInsert("ShortCapitalPlanExamine_Insert", ShortProjectsId, ExamineOpinion, UserCardId, "审批通过", RankId))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.ShortProjectsDeclareExamineInsert("ShortCapitalPlanExamine_Insert", ShortProjectsId, ExamineOpinion, UserCardId, "审批未通过", RankId))
            {
                Response.Write("<script>alert('审批成功！');window.history.go(-1);</script>");
                dataGriviewBD();
            }
