<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsDeclareExamineDetailed.aspx.cs" Inherits="ScientManage_Web.LongProjectsDeclareExamineDetailed" %>
    ...
    <style type="text/css">
        ...
        /*.td5
        {
           width:80px;
            ...
            border-right: 1px solid #000000;
            border-top: 1px solid #000000;
            border-bottom:1px solid #000000; text-align:right;
            }*/
        table {
            width: 98%;
            margin: 0px auto;
                    ...
                    <div>
                        <table class="biaob">
                            ...
                            <tr>
                                ...
                                <td class="td5" style="text-align: left; padding-left: 20px;" colspan="3">
