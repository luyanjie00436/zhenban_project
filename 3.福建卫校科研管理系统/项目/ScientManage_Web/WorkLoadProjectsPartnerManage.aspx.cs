    ...
    public partial class WorkLoadProjectsPartnerManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = bus.SelectWorkLoadProjectsByUserCardId("WorkLoadProjects_SelectByMyUserCardId", UserCardId).Tables[0];
                DlWorkLoadProjects.Items.Clear();
        ...
        public void dataGriviewBD(int WorkLoadProjectsId)
        {
            ...
            GridView1.DataSource = bus.SelectByWorkLoadProjectsId("WorkLoadProjectsPartner_SelectByWorkLoadProjectsId", WorkLoadProjectsId).Tables[0].DefaultView;
            GridView1.DataBind();
        }
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.WorkLoadProjectsPartnerInsert("WorkLoadProjectsPartner_Insert", WorkLoadProjectsId, UserCardId, PartnerRank, PartnerValue))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.WorkLoadProjectsPartnerUpdate("WorkLoadProjectsPartner_Update", WorkLoadProjectsPartnerId, UserCardId, PartnerRank, PartnerValue))
            {
