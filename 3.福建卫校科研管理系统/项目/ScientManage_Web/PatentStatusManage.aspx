<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatentStatusManage.aspx.cs" Inherits="ScientManage_Web.PatentStatusManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">专利审批管理</div>
                </div>
            </div>
                ...
                <div style="margin-top: 10px">
                    <table border="0" cellspacing="0" cellpadding="0" class="bgcolor">
                        <tr>
                            ...
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtUserName" CssClass="select1" runat="server" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入成员姓名"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtPatentName" CssClass="select1" runat="server" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入专利名称"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>专利类别：</strong>
                            </td>
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtPatentCateGory" CssClass="select1" runat="server" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入专利类别 例如（国家级、省级......）"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                            ...
                            <td>
                                <asp:Button ID="Button3" runat="server" CssClass="btn" OnClick="Button3_Click" Text="导 出" data-toggle="tooltip" data-placement="top" ToolTip="点击导出到Excle" />
                            </td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="专利名称" HeaderText="专利名称">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="专利类别" HeaderText="专利类别">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="专利获奖级别" HeaderText="专利获奖级别">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="奖级" HeaderText="奖级">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server"
                                            OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="跳转到专利审批表">修改审批状态</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
