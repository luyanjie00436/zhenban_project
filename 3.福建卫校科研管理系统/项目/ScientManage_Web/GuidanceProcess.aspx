<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidanceProcess.aspx.cs" Inherits="ScientManage_Web.GuidanceProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">指导学生流程</div>
                </div>
            </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgcolor">
                                <tr>
                                    <td width="9%" align="right" class="auto-style1">
                                        <strong>审批部门：</strong>
                                    </td>
                                    <td width="11%" align="left" class="auto-style1">
                                    ...
                                    <td width="14%" align="left" class="auto-style1">
                            ...
                            <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("GuidanceProcessId") %>' runat="server"
