<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachingStatusManage.aspx.cs" Inherits="ScientManage_Web.TeachingStatusManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">著作审批管理</div>
                </div>
            </div>
                ...
                <div style="margin-top: 10px">
                    <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtBookName" runat="server" CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入书名"></asp:TextBox>
                            </td>
                            <td align="right" class="auto-style1">
                                <strong>出版社：</strong>
                            </td>
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtPressName" runat="server" CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入出版社"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="出版类别" HeaderText="出版类别">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="字数" HeaderText="字数">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server"
                                            OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="跳转到著作审批表">修改审批状态</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
