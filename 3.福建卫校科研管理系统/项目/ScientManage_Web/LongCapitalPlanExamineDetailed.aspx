<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalPlanExamineDetailed.aspx.cs" Inherits="ScientManage_Web.LongCapitalPlanExamineDetailed" %>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto">
                    <div>
                        ...
                        <table class="biaob">
                            ...
                            <tr>
                                <td align="right" class="td5">项目来源：</td>
                                <td class="td5">
                            ...
                            <tr>
                                ...
                                <td class="td5">
                                    ...
                                    <asp:LinkButton ForeColor="blue" Text="附件下载" runat="server" ID="LinkButton1" OnClick="LinkButton1_Click" ToolTip="点击下载预算附件"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
