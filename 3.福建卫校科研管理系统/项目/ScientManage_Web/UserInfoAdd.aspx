<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfoAdd.aspx.cs" Inherits="ScientManage_Web.UserInfoAdd" %>
            ...
            <div>
                <div class="aa">
                    <div class="parallelogram">
                        <div class="parallelogram2">用户添加</div>
                    </div>
                </div>
                        ...
                        <ContentTemplate>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="right">
                                        <asp:TextBox ID="txtUserCardId" MaxLength="15" runat="server" Enabled="True" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入用户工号"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style3">
                                ...
                                <tr>
                                    ...
                                    <td class="right">
                                        <asp:TextBox ID="txtUserName" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入用户姓名"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style3"><strong>来源信息：</strong></td>
                                    <td class="right">
                                        ...
                                        <div style="width: 600px; margin: 0 auto;">
                                            <div style="float: left; width: 300px;">
                                                <div style="float: left; width: 200px;">
                                                    <asp:ListBox ID="LBRank1" runat="server" CssClass="LB" Font-Size="15px" Height="200px" Rows="6" SelectionMode="Multiple" Width="150px" ToolTip="现有的行政隶属类别"></asp:ListBox>
                                                </div>
                                            ...
                                            <div style="float: right; width: 200px;">
                                                <asp:ListBox ID="LBRank2" runat="server" CssClass="LB" Font-Size="15px" Height="200px" Rows="6" SelectionMode="Multiple" Width="150px" ToolTip="已添加的行政隶属"></asp:ListBox>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
