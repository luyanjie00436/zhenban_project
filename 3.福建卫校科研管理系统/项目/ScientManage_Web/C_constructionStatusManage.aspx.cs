...
{
    public partial class C_constructionStatusManage : System.Web.UI.Page
    {
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("C_constructionStatusModify.aspx?C_constructionId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
