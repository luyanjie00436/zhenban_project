...
{
    public partial class TeachToTeachingStatusManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/TeachToTeachingManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        public void dataGriviewBD()
        {
            ...
            string TotalScore = txtTotalScore.Text.Trim();
            ...
            int Month;
            string TeachToTeachingYear = DLApplyYear.SelectedItem.Text;
            if (TeachToTeachingYear == "选择年份")
            {
                TeachToTeachingYear = "";
            }
            try
            ...
            DataTable dt = bus.SelectsTeachToTeaching("TeachToTeaching_Selects", UserName, DepartmentId, Year, Month, Status, Quantity, TotalScore, TeachToTeachingYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsTeachToTeaching("TeachToTeaching_Selects", UserName, DepartmentId, Year, Month, Status, Quantity, TotalScore, TeachToTeachingYear).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("TeachToTeachingStatusModify.aspx?TeachToTeachingId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("TeachToTeachingManage.aspx");
        }
