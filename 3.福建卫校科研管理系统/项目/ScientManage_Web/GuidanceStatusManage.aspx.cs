...
{
    public partial class GuidanceStatusManage : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("GuidanceStatusModify.aspx?GuidanceId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
