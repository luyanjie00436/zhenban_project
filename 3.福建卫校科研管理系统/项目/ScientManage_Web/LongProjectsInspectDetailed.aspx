<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsInspectDetailed.aspx.cs" Inherits="ScientManage_Web.LongProjectsInspectDetailed" %>
                    ...
                    <div>
                        <table class="biaob">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="LProjectsLevel"></asp:Label></td>                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:LinkButton ForeColor="blue" Text="查看详细" runat="server" ID="LinkButton3" OnClick="LinkButton3_Click" ToolTip="点击跳转到项目立项申请表"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
