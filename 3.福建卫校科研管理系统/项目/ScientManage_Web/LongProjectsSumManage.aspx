<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsSumManage.aspx.cs" Inherits="ScientManage_Web.LongProjectsSumManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">纵向项目汇总信息</div>
                </div>
            </div>
            <br />
                ...
                <div style="margin-top: 10px">
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReportDate" HeaderText="项目年份">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="InspectStatus" HeaderText="中检状态">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
