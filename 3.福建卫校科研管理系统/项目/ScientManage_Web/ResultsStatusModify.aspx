<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultsStatusModify.aspx.cs" Inherits="ScientManage_Web.ResultsStatusModify" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">教学成果获奖审批表</div>
                </div>
            </div>
                        ...
                        <table class="biaob">
                            ...
                            <tr>
                                ...
                                <td class="td5" align="center">
                                    <asp:Label ID="LResultsName" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LCategory" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LAwardlevel" runat="server"></asp:Label>
                                </td>
                                <td class="td4">
                                    <asp:Label ID="LResultsPrincipal" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LAwarding_unit" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                            ...
                            <tr>
                                ...
                                <td class="td5" align="center">
                                    <asp:Label ID="LResultsTotal" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LResultsDescription" runat="server"></asp:Label>
                                </td>
                                <td class="td5" colspan="2" align="center">
                                    <asp:Label ID="LResultsValue" runat="server"></asp:Label>
                                </td>
