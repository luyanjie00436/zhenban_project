<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseRemunerationManage.aspx.cs" Inherits="ScientManage_Web.UseRemunerationManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">行政职级管理</div>
                </div>
            </div>
            <br />
            ...
            <div class="page_main01">
                <div style="margin-top: 10px">
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="UseRemunerationId" HeaderText="编号">
                            ...
                            <asp:BoundField DataField="Remuneration" HeaderText="行政职级">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="StartDate" HeaderText="获得时间">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
