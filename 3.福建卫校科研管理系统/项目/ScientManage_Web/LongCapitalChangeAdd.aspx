<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalChangeAdd.aspx.cs" Inherits="ScientManage_Web.LongCapitalChangeAdd" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">经费预算变更</div>
                </div>
            </div>
            <div class="page_main01">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="right" class="auto-style5">
                            <strong>上传变更文件：</strong>
                        </td>
                        <td width="30%" align="left" colspan="2">
                            <asp:FileUpload ID="fupFileSend" runat="server" CssClass="input6" Width="203px" ToolTip="点击选择要上传的变更文件" />
                            <asp:LinkButton runat="server" ID="LinkButton2" ForeColor="blue" Text="下载附件" OnClick="LinkButton2_Click" data-toggle="tooltip" data-placement="top" ToolTip="点击下载变更附件"></asp:LinkButton>
