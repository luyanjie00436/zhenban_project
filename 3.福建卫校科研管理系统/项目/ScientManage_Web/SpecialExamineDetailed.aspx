<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialExamineDetailed.aspx.cs" Inherits="ScientManage_Web.SpecialExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">专项分值审批表</div>
                </div>
            </div>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto; margin-top: 5px;">
                    ...
                    <div>
                       <table class="biaob">
                            <tr>
                                <td class="td1">姓名</td>
                                <td class="auto-style1" colspan="2">内容</td>
                            </tr>
                            <tr>
                                <td class="td2">
                                ...
                                <td class="auto-style1" align="center" colspan="2">
                                    <asp:Label ID="LContentName" runat="server"></asp:Label>
                                </td>
