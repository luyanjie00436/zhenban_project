<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="T_AssessYear.aspx.cs" Inherits="ScientManage_Web.T_AssessYear" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">教研工作量核算</div>
                </div>
            </div>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" PageSize="10" Width="100%">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NowValue" HeaderText="已完成分值">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="AssessResult" HeaderText="考核等级">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <a href='T_AssessValueReserve.aspx?AssessValue=<%# Eval("AssessValueId")%>&keepThis=true&TB_iframe=true&height=300&width=500' class="fLink thickbox">
                                                    <asp:Label ID="A7" runat="server">修改预留</asp:Label></a>
                                                <asp:LinkButton ID="LinkButton8" runat="server" CommandArgument='<%# Eval("ApplyYearId") %>' OnCommand="LinkButton8_Command" ToolTip="查看本季度或本年度教师工作量信息">查看详细</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
