...
{
    public partial class P_constructionStatusManage : System.Web.UI.Page
    {
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("P_constructionStatusModify.aspx?P_constructionId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
