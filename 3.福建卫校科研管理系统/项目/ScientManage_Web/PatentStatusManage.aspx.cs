...
{
    public partial class PatentStatusManage : System.Web.UI.Page
    {
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("PatentStatusModify.aspx?PatentId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
