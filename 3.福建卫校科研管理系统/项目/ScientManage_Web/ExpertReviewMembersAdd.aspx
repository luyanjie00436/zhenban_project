<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpertReviewMembersAdd.aspx.cs" Inherits="ScientManage_Web.ExpertReviewMembersAdd" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr class="tr10">
                                ...
                                <td width="70%" height="80" align="left" valign="middle" style="background: none;">
                                    <asp:Button ID="Button1" runat="server" Text="添 加" OnClick="Button1_Click" CssClass="btn" data-toggle="tooltip" data-placement="top" ToolTip="点击添加" />&nbsp;
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
