<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachToTeachingExamineDetailed.aspx.cs" Inherits="ScientManage_Web.TeachToTeachingExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">教学工作量转化教研分审批表</div>
                </div>
            </div>
