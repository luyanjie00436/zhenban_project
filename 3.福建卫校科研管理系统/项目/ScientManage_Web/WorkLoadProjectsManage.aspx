<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLoadProjectsManage.aspx.cs" Inherits="ScientManage_Web.WorkLoadProjectsManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">科研项目添加记录</div>
                </div>
            </div>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server"
                                            OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="跳转到项目申请表">查看详情</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
