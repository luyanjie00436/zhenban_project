...
{
    public partial class C_winnersStatusModify : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.C_winnersStatusModifyInsert("C_winnersStatusModify_Insert", C_winnersId, ExamineOpinion, UserCardId, "同意"))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.C_winnersStatusModifyInsert("C_winnersStatusModify_Insert", C_winnersId, ExamineOpinion, UserCardId, "拒绝"))
            {
                AlertMsgAndNoFlush("审批成功");
                dataGriviewBD();
            }
