...
{
    public partial class TeachingManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/TeachingManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
     ...
     * */
        public DataTable SelectBD()
        {
            ...
            string PressName = txtPressName.Text.Trim();
            ...
            return bus.SelectsTeaching("Teaching_Selects", UserName, DepartmentId, Year, Month, Status, BookName, PressName, WinningYear).Tables[0];
        ...
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectsTeaching("Teaching_Selects", UserName, DepartmentId, Year, Month, Status, BookName, PressName, WinningYear).Tables[0];
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("TeachingDetailed.aspx?TeachingId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("TeachingManage.aspx");
        }
