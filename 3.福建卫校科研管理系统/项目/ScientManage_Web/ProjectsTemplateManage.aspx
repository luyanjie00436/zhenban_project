<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectsTemplateManage.aspx.cs" Inherits="ScientManage_Web.ProjectsTemplateManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">项目模板管理</div>
                </div>
            </div>
            <br />
            <div style="float: right; margin-right: 20px;">
                <a href="ProjectsTemplateAdd.aspx?keepThis=true&TB_iframe=true&height=300&width=500" class="fLink thickbox" style="width: 150px; height: 50px; border: 1px solid #000; border-radius: 13px; margin-right: 20px; text-align: center; line-height: 30px; padding: 6px 15px 6px 15px;">添 加</a>
            ...
            <div class="page_main01">
                <div style="margin-top: 10px">
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="TemplateId" HeaderText="编号">
                            ...
                            <asp:BoundField DataField="TemplateName" HeaderText="名称">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton8" CommandArgument='<%# Eval("FileUrl") %>' runat="server"
                                            OnCommand="LinkButton8_Command">下载附件</asp:LinkButton>

                                        <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("TemplateId") %>' runat="server"
