...
{
    public partial class PatentStatusModify : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.PatentStatusModifyInsert("PatentStatusModify_Insert", PatentId, ExamineOpinion, UserCardId, "同意"))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.PatentStatusModifyInsert("PatentStatusModify_Insert", PatentId, ExamineOpinion, UserCardId, "拒绝"))
            {
                AlertMsgAndNoFlush("审批成功");
                dataGriviewBD();
            }
