<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyPaperManage.aspx.cs" Inherits="ScientManage_Web.MyPaperManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">个人论文添加记录</div>
                </div>
            </div>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PaperName" HeaderText="期刊名称及刊号">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PaperLevel" HeaderText="期刊级别">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PaperYears" HeaderText="年月、期">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("PaperId") %>' ToolTip="点击跳转到个人论文申请详细表">查看详情</asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("PaperId") %>' ToolTip="跳转到论文申请表">修改</asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("PaperId") %>' runat="server"
