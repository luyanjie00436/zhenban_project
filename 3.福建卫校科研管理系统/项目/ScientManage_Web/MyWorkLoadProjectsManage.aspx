<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyWorkLoadProjectsManage.aspx.cs" Inherits="ScientManage_Web.MyWorkLoadProjectsManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">个人项目添加记录</div>
                </div>
            </div>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="WorkLoadProjectsName" HeaderText="工作量项目名称">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="SumProjectsValue" HeaderText="项目总分值">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ProjectsValue" HeaderText="本年度可分配工作量分值">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PartnerRank" HeaderText="分配排名">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("WorkLoadProjectsId") %>' ToolTip="点击跳转到科研项目申请详细表">查看详情</asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("WorkLoadProjectsId") %>' ToolTip="点击跳转到科研项目申报表">修改</asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("WorkLoadProjectsId") %>' runat="server"
