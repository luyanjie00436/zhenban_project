...
{
    public partial class P_constructionManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/P_constructionManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
                ...
                else
                {
                    ...
                    {
                        ListItem li = new ListItem(dt.Rows[i]["DepartmentName"].ToString(), dt.Rows[i]["DepartmentId"].ToString());
                        DlDepartment.Items.Add(li);
                    }
                }
       ...
       /* public void ExportToExcel(System.Web.UI.Page page, GridView excel, string fileName)
        ...
        public void dataGriviewBD()
        {
            ...
            int Month;
            string P_constructionYear = DLApplyYear.SelectedItem.Text;
            if (P_constructionYear == "选择年份")
            {
                P_constructionYear = "";
            }
            try
            ...
            DataTable dt = bus.SelectsP_construction("P_construction_Selects", UserName, DepartmentId, Year, Month, Status, P_constructionName, Leve, P_constructionYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsP_construction("P_construction_Selects", UserName, DepartmentId, Year, Month, Status, P_constructionName, Leve, P_constructionYear).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("P_constructionDetailed.aspx?P_constructionId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("P_constructionManage.aspx");
        }
        //合并单元格
