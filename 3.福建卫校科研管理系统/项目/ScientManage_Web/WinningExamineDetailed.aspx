<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinningExamineDetailed.aspx.cs" Inherits="ScientManage_Web.WinningExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">获奖项目审批表</div>
                </div>
            </div>
            <div class="page_main01">
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto; margin-top: 5px;">
                    <div>
                        <table
                            class="biaoa" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                    ...
                    <div>
                        <table
                            ...
                            <tr>
                                ...
                                <td class="td5" align="center">
                                    <asp:Label ID="LWinningName" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LWinningCategory" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LWinningLevel" runat="server"></asp:Label>
                                </td>
                                <td class="td4" style="word-break: break-all; width: 100px;">
                                    <asp:Label ID="LRemarks" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LWinningValue" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
