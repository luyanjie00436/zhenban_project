<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsStandExamineDetailed.aspx.cs" Inherits="ScientManage_Web.LongProjectsStandExamineDetailed" %>
                    ...
                    <div>
                        <table class="biaob">
                            ...
                            <tr>
                                ...
                                <td class="td5" align="right">评审人数：</td>
                                <td class="td5">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="LSumBranch"></asp:Label>
                                </td>
                                <td align="right">平均分：</td>
                                <td>
                                    <asp:Label runat="server" ID="LAvgBranch"></asp:Label></td>
                            </tr>
                        </table>
                        ...
                        <table class="biaoe" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td colspan="6">
                                    <asp:TextBox ID="txtExamineOpinion" runat="server" Columns="1" CssClass="input1" Height="80" MaxLength="400" Rows="5" TextMode="MultiLine" Width="98%" data-toggle="tooltip" data-placement="top" ToolTip="输入审批意见"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td height="28">
