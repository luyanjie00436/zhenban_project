<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsEndAdd.aspx.cs" Inherits="ScientManage_Web.LongProjectsEndAdd" %>
            ...
            <div class="page_main01">
                ...
                <table cellspacing="0" cellpadding="0" style="width: 800px; margin: 0 auto; border: 0px; background: #d4d2d2;">
                    ...
                    <tr>
                        ...
                        <td width="30%" align="left" colspan="2">
                            <asp:FileUpload ID="fupFileSend" runat="server" CssClass="input6" Width="203px" data-toggle="tooltip" data-placement="top" ToolTip="点击选择上传结题文件" />
                        </td>
                        <td>&nbsp;</td>
                        <td colspan="2">
                            <asp:LinkButton runat="server" ID="LinkButton2" ForeColor="blue" Text="下载附件" OnClick="LinkButton2_Click" ToolTip="点击下载附件"></asp:LinkButton>
