<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalCloseExamineManage.aspx.cs" Inherits="ScientManage_Web.LongCapitalCloseExamineManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">资金决算审批</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点金跳转到审批页面">审批</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
