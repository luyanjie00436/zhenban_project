<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalCloseProcess.aspx.cs" Inherits="ScientManage_Web.ShortCapitalCloseProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">资金决算流程</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" Width="100%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("ShortCapitalCloseProcessId") %>' runat="server"
