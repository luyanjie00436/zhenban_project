<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalCloseManage.aspx.cs" Inherits="ScientManage_Web.LongCapitalCloseManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">经费决算管理</div>
                </div>
            </div>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                ...
                                                <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点击跳转到经费决算页面">决算</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
