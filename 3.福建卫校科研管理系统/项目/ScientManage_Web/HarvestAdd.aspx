<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestAdd.aspx.cs" Inherits="ScientManage_Web.HarvestAdd" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">成果添加</div>
                </div>
            </div>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="12%" align="left">
                            <asp:TextBox ID="txtApplyYear" runat="server" CssClass="input1" ReadOnly="True" data-toggle="tooltip" data-placement="top" ToolTip="请输入年份"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="12%">
                            <asp:TextBox ID="txtHarvestName" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入成果名称"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="12%"><strong>鉴定水平:</strong> </td>
                        <td align="left" width="12%">
                            <asp:TextBox ID="txtAppraisalLevel" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入鉴定水平"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="12%"><strong>鉴定单位:</strong> </td>
                        <td align="left" width="12%">
                            <asp:TextBox ID="txtAppraisalCompany" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入鉴定单位"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="12%">
                            <input id="txtHarvestValue" type="" runat="server" class="input1" onblur="javascript:yzszfw1(this,0,99999999);" data-toggle="tooltip" data-placement="top" title="输入成果分值应为正数  例如（0.1,1.1,1.5.....）"></input>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="12%"><strong>本人排名:</strong> </td>
                        <td align="left" width="12%">
                            <input id="txtPartnerRank" type="" runat="server" class="input1" onblur="javascript:yzszfw1(this,0,100);" data-toggle="tooltip" data-placement="top" title="本人排名应为正数 例如（1,2,3......）"></input>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="12%"><strong>本人得分:</strong> </td>
                        <td align="left" width="12%">
                            <input id="txtPartnerValue" type="" runat="server" onblur="javascript:yzszfw1(this,0,99999999);" class="input1" data-toggle="tooltip" data-placement="top" title="本人得分应为正数  例如（0.1,1.1,1.5.....）"></input>
                        </td>
                    </tr>
                    <tr>
                        <td width="12%" align="right">
