...
{
    public partial class ResultsStatusManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/ResultsManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        public void dataGriviewBD()
        {
            ...
            string Awardlevel = txtAwardlevel.Text.Trim();
            ...
            int Month;
            string ResultsYear = DLApplyYear.SelectedItem.Text;
            if (ResultsYear == "选择年份")
            {
                ResultsYear = "";
            }
            ...
            DataTable dt = bus.SelectsResults("Results_Selects", UserName, DepartmentId, Year, Month, Status, ResultsName, Awardlevel, ResultsYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsResults("Results_Selects", UserName, DepartmentId, Year, Month, Status, ResultsName, Awardlevel, ResultsYear).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("ResultsStatusModify.aspx?ResultsId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("ResultsManage.aspx");
        }
        //合并单元格
