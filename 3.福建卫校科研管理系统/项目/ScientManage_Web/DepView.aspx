<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepView.aspx.cs" Inherits="ScientManage_Web.DepView" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">成员申报信息</div>
                </div>
            </div>
                ...
                <div style="margin-top: 10px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="去年预留分值" HeaderText="去年预留分值">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="已完成科研分" HeaderText="已完成科研分">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="已完成教研分" HeaderText="已完成教研分">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="今年预留分值" HeaderText="今年预留分值">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server"
                                            OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="查看年度工作量核算表">科研详细</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("编号") %>' OnCommand="LinkButton9_Command" ToolTip="查看本季度或本年度教师工作量信息">教研详细</asp:LinkButton>
