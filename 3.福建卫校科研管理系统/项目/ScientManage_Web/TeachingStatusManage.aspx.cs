...
{
    public partial class TeachingStatusManage : System.Web.UI.Page
    {
        ...
        * **/
        ...
        {
            Response.Redirect("TeachingStatusModify.aspx?TeachingId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
