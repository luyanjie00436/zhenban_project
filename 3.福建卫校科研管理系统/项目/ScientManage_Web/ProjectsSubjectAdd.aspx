<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectsSubjectAdd.aspx.cs" Inherits="ScientManage_Web.ProjectsSubjectAdd" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="70%" align="left">
                                    <asp:TextBox ID="txtProjectsSubjectExplain" CssClass="input6" data-toggle="tooltip" data-placement="top" ToolTip="请输入项目类别" runat="server" Height="27px" Width="137px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="tr10">
