<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_constructionStatusModify.aspx.cs" Inherits="ScientManage_Web.C_constructionStatusModify" %>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto; margin-top: 5px;">
                    <div>
                        <table class="biaoa" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td style="border-bottom: none;" class="td3" colspan="6">详细列表</td>
                            </tr>
                        </table>
                    </div>
                    <div>
