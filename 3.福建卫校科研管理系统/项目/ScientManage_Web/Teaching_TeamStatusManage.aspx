<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teaching_TeamStatusManage.aspx.cs" Inherits="ScientManage_Web.Teaching_TeamStatusManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">专业建设审批管理</div>
                </div>
            </div>
                ...
                <div style="margin-top: 10px">
                    ...
                    <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtTeaching_TeamName" CssClass="select1" runat="server" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入项目名称"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>级别：</strong>
                            </td>
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtLeve" runat="server" CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入级别 例如（国家级、省级、院级）"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server"
                                            OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="点击跳转到教学团队建设审批表">修改审批状态</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
