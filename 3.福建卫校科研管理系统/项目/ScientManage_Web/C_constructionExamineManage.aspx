<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_constructionExamineManage.aspx.cs" Inherits="ScientManage_Web.C_constructionExamineManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">课程建设审批</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("C_constructionId") %>' ToolTip="跳转到课程建设审批表">审批</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
