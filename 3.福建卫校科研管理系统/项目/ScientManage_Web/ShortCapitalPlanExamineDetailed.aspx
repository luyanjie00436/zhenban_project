<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalPlanExamineDetailed.aspx.cs" Inherits="ScientManage_Web.ShortCapitalPlanExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">项目经费预算审批表</div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <table class="biaoe" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td colspan="6">
                                    <asp:TextBox ID="txtExamineOpinion" data-toggle="tooltip" data-placement="top" ToolTip="请输入审批意见" runat="server" Columns="1" CssClass="input1" Height="80" MaxLength="400" Rows="5" TextMode="MultiLine" Width="98%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td height="28">
                                    <div class="page_title_txt">
                                        <asp:Button ID="Button1" runat="server" Text="同 意" data-toggle="tooltip" data-placement="top" ToolTip="点击同意" OnClick="Button1_Click" CssClass="btn" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
