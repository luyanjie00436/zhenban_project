<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalPlaceSituation.aspx.cs" Inherits="ScientManage_Web.ShortCapitalPlaceSituation" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">资金到位信息表</div>
                </div>
            </div>
