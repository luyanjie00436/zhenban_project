...
{
    public partial class Teaching_TeamStatusManage : System.Web.UI.Page
    {
     ...
     /*   public void ExportToExcel(System.Web.UI.Page page, GridView excel, string fileName)
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("Teaching_TeamStatusModify.aspx?Teaching_TeamId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
