<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_constructionManage.aspx.cs" Inherits="ScientManage_Web.C_constructionManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">课程建设记录</div>
                </div>
            </div>
            <div class="page_main01">
                <div style="margin-top: 10px">
                    <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtC_constructionName" CssClass="select1" runat="server" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入书名"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>级别：</strong>
                            </td>
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtLeve" runat="server" CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入出版类别 例如（国家级、省级......）"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="本年度项目总分值" HeaderText="本年度项目总分值">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                                ...
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server"
                                            OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="点击跳转到课程建设申请表">查看详情</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
