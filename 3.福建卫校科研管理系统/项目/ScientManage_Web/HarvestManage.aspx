<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestManage.aspx.cs" Inherits="ScientManage_Web.HarvestManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">成果申请记录</div>
                </div>
            </div>
                ...
                <div style="margin-top: 10px">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgcolor">
                        ...
                        <tr>
                            ...
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtHarvestName" runat="server" CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入成果名称"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>鉴定单位：</strong>
                            </td>
                            <td width="10%" align="left">
                                <asp:TextBox ID="txtCompany" runat="server" CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入鉴定单位"></asp:TextBox>
                            </td>
                            <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                            ...
                            <td>
                                <asp:Button ID="Button3" runat="server" CssClass="btn" OnClick="Button3_Click" Text="导 出" data-toggle="tooltip" data-placement="top" ToolTip="数据导出到Excel" />
                            </td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="成果名称" HeaderText="成果名称">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="鉴定单位" HeaderText="鉴定单位">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="鉴定水平" HeaderText="鉴定水平">
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <div class="link02">
                                        <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="跳转到成果项目申请表">查看详情</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
