<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobUpd.aspx.cs" Inherits="ScientManage_Web.JobUpd" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="70%" align="left">
                                    <asp:TextBox ID="txtJobName" runat="server" CssClass="input6" Height="27px" Width="145px" data-toggle="tooltip" data-placement="top" ToolTip="输入职称名称"></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="tr10">
