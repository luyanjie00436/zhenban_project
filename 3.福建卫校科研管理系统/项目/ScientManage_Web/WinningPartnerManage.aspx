<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinningPartnerManage.aspx.cs" Inherits="ScientManage_Web.WinningPartnerManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">获奖项目合作者信息</div>
                </div>
            </div>
                    ...
                    <ContentTemplate>
                        <div style="margin-bottom: 10px">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="right" class="auto-style2">请选择您申报的获奖项目:
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DlWinning" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Partner_SelectedIndexChanged"
                                            CssClass="select1" data-toggle="tooltip" data-placement="top" ToolTip="选择您申报的获奖项目">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" class="auto-style2">合作者工号:
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtUserCardId" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入合作者工号 例如（119999）"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" class="auto-style2">合作者姓名:
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="right" class="auto-style2">排名:
                                    </td>
                                    <td>
                                        <input id="txtPartnerRank" runat="server" type="" class="input1" onblur="javascript:yzszfw1(this,0,100);" data-toggle="tooltip" data-placement="top" title="输入本人排名 例如（1、2、3......）"></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" class="auto-style2">分配分值:
                                    </td>
                                    <td>
                                        <input id="txtPartnerValue" runat="server" type="" class="input1" onblur="javascript:yzszfw1(this,0,99999999);" data-toggle="tooltip" data-placement="top" title="输入分配分值 例如（1、2、3......）"></input>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <asp:Panel ID="Panel2" runat="server">
                            ...
                            <div style="margin: 5px 0px 0px 0px; text-align: center;">
                                <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" ShowHeaderWhenEmpty="True" CssClass="juzhong" AutoGenerateColumns="False" Width="98%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="操作">
                                            <ItemTemplate>
                                                <div class="link02">
                                                    <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("WinningPartnerId") %>'
                                                        OnCommand="LinkButton6_Command" ToolTip="点击进行修改">编辑</asp:LinkButton>
                                                    <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("WinningPartnerId") %>'
