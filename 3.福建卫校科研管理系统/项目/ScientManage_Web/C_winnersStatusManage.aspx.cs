...
{
    public partial class C_winnersStatusManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/C_winnersManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        public void dataGriviewBD()
        {
            ...
            int Month;
            string C_winnersYear = DLApplyYear.SelectedItem.Text;
            if (C_winnersYear == "选择年份")
            {
                C_winnersYear = "";
            }
            try
            ...
            DataTable dt = bus.SelectsC_winners("C_winners_Selects", UserName, DepartmentId, Year, Month, Status, C_winnersName, Leve, C_winnersYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsC_winners("C_winners_Selects", UserName, DepartmentId, Year, Month, Status, C_winnersName, Leve, C_winnersYear).Tables[0];
        }
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("C_winnersStatusModify.aspx?C_winnersId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("C_winnersManage.aspx");
        }
