<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultsExamineManage.aspx.cs" Inherits="ScientManage_Web.ResultsExamineManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">教学成果获奖审批</div>
                </div>
            </div>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Awardlevel" HeaderText="奖级">
                                        <HeaderStyle Width="11%" CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("ResultsId") %>' ToolTip="跳转到教学成果获奖审批表">审批</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
