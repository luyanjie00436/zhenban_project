<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalPlaceDetailed.aspx.cs" Inherits="ScientManage_Web.LongCapitalPlaceDetailed" %>
                    ...
                    <ContentTemplate>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSumMoney" runat="server" Enabled="false" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="资金到位总金额"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
