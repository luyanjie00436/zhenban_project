<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestExamineDetailed.aspx.cs" Inherits="ScientManage_Web.HarvestExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">成果项目审批表</div>
                </div>
            </div>
                    ...
                    <div>
                        <table class="biaob">
                            <tr>
                                ...
                                <td class="td5">成果名称</td>
                                <td class="td5">鉴定水平</td>
                                <td class="td5">鉴定单位</td>
                                <td class="td5">备注</td>
                            ...
                            <tr>
                                ...
                                <td class="td5" align="center">
                                    <asp:Label ID="LHarvestName" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LAppraisalLevel" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LAppraisalCompany" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center" style="word-break: break-all; width: 100px;">
                                    <asp:Label ID="LRemarks" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LHarvestValue" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                            ...
                            <tr>
                                ...
                                <td class="td4" colspan="5" style="width: 730px; text-align: left; padding-left: 20px;">
                        ...
                        <table class="biaoe" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtExamineOpinion" runat="server" Columns="1" CssClass="input1" Height="80" MaxLength="400" Rows="5" TextMode="MultiLine" Width="98%" ToolTip="审批人填写意见"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td height="28">
