<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLoadProjectsPartnerManage.aspx.cs" Inherits="ScientManage_Web.WorkLoadProjectsPartnerManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">科研项目合作者信息</div>
                </div>
            </div>
                    ...
                    <ContentTemplate>
                        <div style="margin-bottom: 10px">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="right" class="auto-style1">请选择您申报的科研项目:
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DlWorkLoadProjects" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Partner_SelectedIndexChanged"
                                            CssClass="select1" data-toggle="tooltip" data-placement="top" ToolTip="请选择您申报的科研项目">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
