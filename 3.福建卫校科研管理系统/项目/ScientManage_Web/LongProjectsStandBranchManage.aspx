<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsStandBranchManage.aspx.cs" Inherits="ScientManage_Web.LongProjectsStandBranchManage" %>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" BackColor=" #d4d2d2" CssClass="juzhong" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点击跳转到项目立项评审表">评审</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
