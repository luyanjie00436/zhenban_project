<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyShortProjectsApprovalManage.aspx.cs" Inherits="ScientManage_Web.MyShortProjectsApprovalManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">个人项目立项表</div>
                </div>
            </div>
            ...
            <div style="float: right; margin-right: 20px;">
                <asp:LinkButton ID="LinkButton3" runat="server" data-toggle="tooltip" data-placement="top" ToolTip="点击添加" CssClass="btn_right" OnClick="LinkButton3_Click">添 加</asp:LinkButton>
                <asp:LinkButton ID="LinkButton9" runat="server" data-toggle="tooltip" data-placement="top" ToolTip="点击重新刷新页面" CssClass="btn_right" OnClick="LinkButton9_Click">刷 新</asp:LinkButton>
            </div>
            <br />
