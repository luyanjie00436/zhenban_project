...
{
    public partial class Teaching__TeamProcess : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/Teaching_TeamProcess.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.Teaching_TeamProcessInsert("Teaching_TeamProcess_Insert", RankId, ProcessOrder, DepartmentName, UserCardId))
            {
        ...
        public void dataGriviewBD()
        {
            ...
            GridView1.DataSource = bus.Select("Teaching_TeamProcessProcess_Select").Tables[0].DefaultView;
            GridView1.DataBind();
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("Teaching_TeamProcess.aspx");
        }
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {

            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            if (bus.Teaching_TeamProcessDelete("Teaching_TeamProcess_Delete", Convert.ToInt32(e.CommandArgument.ToString()), UserCardId))
            {
