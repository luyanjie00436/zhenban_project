...
{
    public partial class SpecialStatusModify : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.SpecialStatusModifyInsert("SpecialStatusModify_Insert", SpecialId, ExamineOpinion, UserCardId, "同意"))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.SpecialStatusModifyInsert("SpecialStatusModify_Insert", SpecialId, ExamineOpinion, UserCardId, "拒绝"))
            {
                AlertMsgAndNoFlush("审批成功");
                dataGriviewBD();
            }
