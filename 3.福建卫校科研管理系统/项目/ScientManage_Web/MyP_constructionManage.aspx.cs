...
{
    public partial class MyP_constructionManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/MyP_constructionManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        {
            UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            GridView1.DataSource = bus.SelectByUserCardId("P_construction_SelectByPartnerUser", UserCardId).Tables[0].DefaultView;
            GridView1.DataBind();
        ...
        protected void LinkButton8_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("P_constructionAdd.aspx?P_constructionId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        ...
        protected void LinkButton9_Command(object sender, CommandEventArgs e)
        {
            ...
            if (bus.P_constructionDelete("P_construction_Delete", Convert.ToInt32(e.CommandArgument.ToString())))
            {
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("MyP_constructionManage.aspx");
        }
    }
}