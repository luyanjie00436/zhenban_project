<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_constructionAdd.aspx.cs" Inherits="ScientManage_Web.C_constructionAdd" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">课程建设添加</div>
                </div>
            </div>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td width="12%" align="left">
                            <asp:DropDownList ID="DlDepartmentId" runat="server" CssClass="input1" ReadOnly="True" data-toggle="tooltip" data-placement="top" ToolTip="选择所在院系">
                    ...
                    <tr>
                        ...
                        <td align="left" width="12%">
                            <asp:TextBox ID="txtC_constructionName" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入项目的名称"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left" width="12%">
                            <input id="txtTotal_Project" runat="server" class="input1" onblur="javascript:yzszfw1(this,0,99999999);" data-toggle="tooltip" data-placement="top" title="请输入项目总分值"></input>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="12%">
                            <input id="txtC_constructionValue" runat="server" class="input1" type="" onblur="javascript:yzszfw1(this,0,99999999);" data-toggle="tooltip" data-placement="top" title="本年度个人工作量分值"></input>
                        </td>
                    </tr>
                    <tr>
