<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_constructionExamineDetailed.aspx.cs" Inherits="ScientManage_Web.C_constructionExamineDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">课程建设审批表</div>
                </div>
            </div>
                    ...
                    <div>
                        <table class="biaob">
                            <tr>
                                ...
                                <td class="td5" align="center">项目名称</td>
                                <td class="td5" align="center">级别</td>
                                <td class="td5" align="center">负责人</td>
                                <td class="td5" align="center">完成情况</td>
                                <td class="td5" align="center">起止时间</td>
                                <td class="td5" align="center">项目总分值</td>
                            </tr>
                            <tr>
                                <td class="td2">
