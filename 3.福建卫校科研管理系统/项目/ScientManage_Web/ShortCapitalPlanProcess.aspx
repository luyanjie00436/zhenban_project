<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalPlanProcess.aspx.cs" Inherits="ScientManage_Web.ShortCapitalPlanProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">资金预算流程</div>
                </div>
            </div>
                            ...
                            <table class="bgcolor" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="11%" align="left">
                                        <asp:DropDownList ID="DlDepartment" runat="server" data-toggle="tooltip" data-placement="top" ToolTip="请选择审批系部" CssClass="select1" Width="80%">
                                    ...
                                    <td width="11%" align="left">
                                        <asp:DropDownList ID="DlProcessOrder" data-toggle="tooltip" data-placement="top" ToolTip="请选择审批顺序" runat="server" CssClass="select1" Width="80%">
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("ShortCapitalPlanProcessId") %>' runat="server"
