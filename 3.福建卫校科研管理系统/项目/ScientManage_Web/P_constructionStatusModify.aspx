<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="P_constructionStatusModify.aspx.cs" Inherits="ScientManage_Web.P_constructionStatusModify" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">专业建设审批表</div>
                </div>
            </div>
                        ...
                        <table class="biaob">
                            ...
                            <tr>
                                ...
                                <td class="td5" align="center">
                                    <asp:Label ID="LP_constructionName" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
