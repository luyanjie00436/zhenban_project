...
{
    public partial class GuidanceManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/GuidanceManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        * */
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectsGuidance("Guidance_Selects", UserName, DepartmentId, Year, Month, Status, GuidanceName, GuidanceLevel, WinningYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsGuidance("Guidance_Selects", UserName, DepartmentId, Year, Month, Status, GuidanceName, GuidanceLevel, WinningYear).Tables[0];
