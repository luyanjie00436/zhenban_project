...
{
    public partial class PaperStatusManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/PaperManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectsPaper("Paper_Selects", UserName, DepartmentId, Year, Month, Status, PaperSubject, PaperName, WinningYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
           ...
           return bus.SelectsPaper("Paper_Selects", UserName, DepartmentId, Year, Month, Status, PaperSubject, PaperName, WinningYear).Tables[0];
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("PaperStatusModify.aspx?PaperId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
