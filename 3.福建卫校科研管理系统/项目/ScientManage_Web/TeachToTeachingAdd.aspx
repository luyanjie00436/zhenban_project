<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachToTeachingAdd.aspx.cs" Inherits="ScientManage_Web.TeachToTeachingAdd" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">教学工作量转化教研分添加</div>
                </div>
            </div>
            <div class="page_main01">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="right" width="12%"><strong>转分课程数 :</strong> </td>
                        <td align="left" width="12%">
                            <asp:TextBox ID="txtQuantity" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" ToolTip="输入转分课程数"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="12%"><strong>转分总分:</strong> </td>
                        <td align="left" width="12%">
                            <asp:TextBox ID="txtTotalScore" runat="server" CssClass="input1" data-toggle="tooltip" data-placement="top" type="" onblur="javascript:yzszfw1(this,0,99999999);" ToolTip="输入转分总分"></asp:TextBox>
                        </td>
                    </tr>
