<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalCloseAdd.aspx.cs" Inherits="ScientManage_Web.ShortCapitalCloseAdd" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">经费决算</div>
                </div>
            </div>
            <div class="page_main01">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="right" class="auto-style5">
                            <strong>上传决算文件：</strong>
                        </td>
                        <td align="left" colspan="2">
                            <asp:FileUpload ID="fupFileSend" runat="server" CssClass="input6" Width="203px" />

                            <asp:LinkButton runat="server" ID="LinkButton2" ForeColor="blue" data-toggle="tooltip" data-placement="top" Text="下载附件" OnClick="LinkButton2_Click"></asp:LinkButton>

                            <asp:Label runat="server" ID="LFileUrl" Visible="false"></asp:Label>
                        </td>
                    </tr>
                    <tr class="tr10">
                        <td align="right" style="background: none;" class="auto-style5"></td>
