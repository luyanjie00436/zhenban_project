...
namespace ScientManage_Web
{
    public partial class PatentManage : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectsPatent("Patent_Selects", UserName, DepartmentId, Year, Month, Status, PatentName, PatentCateGory, WinningYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsPatent("Patent_Selects", UserName, DepartmentId, Year, Month, Status, PatentName, PatentCateGory, WinningYear).Tables[0];
        }
