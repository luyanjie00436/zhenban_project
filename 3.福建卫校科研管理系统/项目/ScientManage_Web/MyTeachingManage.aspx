<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyTeachingManage.aspx.cs" Inherits="ScientManage_Web.MyTeachingManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">个人著作添加记录</div>
                </div>
            </div>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="BookName" HeaderText="著作名称">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PressCategory" HeaderText="出版类别">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="PressDate" HeaderText="出版时间">
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("TeachingId") %>' ToolTip="点击跳转到著作申请详细表">查看详情</asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton8" runat="server" OnCommand="LinkButton8_Command" CommandArgument='<%# Eval("TeachingId") %>' ToolTip="点击跳转到著作申请表">修改</asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("TeachingId") %>' runat="server"
