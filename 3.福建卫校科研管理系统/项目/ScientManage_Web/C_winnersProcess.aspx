<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_winnersProcess.aspx.cs" Inherits="ScientManage_Web.C_winnersProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">竞赛获奖流程</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("C_winnersProcessId") %>' runat="server"
