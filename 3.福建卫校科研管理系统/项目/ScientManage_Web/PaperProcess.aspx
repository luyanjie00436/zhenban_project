<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperProcess.aspx.cs" Inherits="ScientManage_Web.PaperProcess" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">论文审批流程</div>
                </div>
            </div>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" class="bgcolor">
                                <tr>
                                    ...
                                    <td width="11%" align="left">
                                        <asp:DropDownList ID="DlDepartment" runat="server" CssClass="select1" Width="80%" data-toggle="tooltip" data-placement="top" ToolTip="选择要审批的部门">
                                    ...
                                    <td width="14%" height="80" align="left">
                                        <asp:Button ID="Button1" runat="server" Text="添加" OnClick="Button1_Click" CssClass="btn" data-toggle="tooltip" data-placement="top" ToolTip="点击进行添加" />
                                    </td>
                                </tr>
                            </table>
                            <br>
                            ...
                            <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" Width="98%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton9" CommandArgument='<%# Eval("PaperProcessId") %>' runat="server"
                                                    OnCommand="LinkButton9_Command" ToolTip="点击进行删除流程">删除</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
