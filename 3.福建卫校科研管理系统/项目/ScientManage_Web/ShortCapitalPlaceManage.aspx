<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortCapitalPlaceManage.aspx.cs" Inherits="ScientManage_Web.ShortCapitalPlaceManage" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AllowPaging="True" AllowSorting="True"
                                ...
                                ShowHeaderWhenEmpty="True" PageSize="10" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" Width="98%">
