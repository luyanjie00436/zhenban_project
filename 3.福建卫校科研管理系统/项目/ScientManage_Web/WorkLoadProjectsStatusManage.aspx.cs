...
{
    public partial class WorkLoadProjectsStatusManage : System.Web.UI.Page
    {
        ...
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("WorkLoadProjectsStatusModify.aspx?WorkLoadProjectsId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
