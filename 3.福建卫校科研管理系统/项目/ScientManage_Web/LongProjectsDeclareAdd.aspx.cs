    ...
    public partial class LongProjectsDeclareAdd : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                LFileUrl.Text = path;
                if (bus.LongProjectsInsert("LongProjects_Insert", LongProjectsId, UserCardId,DepartmentId, LongProjectsName,ProjectsFrom,ProjectsSubject,ProjectsLevel,Company, path,IsSchool))
                {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (bus.LongProjectsInsert("LongProjects_Update", LongProjectsId, UserCardId,DepartmentId, LongProjectsName, ProjectsFrom, ProjectsSubject, ProjectsLevel, Company, path, IsSchool))
            {
