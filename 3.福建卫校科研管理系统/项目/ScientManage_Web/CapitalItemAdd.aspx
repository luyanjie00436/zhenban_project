<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapitalItemAdd.aspx.cs" Inherits="ScientManage_Web.CapitalItemAdd" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="right" class="auto-style1">
                                    <strong>资金项目名称：</strong>
                                </td>
                                <td width="70%" align="left">
                                    <asp:TextBox ID="txtCapitalItemName" runat="server" CssClass="input6" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入资金项目名称  "></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="tr10">
