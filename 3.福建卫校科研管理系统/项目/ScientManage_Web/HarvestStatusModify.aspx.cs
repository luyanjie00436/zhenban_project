...
{
    public partial class HarvestStatusModify : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (bus.HarvestStatusModifyInsert("HarvestStatusModify_Insert", HarvestId, ExamineOpinion, UserCardId, "同意"))
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string ExamineOpinion = txtExamineOpinion.Text.Trim().ToString();
            string UserCardId = HttpUtility.UrlDecode(Request.Cookies["UserCardId"].Value);
            if (bus.HarvestStatusModifyInsert("HarvestStatusModify_Insert", HarvestId, ExamineOpinion, UserCardId, "拒绝"))
            {
                AlertMsgAndNoFlush("审批成功");
                dataGriviewBD();
            }
