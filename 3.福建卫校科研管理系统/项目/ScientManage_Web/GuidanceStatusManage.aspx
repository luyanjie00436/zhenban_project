<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuidanceStatusManage.aspx.cs" Inherits="ScientManage_Web.GuidanceStatusManage" %>
...
<body>
 ...
 <div class="aa"  ><div class="parallelogram"> <div  class="parallelogram2"   >指导学生审批管理</div></div></div>
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">
                         ...
                         <td width="10%" align="right">
                          ...
                          <tr>
                                <td width="10%" align="right">
                            <strong>成果或调研报告名称：</strong>
                        </td>
                        <td width="10%" align="left"> 
                            <asp:TextBox ID="txtGuidanceName"  CssClass="select1" runat="server" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入成果或调研报告名称"></asp:TextBox>
                        </td>
                        <td width="10%" align="right">
                            <strong>采用级别：</strong>
                        </td>
                        <td width="10%" align="left">
                            <asp:TextBox ID="txtGuidanceLevel" runat="server"  CssClass="select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入采用级别"></asp:TextBox>
                        </td>
                                <td width="10%" align="right">
                                <strong>审核状态：</strong>
                            </td>
                     ...
                     ShowHeaderWhenEmpty="true"    OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="部门" HeaderText="所在院系">
                              ...
                              <asp:BoundField DataField="成果名称" HeaderText="成果或调研报告名称">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="采用级别" HeaderText="成果或采用级别">
                                <HeaderStyle  CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>     
...
OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("编号") %>' ToolTip="跳转到指导学生审批表">修改审批状态</asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridview_HeaderStyle" />
                                <ItemStyle HorizontalAlign="Center" />
