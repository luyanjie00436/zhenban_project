<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialExamineManage.aspx.cs" Inherits="ScientManage_Web.SpecialExamineManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">专项分值审批</div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="GridView1" BackColor=" #d4d2d2" CssClass="juzhong" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ContentName" HeaderText="内容">
                                        <HeaderStyle Width="40%" CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("SpecialId") %>' ToolTip="跳转到专项分值审批表">审批</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
