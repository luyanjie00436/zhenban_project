<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HarvestPartnerManage.aspx.cs" Inherits="ScientManage_Web.HarvestPartnerManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">成果合作者</div>
                </div>
            </div>
                    ...
                    <ContentTemplate>
                        <div style="margin-bottom: 10px">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="right" class="auto-style1">请选择您申报的成果:
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DlHarvest" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Partner_SelectedIndexChanged"
                                            CssClass="select1" data-toggle="tooltip" data-placement="top" ToolTip="选择您申报的成果">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtPartnerRank" runat="server" onblur="javascript:yzszfw1(this,0,100);" class="input1" data-toggle="tooltip" data-placement="top" title="输入本人排名 例如（1、2、3......）"></input>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <asp:GridView ID="GridView1" runat="server" BackColor=" #d4d2d2" CssClass="juzhong" AutoGenerateColumns="False" Width="98%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="操作">
                                            <ItemTemplate>
                                                <div class="link02">
                                                    <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("HarvestPartnerId") %>'
                                                        OnCommand="LinkButton6_Command" ToolTip="点击进行修改">编辑</asp:LinkButton>
                                                    <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("HarvestPartnerId") %>'
