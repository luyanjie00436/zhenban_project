<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShortProjectsStandManage.aspx.cs" Inherits="ScientManage_Web.ShortProjectsStandManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">立项管理</div>
                </div>
            </div>
            ...
            <div style="float: right; margin-right: 20px;">
                ...
                <asp:LinkButton ID="LinkButton9" data-toggle="tooltip" data-placement="top" ToolTip="点击刷新" runat="server" CssClass="btn_right" OnClick="LinkButton9_Click">刷 新</asp:LinkButton>
            </div>
            <br />
