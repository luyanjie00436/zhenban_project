<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JournalManage.aspx.cs" Inherits="ScientManage_Web.JournalManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">日志查看</div>
                </div>
            </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgcolor">
                               ...
                               <asp:DropDownList ID="DlMonth" runat="server" CssClass="select1" Width="80px" data-toggle="tooltip" data-placement="top" ToolTip="选择月份">
                                   ...
                                   <asp:ListItem Value="12">12</asp:ListItem>
                                       ...
                                       <asp:DropDownList ID="DLDay" runat="server" CssClass="select1" Width="80px" data-toggle="tooltip" data-placement="top" ToolTip="选择日期">
                                    ...
                                    <td width="10%" align="left">
                                        <asp:TextBox ID="TextBox1" runat="server" CssClass=" select1" Height="27px" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入操作位置"></asp:TextBox>
                                    </td>
                                    <td width="10%" align="right">
                                        <strong>操作内容：</strong>
                                    </td>
                                    <td width="10%" align="left">
                                        <asp:TextBox ID="TextBox2" runat="server" Height="27px" CssClass=" select1" Width="137px" data-toggle="tooltip" data-placement="top" ToolTip="输入操作内容"></asp:TextBox>
                                    </td>
                                    <td>
