<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachingDetailed.aspx.cs" Inherits="ScientManage_Web.TeachingDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">著作申请表</div>
                </div>
            </div>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto; margin-top: 5px;">
                    ...
                    <div>
                        <table class="biaob">
                            <tr>
                                <td class="td11">姓名</td>
                                <td class="td4">所在院系</td>
                                <td class="td4">著作名称</td>
                                <td class="td4">出版类别</td>
                                <td class="td4">出版社
                                </td>
                                <td class="td5">出版时间</td>
                                <td class="td4">版次</td>
                                <td class="td4">全书字数</td>
                                <td class="td4">备注</td>
                            ...
                            <tr>
                                ...
                                <td class="td4">
                                    <asp:Label ID="LBookName" runat="server"></asp:Label>
                                </td>
                                <td class="td4">
                                    <asp:Label ID="LPressCategory" runat="server"></asp:Label>
                                </td>
                                <td class="td4">
                                    <asp:Label ID="LPressName" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LPressDate" runat="server"></asp:Label>
                                </td>
                                <td class="td4">
                                    <asp:Label ID="LRevision" runat="server"></asp:Label>
                                </td>
                                <td class="td4">
                                    <asp:Label ID="LTotalNumber" runat="server"></asp:Label>
                                </td>
                                <td class="td4" style="word-break: break-all; width: 100px;">
                                    <asp:Label ID="LRemarks" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LTeachingValue" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                            ...
                            <tr>
                                ...
                                <td class="td4" colspan="8" style="text-align: left; padding-left: 20px; width: 730px">
