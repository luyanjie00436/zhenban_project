<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLoadProjectsDetailed.aspx.cs" Inherits="ScientManage_Web.WorkLoadProjectsDetailed" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">项目申请表</div>
                </div>
            </div>
                    ...
                    <div>
                        <table class="biaob">
                            ...
                            <tr>
                                ...
                                <td class="td4" colspan="9" style="text-align: left; padding-left: 20px; width: 730px">
