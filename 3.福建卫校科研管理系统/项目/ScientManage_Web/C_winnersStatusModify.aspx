<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_winnersStatusModify.aspx.cs" Inherits="ScientManage_Web.C_winnersStatusModify" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">竞赛获奖审批表</div>
                </div>
            </div>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto; margin-top: 5px;">
                    ...
                    <div>
                        <table class="biaob">
                            <tr>
                                <td class="td1">姓名</td>
                                <td class="td5">获奖项目名称</td>
                                <td class="td5">获奖项目级别</td>
                                <td class="td5">获奖时间</td>
                                <td class="td5">获奖等级</td>
                                <td class="td5">组织单位</td>
                            ...
                            <tr>
                                ...
                                <td class="td5" align="center">
                                    <asp:Label ID="LC_winnersName" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                ...
                                <td class="td4">
                                    <asp:Label ID="LAward_level" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LOrganizational_Unit" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LC_winnersTotal" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="td5">项目总分值说明</td>
                                <td class="td5">排名</td>
                                <td class="td5" colspan="2">个人工作量分值</td>
                                <td class="td4">备注</td>
                                <td class="td5" colspan="2">审核状态</td>
                            </tr>
                            <tr>
                                <td class="td5" align="center">
                                    <asp:Label ID="LC_winnersDescription" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LRanking" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center">
                                    <asp:Label ID="LC_winnersValue" runat="server"></asp:Label>
                                </td>
                                <td class="td5" align="center" style="word-break: break-all; width: 100px;">
                                    <asp:Label ID="LRemarks" runat="server"></asp:Label>
                                </td>
                                <td class="td5" colspan="3" align="center">
                                    <asp:Label ID="LTransferStatus" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="td4">合作者列表</td>
                                <td class="td4" colspan="7" style="text-align: left; padding-left: 20px; width: 730px">
