...
{
    public partial class WorkLoadProjectsManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (bus.AuthoritySelect("Authority_SelectByUserCardId", UserCardId, "~/WorkLoadProjectsManage.aspx") == 0)
                {
                    Response.Write("<script>alert('您暂时无法访问此页面，请与科研处联系！！');" + "window.parent.parent.location.href='Login.aspx'<" + "/script>");
                }
        ...
        public void ExportToExcel(string ExcelName)
        {
            ...
            if (RowCount > 0)
            {
                ...
                {
                    mySheet.GetRow(i).GetCell(0).SetCellValue(sum++);
        ...
        public void dataGriviewBD()
        {
            ...
            string ProjectsForm = txtProjectsForm.Text.Trim();
            ...
            DataTable dt=bus.SelectsWorkLoadProjects("WorkLoadProjects_Selects", UserName, DepartmentId, Year, Month, Status,ProjectsName,ProjectsForm,WinningYear).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            return bus.SelectsWorkLoadProjects("WorkLoadProjects_Selects", UserName, DepartmentId, Year, Month, Status, ProjectsName, ProjectsForm, WinningYear).Tables[0];
        }
        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {

            Response.Redirect("WorkLoadProjectsDetailed.aspx?WorkLoadProjectsId=" + pwds.EncryptDES(e.CommandArgument.ToString(), "asdfasdf") + "");
        }
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("WorkLoadProjectsManage.aspx");
        }
        //合并单元格
