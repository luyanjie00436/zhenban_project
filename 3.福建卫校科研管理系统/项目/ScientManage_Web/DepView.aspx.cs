...
{
    public partial class DepView : System.Web.UI.Page
    {
        ...
        */
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectsByApplyValue("AssessValueView_Selects", UserName, DepartmentName,ApplyYearName).Tables[0];
        ...
        public DataTable SelectBD()
        {
            ...
            string ApplyYearName = DLApplyYear.SelectedItem.Text;
            string DepartmentName = DlDepartment.SelectedItem.Text;
            return bus.SelectsByApplyValue("AssessValueView_Selects", UserName, DepartmentName, ApplyYearName).Tables[0];
        }

        protected void LinkButton7_Command(object sender, CommandEventArgs e)
        {
            DataTable dt = bus.SelectByAssessValueId("AssessValue_SelectByAssessValueId", Convert.ToInt32(e.CommandArgument.ToString())).Tables[0];
            string UserCardId = dt.Rows[0]["UserCardId"].ToString();
            string ApplyYearId = dt.Rows[0]["ApplyYearId"].ToString();
            string url = "/AssessDetailed.aspx?ApplyYearId=" + pwds.EncryptDES(ApplyYearId, "asdfasdf")+"&UserCardId="+ pwds.EncryptDES(UserCardId, "asdfasdf");
