<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongProjectsStandDetailed.aspx.cs" Inherits="ScientManage_Web.LongProjectsStandDetailed" %>
                    ...
                    <div>
                        <table style="margin-left: -1px">
                            ...
                            <tr>
                                ...
                                <td class="td5">
                                    <asp:Label ID="LCountNum" runat="server" Visible="false"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <asp:DataList ID="dataOfYear" runat="server" Width="100%" Style="margin: 0 auto">
                            <ItemTemplate>
