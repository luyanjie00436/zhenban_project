<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LongCapitalChangeExamineManage.aspx.cs" Inherits="ScientManage_Web.LongCapitalChangeExamineManage" %>
        ...
        <div id="div_main" class="min_height">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">预算变更审批</div>
                </div>
            </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div style="padding-left: 100px;">
                                <asp:TextBox ID="TextBox1" runat="server" BorderColor="#000000" BorderWidth="1px" CssClass="select1" data-placement="top" data-toggle="tooltip" Height="27px" OnTextChanged="TextBox2_TextChanged" Width="137px"></asp:TextBox>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" BackColor=" #d4d2d2" CssClass="juzhong" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="LongProjectsId" HeaderText="项目编号">
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <div class="link02">
                                                <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton7_Command" CommandArgument='<%# Eval("LongProjectsId") %>' ToolTip="点击跳转到审批页面">审批</asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridview_HeaderStyle" />
                                        <ItemStyle HorizontalAlign="Center" />
