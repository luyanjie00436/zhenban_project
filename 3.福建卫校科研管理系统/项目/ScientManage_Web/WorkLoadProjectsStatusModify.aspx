<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLoadProjectsStatusModify.aspx.cs" Inherits="ScientManage_Web.WorkLoadProjectsStatusModify" %>
        ...
        <div id="div_main">
            <div class="aa">
                <div class="parallelogram">
                    <div class="parallelogram2">工作量项目审批表</div>
                </div>
            </div>
                ...
                <div style="width: 1024px; height: 297mm; margin: 0 auto; margin-top: 5px;">
                    ...
                    <div>
                        <table class="biaob">
                            <tr>
                                <td class="td1">姓名</td>
                                <td class="td5">项目类别</td>
                                <td class="td5">项目名称</td>
                                <td class="td5">项目编号</td>
                                <td class="td5">来源及类别</td>
                                <td class="td5">起止时间</td>
                                <td class="td5">到校经费（万元）</td>
                                <td class="td5">备注</td>
                                <td class="td5">项目总分值</td>
                                <td class="td5">本年度可分配工作量分值</td>
                            ...
                            <tr>
                                ...
                                <td class="td5" style="word-break: break-all; width: 100px;">
                                    <asp:Label ID="LRemarks" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                                    <asp:Label ID="LSumProjectsValue" runat="server"></asp:Label>
                                </td>
                                <td class="td5">
                            ...
                            <tr>
                                ...
                                <td class="td4" colspan="10" style="width: 730px">
                        ...
                        <table class="biaoe" border="0" cellspacing="0" cellpadding="0" border="0" cellspacing="0" cellpadding="0">
                            <tr>
