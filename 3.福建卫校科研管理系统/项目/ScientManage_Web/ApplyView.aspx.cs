...
{
    public partial class ApplyView : System.Web.UI.Page
    {
        ...
        public void dataGriviewBD()
        {
            ...
            DataTable dt = bus.SelectsByApplyValue("ApplyValueView_Selects", UserName, DepartmentName, ApplyYearName).Tables[0];
        ...
        public DataTable SelectBD(){
            ...
            string ApplyYearName = DLApplyYear.SelectedItem.Text;
            string DepartmentName = DlDepartment.SelectedItem.Text;
            return bus.SelectsByApplyValue("ApplyValueView_Selects", UserName, DepartmentName, ApplyYearName).Tables[0];
        }
